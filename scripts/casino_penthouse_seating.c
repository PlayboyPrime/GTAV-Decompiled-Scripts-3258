...
int func_66()
{
	...
	if (func_79(unk_0x259BE71D8A81D4FA()) && unk_0x15CCE8886267624F())
	{
		return 1;
	}
	if (func_77() != 0)
...
int func_77()
{
	return func_78(unk_0x259BE71D8A81D4FA());
}
...
int func_82(int iParam0)
{
	if (iParam0 != func_53())
	{
		if (func_54(iParam0, 1, 1))
		{
			...
			{
				return func_83(Global_2657971[iParam0 /*465*/].f_322.f_8) == 15;
			}
		}
	}
	return 0;
...
void func_86(var uParam0)
{
	...
	if (uParam0->f_13 > 2)
	{
		...
		func_87(unk_0x259BE71D8A81D4FA(), 1, 0, 0);
	}
	...
	else
	{
		...
		if (unk_0x762604C40829DB72(iParam0) && (unk_0x75EAB09F5E974116(iParam0) || iParam3 == 1))
		{
			...
			if (!bVar20)
			{
				...
				else if (bVar14 || ((!func_97(unk_0x259BE71D8A81D4FA(), 0) && !func_96()) && !func_95(unk_0x259BE71D8A81D4FA())))
				{
			...
			if (bParam1)
			{
				...
				if (!func_91(uVar27) && !unk_0xB431D60610E7F85F(uVar27))
				{
					if (!bVar22)
					{
			...
			else
			{
				if (!func_91(uVar27) && !unk_0xB431D60610E7F85F(uVar27))
				{
					...
					if (func_88(Global_4718592.f_185586))
					{
...
void func_92(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == 0)
	{
		...
		if (func_97(unk_0x259BE71D8A81D4FA(), 0))
		{
...
void func_102()
{
	unk_0xDB2434E51017FFCC(32, 0, func_113());
	func_111(0, -1, 0);
	func_110();
	func_103();
	if (unk_0x76CD105BCAC6EB9F())
...
void func_103()
{
	func_104(0, &uLocal_116, 0, 3);
	func_104(1, &uLocal_116, 1, 3);
	func_104(2, &uLocal_116, 2, 3);
	func_104(3, &uLocal_116, 3, 1);
	func_104(4, &uLocal_116, 4, 1);
	func_104(5, &uLocal_116, 5, 1);
	func_104(6, &uLocal_116, 6, 1);
	func_104(7, &uLocal_116, 7, 1);
	func_104(8, &uLocal_116, 8, 1);
	func_104(9, &uLocal_116, 9, 1);
	func_104(10, &uLocal_116, 10, 1);
	func_104(11, &uLocal_116, 11, 1);
	func_104(12, &uLocal_116, 12, 1);
	func_104(13, &uLocal_116, 13, 1);
	func_104(14, &uLocal_116, 14, 1);
	func_104(15, &uLocal_116, 15, 1);
	func_104(16, &uLocal_116, 16, 1);
	func_104(17, &uLocal_116, 17, 1);
	func_104(18, &uLocal_116, 18, 1);
	func_104(19, &uLocal_116, 19, 1);
}
...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_109(iParam0, &Var0, &fVar1);
	uParam1->f_16[iParam2 /*14*/].f_13 = iParam3;
	uParam1->f_16[iParam2 /*14*/] = { Var0 };
	uParam1->f_16[iParam2 /*14*/].f_3 = { 0f, 0f, fVar1 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_1 = { func_106(func_108(), func_107(iParam3, fVar1)) + Var0 };
	uParam1->f_16[iParam2 /*14*/].f_6.f_4 = { func_106(func_105(), func_107(iParam3, fVar1)) + Var0 };
...
Vector3 func_106(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
float func_107(int iParam0, float fParam1)
{
	switch (iParam0)
	{
		case 1:
