	...
	while (true)
	{
		...
		switch (iVar2)
		{
			case 2:
				...
				func_338(&Var1);
				unk_0x80813AC549A1E8AE(func_337());
				unk_0xA336AFF285251641("move_m@golfer@");
				func_333(&uVar4);
				iVar2 = 3;
				break;
			
			case 3:
				if (((unk_0xE100DD4F82A51BDE(func_337()) && unk_0xD7E1DF759CD0FFF2("GOLF_I", 0, -1)) && unk_0x60C643DC13B0C72B("move_m@golfer@")) && func_332(&uVar4))
				{
					func_329(&uVar3);
					iVar2 = 4;
				}
			...
			case 4:
				if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && func_328(unk_0x5295501D0862870D()))
				{
					if (((!unk_0x7B780C491DEC834E(func_327(&Var1, (2 + iVar5 * 2)), 10f) && !unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), func_327(&Var1, (2 + iVar5 * 2)), 10f, 10f, 10f, 0, 1, 0)) || ((func_326() || unk_0x3555462DB47B7AB1()) || unk_0x15CCE8886267624F())) || func_325(4))
					{
						if (iVar6 == 0)
						{
							func_321(&Var1, &(Var0[iVar5 /*170*/]), (2 + iVar5 * 2), unk_0xC5935DFB3F39785A(1, 3));
						}
						if (iVar6 < func_320(&(Var0[iVar5 /*170*/])))
						{
							func_314(&Var1, &(Var0[iVar5 /*170*/]), iVar6);
						}
						iVar6++;
						if (iVar6 > func_320(&(Var0[iVar5 /*170*/])))
						{
							iVar6 = 0;
							func_312(&Var1, &(Var0[iVar5 /*170*/]), func_313(&(Var0[iVar5 /*170*/])), func_320(&(Var0[iVar5 /*170*/])));
							iVar5++;
							if (iVar5 >= Var0.f_0)
							{
								iVar2 = 5;
...
void func_1(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4)
{
	...
	func_300(&(uParam2->f_15[uParam2->f_165 /*34*/]), unk_0x4A8C381C258A124D(), uParam2, uParam2->f_165, uParam1);
	uParam2->f_165++;
	if (uParam2->f_165 >= func_320(uParam2))
	{
		uParam2->f_165 = 0;
	}
	bVar1 = unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0;
	Var2.f_2 = 1097859072;
	Var2.f_3 = 1500;
	Var2.f_4 = 45;
	Var2.f_5 = 1103626240;
	...
	while (iVar0 < func_320(uParam2))
	{
		if (unk_0xFC8BFE4B41177C22(func_299(&(uParam2->f_15[iVar0 /*34*/]))))
		{
			if (unk_0x1C2F771CDC87A3A5(func_299(&(uParam2->f_15[iVar0 /*34*/])), 0) && !func_298(uParam2, iVar0, 16777216))
			{
				func_296(uParam2);
				return;
			}
			...
			if (func_286(func_299(&(uParam2->f_15[iVar0 /*34*/])), func_294(uParam2, 0), &Var2, &uVar3, 1, 1, 0, 1, 1))
			{
				func_296(uParam2);
				return;
			}
	...
	{
		if (unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0) == func_294(uParam2, 0))
		{
			unk_0xEE0BCDB1B5E36BCB(func_294(uParam2, 0), 0, 0);
			unk_0x68298CA6191CDFDB(&(uParam2->f_152[0]));
			func_285(uParam2, 0, 0);
			if (unk_0xFC8BFE4B41177C22(func_284(uParam2, 0)) && !unk_0x1C2F771CDC87A3A5(func_284(uParam2, 0), 0))
			{
				if (unk_0x9B5C1660CCDF7189(func_284(uParam2, 0), joaat("script_task_enter_vehicle")) != 1)
				{
					unk_0x974022927CB47E68(func_284(uParam2, 0));
					unk_0x0E95B96CFEFE7B61(func_284(uParam2, 0), unk_0x4A8C381C258A124D(), -1);
				}
			}
			if (unk_0xFC8BFE4B41177C22(func_284(uParam2, 1)) && !unk_0x1C2F771CDC87A3A5(func_284(uParam2, 1), 0))
			{
				if (unk_0x9B5C1660CCDF7189(func_284(uParam2, 1), joaat("script_task_enter_vehicle")) != 1)
				{
					unk_0x974022927CB47E68(func_284(uParam2, 1));
					unk_0x0E95B96CFEFE7B61(func_284(uParam2, 1), unk_0x4A8C381C258A124D(), -1);
				}
			}
		}
		if (unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0) == func_294(uParam2, 1))
		{
			unk_0xEE0BCDB1B5E36BCB(func_294(uParam2, 1), 0, 0);
			unk_0x68298CA6191CDFDB(&(uParam2->f_152[1]));
			func_285(uParam2, 0, 1);
		}
	}
	if (Global_112997 == func_313(uParam2))
	{
		func_283(uParam2, uParam1, iParam3);
	}
	if (iParam4 == 0 && func_325(16))
	{
		iVar4 = func_282(Global_112997);
		if (func_313(uParam2) != iVar4 && !func_281(iParam3, iVar4))
		{
			func_280(uParam2, uParam1, iVar4);
		}
	}
	if (func_279(uParam0, 1) || func_325(1))
	{
		...
		while (iVar0 < func_320(uParam2))
		{
			if (unk_0xFC8BFE4B41177C22(func_299(&(uParam2->f_15[iVar0 /*34*/]))))
			{
				if (!unk_0x1C2F771CDC87A3A5(func_299(&(uParam2->f_15[iVar0 /*34*/])), 0))
				{
					unk_0xB2BD5837A8D3CEDA(func_299(&(uParam2->f_15[iVar0 /*34*/])), func_278(&(uParam2->f_15[iVar0 /*34*/])), 1, 0, 0, 1);
				}
			}
			iVar0++;
		}
	...
	{
		iVar5 = func_282(Global_112997);
		func_280(uParam2, uParam1, iVar5);
	}
	switch (func_276(uParam2))
	{
		case 5:
			...
			{
				if ((((unk_0xFC8BFE4B41177C22(func_274(uParam2, uParam2->f_165)) && !unk_0x1C2F771CDC87A3A5(func_274(uParam2, uParam2->f_165), 0)) && unk_0xFC8BFE4B41177C22(func_284(uParam2, uParam2->f_165))) && !func_298(uParam2, uParam2->f_165, 16777216)) && func_273(func_274(uParam2, uParam2->f_165), func_284(uParam2, uParam2->f_165), 1) < 25f)
				{
					if (unk_0x9B5C1660CCDF7189(func_284(uParam2, uParam2->f_165), joaat("script_task_enter_vehicle")) != 1 && !func_298(uParam2, uParam2->f_165, 67108864))
					{
						unk_0x974022927CB47E68(func_284(uParam2, uParam2->f_165));
						if (!unk_0xCECDBB848D53DEB2(func_284(uParam2, uParam2->f_165), func_274(uParam2, uParam2->f_165), 0))
						{
							if (uParam2->f_165 == func_271(uParam2, func_272(uParam2, uParam2->f_165)))
							{
								if (!unk_0xFC8BFE4B41177C22(func_284(uParam2, uParam2->f_165 + 1)) || !unk_0x9D6DF8F3584AAC2B(func_284(uParam2, uParam2->f_165 + 1)))
								{
									unk_0xEBA229B2E0BB05E0(func_284(uParam2, uParam2->f_165), func_274(uParam2, uParam2->f_165), -1, -1, 1f, 1, 0, 0);
								}
							}
							else
							{
								unk_0xEBA229B2E0BB05E0(func_284(uParam2, uParam2->f_165), func_274(uParam2, uParam2->f_165), -1, 0, 1f, 1, 0, 0);
							}
						}
					}
				}
				else
				{
					...
					while (iVar0 < func_320(uParam2))
					{
						if (iVar0 != func_270(uParam2))
						{
							...
							{
								Var7 = { func_268(uParam1, func_313(uParam2), iVar0) };
							}
							else if (!func_267(uParam2, -1))
							{
								Var7 = { func_266(uParam1, func_313(uParam2), iVar0) };
							}
							else
							{
								Var7 = { func_265(uParam2, iVar0) };
							}
							if (unk_0xFC8BFE4B41177C22(func_284(uParam2, iVar0)) && !unk_0x1C2F771CDC87A3A5(func_284(uParam2, iVar0), 0))
							{
								unk_0x974022927CB47E68(func_284(uParam2, iVar0));
								unk_0xA966E518B752B92A(func_284(uParam2, iVar0), Var7, 1f, -1, 1048576000, 0, 1193033728);
							}
						}
						iVar0++;
					}
		...
		case 2:
			...
			if (!unk_0x4FAFF4BCB7633475(func_64(uParam2)))
			{
				unk_0x0FB8E752BCC547A9(func_64(uParam2), 129, 1);
			}
			if (func_63(uParam2, -1, 0))
			{
				...
				if (func_275(uParam2, 1048576))
				{
					Var7 = { func_266(uParam1, func_313(uParam2), func_270(uParam2)) };
					func_42(uParam2, func_270(uParam2), Var7, uParam1, 0, 1);
					unk_0xCD76801E1106CABE(func_64(uParam2), func_41(uParam1, func_313(uParam2)), 0);
				}
			}
...
void func_2(var uParam0, var uParam1, bool bParam2)
{
	...
	while (iVar0 < func_320(uParam0))
	{
		...
		if (unk_0xFC8BFE4B41177C22(func_299(&(uParam0->f_15[iVar0 /*34*/]))))
		{
			if (!unk_0x1C2F771CDC87A3A5(func_299(&(uParam0->f_15[iVar0 /*34*/])), 0))
			{
				unk_0xB2BD5837A8D3CEDA(func_299(&(uParam0->f_15[iVar0 /*34*/])), func_266(uParam1, iVar1, iVar0), 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
	if (bParam2)
	{
		...
		Var3 = { 5f, 5f, 0f };
		fVar4 = 0f;
		if (func_3(func_327(uParam1, iVar1), func_41(uParam1, iVar1), &Var2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0))
		{
			iVar5 = 0;
			while (iVar5 < 2)
			{
				if (unk_0xFC8BFE4B41177C22(func_294(uParam0, iVar5)))
				{
					if (!unk_0x1C2F771CDC87A3A5(func_294(uParam0, iVar5), 0) && !unk_0x7B780C491DEC834E(Var2 + FtoV(system::to_float(iVar5)) * Var3, 5f))
					{
						unk_0xB2BD5837A8D3CEDA(func_294(uParam0, iVar5), Var2 + FtoV(system::to_float(iVar5)) * Var3, 1, 0, 0, 1);
						unk_0x5C96CEA06531AB03(func_294(uParam0, iVar5), fVar4);
					}
				}
				iVar5++;
			}
...
int func_3(struct<3> Param0, struct<2> Param1, var uParam2, var uParam3, float fParam4, struct<3> Param5, struct<2> Param6, float fParam7, bool bParam8)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	{
		if (!unk_0x6009FBA2EAAA60BE(Param0, iVar1, uParam3, fParam4, &uVar2, 1, 1077936128, 0))
		{
			return 0;
		}
		else if ((system::vdist2(Param0, *uParam3) > 100f && !unk_0x913602ADD2D86A7A(*uParam3, 5f)) && !func_7(*uParam3))
		{
			Var3 = { func_6(Vector(0f, uParam3->f_1, *uParam3) - Vector(0f, Param6.f_1, Param6.f_0)) };
			if (!bParam8 || func_5(Param5, Var3) < 0,75f)
			{
				bVar0 = true;
			}
		}
	...
	if (unk_0x1D5CD3EAAA7422B0((unk_0x97BC40FFA2FFCCD2((Param1.f_0 - Param0.f_0), (Param1.f_1 - Param0.f_1)) - *fParam4)) > 90f)
	{
...
int func_4(var uParam0, float fParam1, float fParam2)
{
	...
	if (unk_0xB1EAADCB692D69CE(*uParam0 + Vector(fParam2, 0f, 0f), &fVar0, 0, 0))
	{
		if (unk_0x1D5CD3EAAA7422B0((uParam0->f_2 - fVar0)) < fParam1)
		{
			uParam0->f_2 = fVar0;
			return 1;
		}
...
int func_7(struct<3> Param0)
{
	...
	fVar1 = func_8(Var0, -1405,69f, 61,69f, 51,66f);
	if (func_8(Param0, Var0) > fVar1)
	{
		return 1;
	}
	Var0 = { func_6(Vector(0f, -85,86f, -1167,9f) - Vector(0f, -89,1f, -1162,01f)) };
	fVar1 = func_8(Var0, Vector(0f, -89,1f, -1162,01f) - Vector(9,92f, 9,92f, 9,92f) * Var0);
	if (func_8(Param0, Var0) > fVar1)
	{
		Var0 = { func_6(Vector(0f, -89,76f, -1193,7f) - Vector(0f, -87,41f, -1192,45f)) };
		fVar1 = func_8(Var0, Vector(39,97f, -89,76f, -1193,7f) - Vector(2,778f, 2,778f, 2,778f) * Var0);
		if (func_8(Param0, Var0) > fVar1)
		{
			return 1;
		}
		if (unk_0x26715B0ED6702C87(Param0, -1227,909f, -68,76888f, 43,06714f, -1260,599f, -50,60131f, 44,63058f, 2,74f, 0, 0))
		{
			return 1;
		}
	}
	...
	{
		Var0 = { func_6(Vector(0f, -89,76f, -1193,7f) - Vector(0f, -87,41f, -1192,45f)) };
		fVar1 = func_8(Var0, Vector(39,97f, -89,76f, -1193,7f) - Vector(1,03f, 1,03f, 1,03f) * Var0);
		if (func_8(Param0, Var0) > fVar1)
		{
			return 1;
		}
	...
	fVar1 = func_8(Var0, -970,31f, -113,24f, 38,28f);
	if (func_8(Param0, Var0) > fVar1)
	{
		Var0 = { func_6(Vector(0f, -106,46f, -948,52f) - Vector(0f, -102,2f, -951,06f)) };
		fVar1 = func_8(Var0, -948,52f, -106,46f, 42,39f);
		if (func_8(Param0, Var0) > fVar1)
		{
			return 1;
		}
	...
	else
	{
		...
		fVar1 = func_8(Var0, -1028,62f, -127,38f, 39,51f);
		if (func_8(Param0, Var0) > fVar1)
		{
			Var0 = { func_6(Vector(0f, -125,95f, -994,29f) - Vector(0f, -94,44f, -1001,81f)) };
			fVar1 = func_8(Var0, -994,29f, -125,95f, 40,12f);
			if (func_8(Param0, Var0) > fVar1)
			{
				return 1;
			}
		...
		else
		{
			...
			fVar1 = func_8(Var0, -1037,99f, -140,83f, 42,99f);
			if (func_8(Param0, Var0) > fVar1)
			{
				return 1;
			}
	...
	fVar1 = func_8(Var0, -1047,59f, 96,74f, 52,25f);
	if (func_8(Param0, Var0) > fVar1)
	{
		Var0 = { func_6(Vector(0f, 180,44f, -1094,08f) - Vector(0f, 167,17f, -1086,17f)) };
		fVar1 = func_8(Var0, -1094,08f, 180,44f, 61,49f);
		if (func_8(Param0, Var0) > fVar1)
		{
			Var0 = { func_6(Vector(0f, 196,78f, -1092f) - Vector(0f, 179,38f, -1163,07f)) };
			fVar1 = func_8(Var0, Vector(60,09f, 196,78f, -1092f) - Vector(3,75f, 3,75f, 3,75f) * Var0);
			if (func_8(Param0, Var0) > fVar1)
			{
				return 1;
			}
		...
		else
		{
			...
			fVar1 = func_8(Var0, -1069,28f, 145,22f, 61,6f);
			if (func_8(Param0, Var0) > fVar1)
			{
				return 1;
			}
	...
	else
	{
		...
		fVar1 = func_8(Var0, -967,03f, -19,35f, 48,28f);
		if (func_8(Param0, Var0) > fVar1)
		{
			return 1;
		}
	...
	fVar1 = func_8(Var0, -1274,15f, 186,79f, 61,97f);
	if (func_8(Param0, Var0) > fVar1)
	{
		Var0 = { func_6(Vector(0f, 192,648f, -1326,063f) - Vector(0f, 183,78f, -1325,44f)) };
		fVar1 = func_8(Var0, -1326,063f, 192,648f, 61,76f);
		if (func_8(Param0, Var0) > fVar1)
		{
			return 1;
		}
	...
	else
	{
		...
		fVar1 = func_8(Var0, -1159,35f, 226,63f, 70f);
		if (func_8(Param0, Var0) > fVar1)
		{
			return 1;
		}
...
float func_8(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

void func_9(var uParam0, int iParam1, struct<3> Param2, int iParam3, bool bParam4)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_15)
	{
		return;
	}
	func_10(&(uParam0->f_15[iParam1 /*34*/]), Param2, iParam3, bParam4);
}

void func_10(var uParam0, struct<3> Param1, int iParam2, bool bParam3)
{
	if (bParam3)
	{
	}
...
bool func_12(struct<3> Param0, struct<3> Param1, float fParam2, int iParam3)
{
...
int func_18(var uParam0, var uParam1)
{
	...
	iVar0 = 150;
	iVar1 = 1600;
	if (!unk_0xFC8BFE4B41177C22(func_64(uParam0)))
	{
		return 0;
	}
	if (system::vdist2(unk_0xD1A6A821F5AC81DB(func_64(uParam0), 1), func_41(uParam1, func_313(uParam0))) < IntToFloat(iVar1))
	{
		if (unk_0xFC8BFE4B41177C22(func_25(uParam0)) && !unk_0x1C2F771CDC87A3A5(func_294(uParam0, func_253(uParam0)), 0))
		{
			if (system::vdist2(unk_0xD1A6A821F5AC81DB(func_25(uParam0), 1), func_41(uParam1, func_313(uParam0))) > IntToFloat(iVar1))
			{
				return 1;
			}
			func_20(uParam0, uParam1, func_253(uParam0), 1, 38314, 7443);
		}
		return 0;
	}
	if (system::vdist2(unk_0xD1A6A821F5AC81DB(func_64(uParam0), 1), func_19(uParam0)) < IntToFloat(iVar0))
	{
		return 0;
	}
	return 1;
...
void func_20(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	...
	while (iVar0 < func_320(uParam0))
	{
		...
		{
			unk_0xB5396F1FB088FE38(&(uParam0->f_15[iVar0 /*34*/].f_21));
			...
			Stack.Push(iVar0);
			Call_Loc(iParam4);
			unk_0xA966E518B752B92A(StackVal, StackVal, StackVal, StackVal, 1f, -1, 1048576000, 0, 1193033728);
			Stack.Push(0);
			Stack.Push(uParam1);
			Stack.Push(func_313(uParam0));
			Call_Loc(iParam5);
			unk_0xCD76801E1106CABE(StackVal, StackVal, StackVal, StackVal, 0);
			unk_0x93C0674FC00824D0(uParam0->f_15[iVar0 /*34*/].f_21);
			unk_0x4BD42B0527065BB6(func_284(uParam0, iVar0), uParam0->f_15[iVar0 /*34*/].f_21);
			unk_0xD0557B139A542F12(&(uParam0->f_15[iVar0 /*34*/].f_21));
	...
	while (iVar2 < func_320(uParam0))
	{
		if (func_23(uParam0, iVar2) != 0)
		{
			if (func_21(uParam0, iVar2) != 10 && !func_298(uParam0, iVar2, 16777216))
			{
				...
				Var5 = { func_41(uParam1, func_313(uParam0)) };
				Var4.f_2 = 0f;
				Var5.f_2 = 0f;
				fVar3 = system::vdist(Var4, Var5);
...
void func_38(var uParam0)
{
	...
	{
		unk_0x837D67618BF89034(uParam0->f_4, 1, 1);
		unk_0x51C8BEA2005931AB(&(uParam0->f_4));
	}
}
...
void func_42(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4, int iParam5)
{
	var uVar0;
	int iVar1;
	struct<3> Var2;
	...
	if (bParam4)
	{
		if (unk_0xB1EAADCB692D69CE(Param2 + Vector(50f, 0f, 0f), &uVar0, 0, 0))
		{
			Param2.f_2 = uVar0;
		}
	}
	unk_0xB2BD5837A8D3CEDA(func_284(uParam0, iParam1), Param2, 0, 0, 0, 1);
	iVar1 = func_272(uParam0, iParam1);
	if (unk_0xFC8BFE4B41177C22(func_294(uParam0, iVar1)) && iParam5)
	{
		Var2 = { 0f, 0f, 0f };
		Var3 = { 0f, 0f, 0f };
		fVar4 = 0f;
		...
		if (!unk_0x1C2F771CDC87A3A5(func_294(uParam0, iVar1), 0))
		{
			if (func_298(uParam0, iParam1, 1048576))
			{
				bVar5 = func_43(Param2 + Var3, func_41(uParam3, func_313(uParam0)), &Var2, &fVar4);
			}
			else
			{
				bVar5 = func_3(Param2 + Var3, func_41(uParam3, func_313(uParam0)), &Var2, &fVar4, 0f, 0f, 0f, 0f, 0f, 0f, 0);
			}
			if (bVar5 && !unk_0x7B780C491DEC834E(Var2, 5f))
			{
				unk_0xB2BD5837A8D3CEDA(func_294(uParam0, iVar1), Var2, 1, 0, 0, 1);
				unk_0x5C96CEA06531AB03(func_294(uParam0, iVar1), fVar4);
			}
		}
	}
}

int func_43(struct<3> Param0, struct<2> Param1, var uParam2, var uParam3, float fParam4)
{
	if (!unk_0x813ADF2A2A03F440(Param0, uParam3, fParam4, 1, 1077936128, 0))
	{
		return 0;
	}
	if (unk_0x1D5CD3EAAA7422B0((unk_0x97BC40FFA2FFCCD2((Param1.f_0 - Param0.f_0), (Param1.f_1 - Param0.f_1)) - *fParam4)) > 90f)
...
void func_59(var uParam0, struct<3> Param1, int iParam2)
{
	func_10(&(uParam0->f_15[uParam0->f_157 /*34*/]), Param1, iParam2, 1);
}
...
void func_62(var uParam0)
{
	...
	{
		if (unk_0x4C052E5245B17920(uParam0->f_3))
		{
			unk_0xE3F88173F42C071B();
		}
		if (unk_0x110821AE6C63DD4F(uParam0->f_3))
		{
			unk_0x51C8BEA2005931AB(&(uParam0->f_3));
		}
	}
	uParam0->f_3 = 0;
}
...
void func_67(var uParam0, var uParam1, var uParam2)
{
	...
	if (!unk_0xFC8BFE4B41177C22(func_64(uParam2)))
	{
		return;
	}
	if (unk_0x1C2F771CDC87A3A5(func_64(uParam2), 0))
	{
		return;
	}
	switch (func_34(uParam2))
	{
		case 0:
			...
			if (!unk_0xFC8BFE4B41177C22(func_250(uParam2)))
			{
				func_245(uParam2, func_247(Var0, func_248(func_249(uParam1, func_313(uParam2)), func_19(uParam2))));
			}
			else if (!func_244())
			{
				unk_0xB2BD5837A8D3CEDA(func_250(uParam2), Var0, 1, 0, 0, 1);
			}
			func_243(uParam2, unk_0xD1A6A821F5AC81DB(func_250(uParam2), 1));
			...
			unk_0x3A95CBA6857C4C37(func_250(uParam2), 0);
		...
		case 3:
			if (func_193(uParam2) || func_40(&(uParam2->f_15[func_270(uParam2) /*34*/]), 1048576))
			{
				...
				if (unk_0xFC8BFE4B41177C22(func_64(uParam2)) && !unk_0x1C2F771CDC87A3A5(func_64(uParam2), 0))
				{
					if (system::vdist2(unk_0xD1A6A821F5AC81DB(func_64(uParam2), 1), func_19(uParam2)) > 9f)
					{
						unk_0x974022927CB47E68(func_64(uParam2));
						func_263(uParam2, 1);
						return;
					}
				}
			...
			else if (unk_0xDF93B3CFAC96698F(func_64(uParam2)) == 0f && func_171(&(uParam2->f_162), 15f))
			{
				func_260(&(uParam2->f_162));
				unk_0x974022927CB47E68(func_64(uParam2));
				if (!func_267(uParam2, -1))
		...
		case 4:
			if (func_170(unk_0x4A8C381C258A124D(), uParam2->f_15[func_270(uParam2) /*34*/].f_2, 0) < 1f)
			{
				if (unk_0x685171EED42BC4DF(unk_0x4A8C381C258A124D(), uParam2->f_15[func_270(uParam2) /*34*/].f_2))
				{
					unk_0x19626F992DC71FB9(uParam2->f_15[func_270(uParam2) /*34*/].f_2);
					func_203(uParam1, uParam2, uParam0, 0, 0, 0, 1, 0);
					func_277(uParam2, 0);
					func_263(uParam2, 1);
			...
			{
				if (((uParam2->f_1 == 4 || uParam2->f_1 == 6) || func_275(uParam2, 1048576)) && unk_0xFC8BFE4B41177C22(func_250(uParam2)))
				{
					if (((func_156(func_64(uParam2)) || func_171(&(uParam2->f_162), 2,5f)) || func_275(uParam2, 1048576)) && unk_0x4DBCC7D5D01D67FA(func_250(uParam2)))
					{
						if (func_275(uParam2, 1048576))
						{
							if (bLocal_0)
				...
				else if (!unk_0xFC8BFE4B41177C22(func_250(uParam2)))
				{
					uParam2->f_1 = 0;
					func_263(uParam2, 0);
				}
		...
		case 6:
			func_118(uParam0, uParam2, 1);
			if ((func_88(uParam2) || func_87(uParam2)) || func_7(unk_0xD1A6A821F5AC81DB(func_250(uParam2), 1)))
			{
				func_86(uParam2);
			}
			else
		...
		case 8:
			...
			{
				unk_0x974022927CB47E68(func_64(uParam2));
				unk_0xB5396F1FB088FE38(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
				unk_0x30FAA55EAF29F9BE(0, func_268(uParam1, func_313(uParam2), func_270(uParam2)), 1f, 0, 0, 786603, -1082130432);
				unk_0xCD76801E1106CABE(0, func_41(uParam1, func_313(uParam2)), 0);
				unk_0x93C0674FC00824D0(uParam2->f_15[func_270(uParam2) /*34*/].f_21);
				unk_0x4BD42B0527065BB6(func_64(uParam2), uParam2->f_15[func_270(uParam2) /*34*/].f_21);
				unk_0xD0557B139A542F12(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
			}
			break;
			...
			if (!func_118(uParam0, uParam2, 0))
			{
				if (func_70(uParam1, uParam2) && !func_267(uParam2, func_270(uParam2)))
				{
					if (!func_275(uParam2, 1048576))
					{
						...
						unk_0x974022927CB47E68(func_64(uParam2));
						unk_0xB5396F1FB088FE38(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
						unk_0xA966E518B752B92A(0, func_266(uParam1, func_313(uParam2), func_270(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
						unk_0xCD76801E1106CABE(0, func_327(uParam1, func_313(uParam2)), 0);
						unk_0x93C0674FC00824D0(uParam2->f_15[func_270(uParam2) /*34*/].f_21);
						unk_0x4BD42B0527065BB6(func_64(uParam2), uParam2->f_15[func_270(uParam2) /*34*/].f_21);
						unk_0xD0557B139A542F12(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
					}
					...
					{
						unk_0xB2BD5837A8D3CEDA(func_64(uParam2), func_266(uParam1, func_313(uParam2), func_270(uParam2)), 1, 0, 0, 1);
					}
				}
				else if (func_194(uParam2) || func_275(uParam2, 67108864))
				{
					if (!func_275(uParam2, 1048576))
					{
						if (!func_63(uParam2, func_270(uParam2), 0))
						{
							...
							unk_0x974022927CB47E68(func_64(uParam2));
							unk_0xB5396F1FB088FE38(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
							unk_0xA966E518B752B92A(0, func_268(uParam1, func_313(uParam2), func_270(uParam2)), 1f, -1, 1048576000, 0, 1193033728);
							unk_0xCD76801E1106CABE(0, func_41(uParam1, func_313(uParam2)), 0);
							unk_0x93C0674FC00824D0(uParam2->f_15[func_270(uParam2) /*34*/].f_21);
							unk_0x4BD42B0527065BB6(func_64(uParam2), uParam2->f_15[func_270(uParam2) /*34*/].f_21);
							unk_0xD0557B139A542F12(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
					...
					{
						unk_0xB2BD5837A8D3CEDA(func_64(uParam2), func_268(uParam1, func_313(uParam2), func_270(uParam2)), 1, 0, 0, 1);
					}
				}
				else if (!func_275(uParam2, 1048576))
				{
					if (!func_63(uParam2, func_270(uParam2), 0) && unk_0xFC8BFE4B41177C22(func_25(uParam2)))
					{
						if (!unk_0x1C2F771CDC87A3A5(func_25(uParam2), 0))
						{
							unk_0x974022927CB47E68(func_64(uParam2));
							unk_0xB5396F1FB088FE38(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
							unk_0xEBA229B2E0BB05E0(0, func_25(uParam2), -1, func_68(uParam2), 1f, 1, 0, 0);
							unk_0x93C0674FC00824D0(uParam2->f_15[func_270(uParam2) /*34*/].f_21);
							unk_0x4BD42B0527065BB6(func_64(uParam2), uParam2->f_15[func_270(uParam2) /*34*/].f_21);
							unk_0xD0557B139A542F12(&(uParam2->f_15[func_270(uParam2) /*34*/].f_21));
						}
...
void func_77(var uParam0, var uParam1)
{
	if (!bLocal_229)
	{
		...
		func_243(uParam1, unk_0xD1A6A821F5AC81DB(func_250(uParam1), 1));
		func_84(uParam1, system::vdist(func_19(uParam1), func_41(uParam0, func_313(uParam1))));
	}
	else
	{
		unk_0xB2BD5837A8D3CEDA(func_250(uParam1), func_19(uParam1) + Vector(0,05f, 0f, 0f), 1, 0, 0, 1);
		func_82(uParam1);
		func_80(uParam1);
	}
	unk_0xB4E9A7A3A518ECC1(func_250(uParam1), 150f);
...
void func_89(var uParam0, var uParam1, var uParam2)
{
	...
	Var1 = { unk_0xE5741C6B6539231F(iVar0) };
	fVar2 = system::vmag(Var1);
	Var3 = { func_41(uParam1, func_313(uParam2)) };
	Var4 = { unk_0xD1A6A821F5AC81DB(iVar0, 1) };
	unk_0x43C223EA02402E66(iVar0, 0, 2,96f);
	unk_0x43C223EA02402E66(iVar0, 3, 2,96f);
	iVar5 = func_102(uParam1, func_313(uParam2));
	...
	{
		func_59(uParam2, unk_0xD1A6A821F5AC81DB(iVar0, 1), func_99(unk_0x28637BDE402A5913(iVar0)));
		func_74(uParam2, 2);
		func_311(uParam0, 268435456);
		if (unk_0xFC8BFE4B41177C22(iVar5))
		{
			if (unk_0x685171EED42BC4DF(iVar0, iVar5) && !func_275(uParam2, 268435456))
			{
				unk_0xBD618A73193F9982(-1, "GOLF_BALL_IMPACT_FLAG_MASTER", func_250(uParam2), 0, 0, 0);
				unk_0x44C48AC14D3C09ED(iVar5, 0, 0);
	...
	{
		if (!func_279(uParam0, 268435456) && system::vdist2(Var4, Var3) < (0,3f * 0,3f))
		{
			unk_0xBD618A73193F9982(-1, "GOLF_BALL_CUP_MISS_MASTER", func_250(uParam2), 0, 0, 0);
			func_125(uParam0, 268435456);
		}
	}
	if (((fVar2 < 0,25f || (fVar2 < 6f && func_98(uParam1, uParam2))) || func_275(uParam2, 256)) || func_97())
	{
		if (!func_96(&(uParam2->f_159)))
		{
			func_59(uParam2, unk_0xD1A6A821F5AC81DB(iVar0, 1), func_99(unk_0x28637BDE402A5913(iVar0)));
			func_58(uParam2, unk_0xB6BF12B4CF844B3E(iVar0));
			if (func_98(uParam1, uParam2))
			{
			}
			func_260(&(uParam2->f_159));
		}
		if ((!func_98(uParam1, uParam2) && (((func_275(uParam2, 256) || system::vdist2(Var4, Var3) < (0,1601f * 0,1601f)) || func_97()) || func_93(uParam1, uParam2))) && 0)
		{
			func_92(iVar0, Var4, Var3);
			func_74(uParam2, 256);
		}
		else if (func_171(&(uParam2->f_159), 0,5f))
		{
			...
			unk_0x3A95CBA6857C4C37(iVar0, 0);
	...
	{
		unk_0xB2BD5837A8D3CEDA(iVar0, func_90(uParam2), 1, 0, 0, 1);
		unk_0x3A95CBA6857C4C37(iVar0, 0);
		func_202(iVar0, 1);
		func_263(uParam2, 6);
		func_74(uParam2, 68);
...
void func_92(int iParam0, struct<2> Param1, Vector3 vParam2, struct<2> Param3, var uParam4)
{
	struct<3> Var0;
	
	Var0 = { func_6(Vector(0f, Param3.f_1, Param3.f_0) - Vector(0f, Param1.f_1, Param1.f_0)) * Vector(9f, 9f, 9f) };
	unk_0xE592D924D5438108(iParam0, 0, Var0, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
}
...
int func_93(var uParam0, var uParam1)
{
	...
	if (system::vdist(Var0, func_41(uParam0, func_313(uParam1))) > fVar1)
	{
		return 0;
	}
	return 1;
...
int func_98(var uParam0, var uParam1)
{
	...
	if (!unk_0xFC8BFE4B41177C22(func_250(uParam1)))
	{
		return 0;
	}
	Var0 = { unk_0xD1A6A821F5AC81DB(func_250(uParam1), 0) };
	Var1 = { func_41(uParam0, func_313(uParam1)) };
	if (system::vdist2(Var0, Var1) > (0,25f * 0,25f))
	{
		return 0;
	}
	if (func_35(uParam1) == 8)
	{
		if (Var0.f_2 < (Var1.f_2 + 0,11f))
		{
			return 1;
		}
	}
	if (system::vdist2(Var0, Var1) < (0,1f * 0,1f))
	{
...
int func_100(var uParam0, var uParam1, var uParam2)
{
	...
	uVar0 = func_250(uParam2);
	if (unk_0x69799E0840A34AFB(uVar0))
	{
		unk_0x3A95CBA6857C4C37(uVar0, 0);
		func_202(iVar0, 1);
...
{
	unk_0xBD618A73193F9982(-1, "GOLF_BALL_IN_WATER_MASTER", func_250(uParam0), 0, 0, 0);
	return;
	unk_0xE56FEB6B12B5A32C("scr_golf_landing_water", unk_0xD1A6A821F5AC81DB(func_250(uParam0), 1), 0f, 0f, func_248(unk_0xD1A6A821F5AC81DB(func_250(uParam0), 1), func_19(uParam0)), 1065353216, 0, 0, 0);
}
...
void func_105(var uParam0, var uParam1, var uParam2)
{
	...
	Var2 = { unk_0xE5741C6B6539231F(iVar0) };
	fVar3 = system::vmag(Var2);
	Var5 = { uParam2->f_1.f_5, uParam2->f_1.f_6, 0f };
	fVar6 = func_116(uParam2);
	Var7 = { func_6(system::cos(fVar6), system::sin(fVar6), 0f) };
	Var8 = { func_115(Var7, 0) };
	Var9 = { Var7 * Vector(-Var5.f_0, -Var5.f_0, -Var5.f_0) * Vector(0,05f, 0,05f, 0,05f) + Var8 * Vector(Var5.f_1, Var5.f_1, Var5.f_1) * Vector(0,2f, 0,2f, 0,2f) };
	unk_0x9E36887F0AA9DF6D(unk_0xD1A6A821F5AC81DB(iVar0, 1), unk_0xD1A6A821F5AC81DB(iVar0, 1) + func_6(Var9), 0, 0, 0, 255);
	if (func_100(uParam0, uParam1, uParam2))
	{
		return;
	}
	if (unk_0x14E25ED5E75102C8(iVar0))
	{
		...
		{
			if (unk_0x685171EED42BC4DF(iVar0, iVar1))
			{
				...
				{
					unk_0x44C48AC14D3C09ED(iVar1, 0, 0);
				}
			}
		}
		fVar10 = 1f;
		...
		fVar12 = 0f;
		fVar13 = 0f;
		switch (func_99(unk_0x28637BDE402A5913(iVar0)))
		{
			case 1:
				fVar10 = 0,89f;
				fVar11 = 0,75f;
		...
		if (!bLocal_232)
		{
			Var9 = { Var7 * Vector(-Var5.f_0, -Var5.f_0, -Var5.f_0) * Vector(0,2f, 0,2f, 0,2f) + Var8 * Vector(Var5.f_1, Var5.f_1, Var5.f_1) * Vector(0,2f, 0,2f, 0,2f) };
			Var9 = { Var9 * Vector(fVar12, fVar12, fVar12) };
			unk_0xE592D924D5438108(iVar0, 0, Var9, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
		}
		func_114(&(uParam2->f_1));
		if (!func_279(uParam0, 64))
		{
			if (fVar11 != 0f && system::vmag2(Var2) > 9,5f)
			{
				unk_0x1C23EBEE3AABD4C7(unk_0xD1A6A821F5AC81DB(iVar0, 1) + Vector(1f, 0f, 0f), &uVar4, &Var15);
				Var16 = { FtoV(func_8(Local_239, Var15)) * Var15 };
				Var14 = { FtoV(-(1f + fVar11)) * Var16 + Local_239 };
				Var17 = { Local_239 - Var16 };
				Var14 = { Var14 - Var17 * Vector(fVar13, fVar13, fVar13) };
				unk_0x1AB7223AC0702871(iVar0, Var14);
			}
			func_125(uParam0, 64);
		...
		{
			Var18 = { unk_0xE5741C6B6539231F(iVar0) };
			if (fVar10 != 1f)
			{
				Var18 = { Var18 * Vector(fVar10, fVar10, fVar10) };
				unk_0x1AB7223AC0702871(iVar0, Var18);
			}
		}
	}
	else
	{
		...
		{
			Var19 = { func_6(uParam0->f_16, uParam0->f_16.f_1, 0f) * Vector(uParam0->f_20, uParam0->f_20, uParam0->f_20) * Vector(0,5f, 0,5f, 0,5f) };
			unk_0xE592D924D5438108(iVar0, 0, Var19, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
		}
		if (!bLocal_232)
		{
			unk_0xE592D924D5438108(iVar0, 0, Var9, 0f, 0f, 0f, 0, 0, 0, 1, 0, 1);
	...
	if (func_110(uParam2))
	{
		unk_0x97A041099E92C69F(0, 50, func_108(0, func_109(256, (unk_0x510D0699BE9C6D06(system::round(uParam2->f_1.f_6)) + unk_0x510D0699BE9C6D06(system::round(uParam2->f_1.f_5))) + 30)));
	}
	if (!func_275(uParam2, 2))
	{
		...
		if (unk_0x14E25ED5E75102C8(iVar0) && func_257(&(uParam2->f_159), 0,2f))
		{
			...
			func_78(uParam2, system::vdist(unk_0xD1A6A821F5AC81DB(iVar0, 1), func_19(uParam2)));
			func_74(uParam2, 2);
			func_169(&(uParam2->f_159));
			func_106(uParam2);
		}
	...
	{
		func_92(iVar0, unk_0xD1A6A821F5AC81DB(iVar0, 1), func_41(uParam1, func_313(uParam2)));
	}
	else if ((fVar3 < 0,5f && (unk_0x1D5CD3EAAA7422B0(uParam2->f_1.f_5) + unk_0x1D5CD3EAAA7422B0(uParam2->f_1.f_6)) < 0,05f) || (fVar3 < 6f && func_98(uParam1, uParam2)))
	{
		if (!func_96(&(uParam2->f_159)))
		{
			func_59(uParam2, unk_0xD1A6A821F5AC81DB(iVar0, 1), func_99(unk_0x28637BDE402A5913(iVar0)));
		...
		if (func_171(&(uParam2->f_159), 1f))
		{
			...
			else
			{
				...
				if (func_110(uParam2))
				{
					unk_0x97A041099E92C69F(0, 10, 10);
				}
			}
			func_74(uParam2, 4);
			func_202(iVar0, 1);
	...
	{
		Local_239 = { unk_0xE5741C6B6539231F(iVar0) };
	}
	func_311(uParam0, 32);
}
...
void func_106(var uParam0)
{
	...
	sVar0 = "";
	switch (unk_0x28637BDE402A5913(func_250(uParam0)))
	{
		case -461750719:
		case 930824497:
	...
	if (!func_107(sVar0))
	{
		unk_0xE56FEB6B12B5A32C(sVar0, unk_0xD1A6A821F5AC81DB(func_250(uParam0), 1), 0f, 0f, func_248(unk_0xD1A6A821F5AC81DB(func_250(uParam0), 1), func_19(uParam0)), 1065353216, 0, 0, 0);
	}
}
...
void func_112(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_107(sVar0))
	{
		if (bParam1)
		{
			unk_0xF37CDE164C892195(-1, sVar0, unk_0xD1A6A821F5AC81DB(func_250(uParam0), 1), 0, 0, 0, 0);
		}
		else
		{
			unk_0xBD618A73193F9982(-1, sVar0, func_250(uParam0), 0, 0, 0);
		}
	}
}
...
{
	return unk_0xDF93B3CFAC96698F(iParam0) < 6f;
}
...
void func_114(var uParam0)
{
	...
	Var0 = { func_6(uParam0->f_5, uParam0->f_6, 0f) * Vector(25f, 25f, 25f) * FtoV(unk_0x0B852B0BF94A8DC1()) };
	Var1 = { -Var0 };
	if (unk_0x1D5CD3EAAA7422B0(uParam0->f_5) < unk_0x1D5CD3EAAA7422B0(Var0.f_0))
	{
		uParam0->f_5 = 0f;
	}
	else
	...
	if (unk_0x1D5CD3EAAA7422B0(uParam0->f_6) < unk_0x1D5CD3EAAA7422B0(Var0.f_1))
	{
		uParam0->f_6 = 0f;
	}
	else
...
Vector3 func_115(struct<3> Param0, int iParam1)
{
	struct<3> Var0;
...
int func_118(var uParam0, var uParam1, bool bParam2)
{
	...
	if (unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar2, 3))
	{
		if (unk_0x82E64DE58A6B84A8(iVar0, func_119(0), &cVar2) > 0,95f)
		{
			return 0;
		}
	}
	if (bParam2)
	{
		if (!unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar2, 3) && (((unk_0x13CCB1AD131C1082(iVar0, func_119(0), "iron_swing_action", 3) || unk_0x13CCB1AD131C1082(iVar0, func_119(0), "putt_action", 3)) || unk_0x13CCB1AD131C1082(iVar0, func_119(0), "wedge_swing_action", 3)) || unk_0x13CCB1AD131C1082(iVar0, func_119(0), "wood_swing_action", 3)))
		{
			unk_0x10425721983AE158(iVar0, func_119(0), &cVar2, 8f, -2f, -1, 0, 0, 0, 0, 0);
		}
		return 1;
	}
	return 0;
...
int func_124(int iParam0, float fParam1)
{
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		if (unk_0x13CCB1AD131C1082(iParam0, func_119(0), &cVar0, 3))
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar0) >= fParam1)
			{
				return 1;
			}
		}
		else if (unk_0x13CCB1AD131C1082(iParam0, func_119(0), &cVar1, 3))
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar1) >= fParam1)
			{
				return 1;
			}
		}
		else if (unk_0x13CCB1AD131C1082(iParam0, func_119(0), &cVar2, 3))
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar2) >= fParam1)
			{
				return 1;
			}
		}
		else if (unk_0x13CCB1AD131C1082(iParam0, func_119(0), &cVar3, 3))
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar3) >= fParam1)
			{
				return 1;
			}
		}
...
int func_126(var uParam0, var uParam1, var uParam2)
{
	...
	unk_0x3A95CBA6857C4C37(func_250(uParam2), 1);
	unk_0x2493F314750274C9(func_250(uParam2), -1f, -1f, 0f, 0f, 0,01f, -1f, -1f, -1f, -1f, -1f, -1082130432);
	bVar0 = func_85(uParam2) == 4;
	fVar1 = func_142(&(uParam2->f_15[func_270(uParam2) /*34*/]), uParam0, &(uParam2->f_1), bVar0, !bLocal_230, 0);
	fVar2 = 1f;
	...
	switch (uParam2->f_1)
	{
		case 4:
			...
			{
				fVar4 = (fVar4 + (25f * unk_0xD2AA6F822D3A55D2(-1f, 1f)));
			}
			if (!bVar0)
			{
				uParam2->f_1.f_5 = 0f;
		...
		case 6:
			if (!func_194(uParam2))
			{
				fVar1 = (fVar1 * unk_0xD2AA6F822D3A55D2(0,15f, 0,25f));
				fVar3 = (fVar3 * unk_0xD2AA6F822D3A55D2(0,25f, 1,25f));
			}
			if (uParam2->f_1.f_7 < 0)
			{
				fVar4 = (func_116(uParam2) + (90f * unk_0xD2AA6F822D3A55D2(0f, 1f)));
				uParam2->f_1.f_5 = (unk_0xD2AA6F822D3A55D2(0f, 20f) * fVar5);
			}
			else
			{
				fVar4 = (func_116(uParam2) + (90f * unk_0xD2AA6F822D3A55D2(-1f, 0f)));
				uParam2->f_1.f_5 = (unk_0xD2AA6F822D3A55D2(-20f, 0f) * fVar5);
			}
			uParam2->f_1.f_6 = (unk_0xD2AA6F822D3A55D2(-20f, 20f) * fVar5);
			break;
	...
	else
	{
		...
		Var7 = { func_132(func_85(uParam2) == 4, 0f, 0f, 1f, -func_133(uParam2)) };
		Var8 = { func_6(system::cos(fVar4), system::sin(fVar4), 0f) };
		Var9 = { -func_6(Var8 - FtoV(func_8(Var8, Var7)) * Var7) };
		Var10 = { func_6(-Var8 * Vector(fVar12, fVar12, fVar12) + Var7 * Vector(fVar13, fVar13, fVar13)) };
		Var14 = { func_6(Var9 * Vector(fVar12, fVar12, fVar12) + Var7 * Vector(fVar13, fVar13, fVar13)) };
		fVar15 = func_8(Var8, func_6(Var14.f_0, Var14.f_1, 0f));
		fVar16 = func_27(((Var8.f_0 * Var14.f_1) - (Var8.f_1 * Var14.f_0)) < 0f, -1f, 1f);
		if (unk_0x1D5CD3EAAA7422B0(fVar15) < system::cos(15f))
		{
			Var14 = { func_131(Var14, (fVar16 * (unk_0x42CDD13001C98400(unk_0x1D5CD3EAAA7422B0(fVar15)) - 15f))) };
		}
		Var10.f_1 = ((Var14.f_1 / unk_0x1D5CD3EAAA7422B0(Var14.f_1)) * system::sqrt(unk_0x1D5CD3EAAA7422B0((((Var10.f_2 * Var10.f_2) - 1f) / (((Var14.f_0 * Var14.f_0) / (Var14.f_1 * Var14.f_1)) + 1f)))));
		Var10.f_0 = ((Var14.f_0 * Var10.f_1) / Var14.f_1);
		Var6 = { FtoV((-1f * fVar1)) * Var10 };
	}
	if (bLocal_0)
	{
	...
	unk_0x1AB7223AC0702871(func_250(uParam2), Var6);
	unk_0xB4E9A7A3A518ECC1(func_250(uParam2), 150f);
	func_125(uParam0, 32);
...
void func_127(var uParam0, var uParam1, var uParam2)
{
	...
	{
		case 2:
			if (unk_0x1D5CD3EAAA7422B0(uParam0->f_1.f_4) < 10f)
			{
	...
	if (!func_107(sVar0))
	{
		unk_0xE56FEB6B12B5A32C(sVar0, func_19(uParam0), 0f, 0f, func_116(uParam0), 1065353216, 0, 0, 0);
	}
}
...
void func_128(var uParam0, bool bParam1)
{
	...
	return;
	if (!func_194(uParam0) && unk_0xFC8BFE4B41177C22(func_250(uParam0)))
	{
		uVar0 = unk_0x62750FD2BDD8BD49("scr_golf_ball_trail", func_250(uParam0), 0f, 0f, 0f, 0f, 0f, 0f, 1065353216, 0, 0, 0);
		if (bParam1)
		{
			unk_0x6154AB43546C6437(uVar0, (240f / 255f), (200f / 255f), (80f / 255f), 0);
		}
	}
}
...
void func_129(var uParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!func_107(sVar0))
	{
		if (iParam2 || !unk_0xFC8BFE4B41177C22(func_250(uParam1)))
		{
			unk_0xF37CDE164C892195(-1, sVar0, func_19(uParam1), 0, 0, 0, 0);
		}
		else
		{
			unk_0xBD618A73193F9982(-1, sVar0, func_250(uParam1), 0, 0, 0);
		}
	}
}

int func_130(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
Vector3 func_131(struct<3> Param0, float fParam1)
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
Vector3 func_132(bool bParam0, struct<3> Param1, struct<3> Param2)
{
	if (bParam0)
	{
		return Param1;
...
float func_141(float fParam0, float fParam1)
{
	...
	fVar0 = system::sin(unk_0xD2AA6F822D3A55D2(-180f, 180f));
	if (fVar0 < 0f)
	{
		fVar0 = (fVar0 + 1f);
	}
...
float func_146()
{
	...
	unk_0xDF7F16323520B858(func_147(func_149(), 2), &iVar0, -1);
...
void func_150()
{
	...
	{
		if (func_154(Global_113969.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			iVar0 = func_153(unk_0x4A8C381C258A124D());
			if (func_152(iVar0) && (!func_151(14) || Global_112917))
			{
				if (Global_113969.f_2366.f_539.f_4321 != iVar0 && func_152(Global_113969.f_2366.f_539.f_4321))
				{
...
int func_156(int iParam0)
{
	...
	if (!unk_0x4FAFF4BCB7633475(iParam0))
	{
		...
		if (unk_0x13CCB1AD131C1082(iParam0, func_119(0), &cVar0, 3))
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar0) > 0,16f)
			{
				return 1;
			}
		}
		...
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar1) > 0,134f)
			{
				return 1;
			}
		}
		...
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar2) > 0,119f)
			{
				return 1;
			}
		}
		...
		{
			if (unk_0x82E64DE58A6B84A8(iParam0, func_119(0), &cVar3) > 0,159f)
			{
				return 1;
			}
		}
...
void func_157(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (uParam2->f_12 > 0)
	{
		uParam2->f_12 = (uParam2->f_12 + system::floor((unk_0x0B852B0BF94A8DC1() * 1000f)));
	}
	if ((uParam2->f_11 == 0 && !func_275(uParam0, 1048576)) || func_167(uParam0) == 0)
	{
		func_187(uParam0, 1);
		uParam2->f_11 = unk_0x1DD05E817C89C737();
...
void func_162(var uParam0, var uParam1, int iParam2, float fParam3)
{
	...
	switch (func_136(uParam0))
	{
		...
		case 3:
		case 2:
			unk_0xBD618A73193F9982(-1, "GOLF_FORWARD_SWING_HARD_MASTER", func_163(uParam0), 0, 0, 0);
			break;
...
void func_166(var uParam0)
{
	switch (func_136(uParam0))
	{
		case 0:
		case 1:
			unk_0xBD618A73193F9982(-1, "GOLF_BACK_SWING_HARD_MASTER", func_163(uParam0), 0, 0, 0);
			break;
...
int func_172(var uParam0, var uParam1)
{
	...
	if (unk_0xFC8BFE4B41177C22(func_173(uParam1)) && func_35(uParam1) == 3)
	{
		return 1;
	}
	if (!unk_0xFC8BFE4B41177C22(iVar0))
	...
	Var1 = { unk_0xD1A6A821F5AC81DB(func_250(uParam1), 0) };
...
void func_176(var uParam0, var uParam1, var uParam2)
{
	...
	{
		uVar6 = func_178(uParam1, uParam0, &uVar5, 0, 0, 0, 0);
		bVar7 = !func_107(uVar6);
		...
		switch (func_168(uParam1))
		{
			...
			case 1:
				...
				if (!unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar10, 3))
				{
					unk_0x10425721983AE158(iVar0, func_119(0), &cVar10, 8f, -8f, -1, 2, 0, 0, 0, 0);
					if (bLocal_0)
					{
					}
				}
				...
				{
					fVar4 = unk_0x82E64DE58A6B84A8(iVar0, func_119(0), &cVar10);
					if (unk_0x82E64DE58A6B84A8(iVar0, func_119(0), &cVar10) >= 0,975f)
					{
						if (bLocal_0)
						{
						}
						unk_0x458AA1A01F53901E(iVar0, func_119(0), &cVar10, 0f);
						if (uParam2->f_10 == 0)
						{
							uParam2->f_10 = unk_0x1DD05E817C89C737();
						}
					}
					else
					{
						unk_0x458AA1A01F53901E(iVar0, func_119(0), &cVar10, 0,6f);
					}
					if (fVar4 < fVar2)
					{
						unk_0x6D75623C644D6F83(iVar0, func_119(0), &cVar10, fVar2);
						unk_0x458AA1A01F53901E(iVar0, func_119(0), &cVar10, 0,8f);
					}
				}
				break;
			...
			case 3:
				...
				if (unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar10, 3))
				{
					...
					if (fVar4 < fVar2)
					{
						unk_0x10425721983AE158(iVar0, func_119(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						func_177(uParam1, 0);
					}
					else
					{
						unk_0x6D75623C644D6F83(iVar0, func_119(0), &cVar10, (fVar4 - fVar3));
						if (bLocal_0)
						{
						}
					}
				...
				{
					if (!unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar9, 3))
					{
						unk_0x10425721983AE158(iVar0, func_119(0), &cVar9, 4f, -8f, -1, 10, 0, 0, 0, 0);
						if (bLocal_0)
						{
			...
			case 4:
				...
				if (!unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar11, 3))
				{
					if (unk_0x67C276550F2DBF33(iVar0, func_119(0), &cVar10, 3))
					{
						unk_0x10425721983AE158(iVar0, func_119(0), &cVar11, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
					}
					else if (unk_0x13CCB1AD131C1082(iVar0, func_119(0), &cVar10, 3))
					{
						fVar1 = unk_0x82E64DE58A6B84A8(iVar0, func_119(0), &cVar10);
						unk_0x10425721983AE158(iVar0, func_119(0), &cVar11, 8f, -8f, -1, 2, 0, 0, 0, 0);
						if (bLocal_0)
						{
						}
...
char* func_178(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, int iParam6)
{
	...
	Var2 = { unk_0xD1A6A821F5AC81DB(func_299(uParam0), 1) };
	if (bParam3)
	{
		Var2 = { iParam4, iParam5, iParam6 };
	}
	Var3 = { func_278(uParam0) };
	fVar4 = 52,25f;
	func_183(iVar1, &fVar4, &fVar5, &fVar6);
	Var2.f_2 = (Var2.f_2 + fVar6);
	Var7 = { unk_0x90D0E0397D3F7690(func_299(uParam0)) };
	Var8 = { func_6(Var3 - Var2) };
	Var9 = { func_131(Var7, 90f) };
	Var10 = { Var7 };
	func_179(&Var10, fVar4, Var9);
	fVar11 = unk_0x42CDD13001C98400(func_8(Var7, Var8));
	fVar12 = (fVar11 - fVar4);
	Var13 = { func_6(Var10) };
	func_179(&Var13, fVar12, Var9);
	unk_0x9E36887F0AA9DF6D(Var2, Var2 + Var8, 255, 0, 0, 255);
	unk_0x9E36887F0AA9DF6D(Var2, Var2 + Var7, 0, 0, 255, 255);
	unk_0x9E36887F0AA9DF6D(Var2, Var2 + Var13, 255, 255, 255, 255);
	unk_0x9E36887F0AA9DF6D(Var2, Var2 + Var10, 0, 0, 0, 255);
	if (fVar11 < fVar4)
	{
		*uParam2 = (unk_0x1D5CD3EAAA7422B0(fVar12) * fVar5);
		if (*uParam2 > 0,9999f)
		{
			*uParam2 = 0,9999f;
		}
...
Vector3 func_180(struct<3> Param0, struct<3> Param1)
{
	struct<3> Var0;
	
	Var0 = { Param1 * FtoV(func_8(Param0, Param1)) };
	return Var0;
}

Vector3 func_181(struct<3> Param0, struct<3> Param1)
{
...
Vector3 func_182(struct<3> Param0, struct<3> Param1)
{
	struct<3> Var0;
	
	Var0 = { Param0 - func_180(Param0, Param1) };
	return Var0;
}
...
{
	uParam0->f_1 = (func_191(BitTest(*uParam0, 4)) - fParam1);
...
int func_193(var uParam0)
{
	...
	{
		if (unk_0x9B5C1660CCDF7189(func_64(uParam0), joaat("script_task_perform_sequence")) == 1)
		{
			if (unk_0x89EC60A4485FD199(func_64(uParam0)) == 2)
			{
				return 1;
			}
		}
	}
	else if (unk_0x9B5C1660CCDF7189(func_64(uParam0), joaat("script_task_perform_sequence")) != 1 && unk_0x9B5C1660CCDF7189(func_64(uParam0), joaat("script_task_perform_sequence")) != 0)
	{
		return 1;
	}
	return 0;
...
Vector3 func_196(var uParam0, var uParam1)
{
	...
	{
		Var0 = { unk_0xF10F2A2453AF1DFB(func_19(uParam0), (func_116(uParam0) + fVar1), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0) /*34*/])))) * ((func_165(uParam0, 1) * fVar2) / 100f)), 0f, 0f) };
	}
	else if (func_35(uParam0) != 3)
	{
		Var0 = { unk_0xF10F2A2453AF1DFB(func_19(uParam0), func_116(uParam0), (((-func_144(uParam1, func_140(uParam0)) * func_197(func_136(uParam0))) * func_143(func_28(&(uParam0->f_15[func_270(uParam0) /*34*/])))) * (func_165(uParam0, 1) / 100f)), 0f, 0f) };
	}
	else
	{
		Var0 = { unk_0xF10F2A2453AF1DFB(func_19(uParam0), func_116(uParam0), Vector(-uParam0->f_1.f_1, -uParam0->f_1.f_1, -uParam0->f_1.f_1) * Vector(0f, 0f, (func_165(uParam0, 1) / 100f))) };
	}
...
{
	unk_0x5D7CD709B34C90F0(iParam0, iParam1);
}
...
void func_203(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	...
	iVar1 = (func_248(Var0, func_19(uParam1)) + 90f);
	func_204(&(uParam1->f_15[func_270(uParam1) /*34*/]), uParam2, iVar1, 0, iParam3, iParam4, iParam6, bParam7);
}
...
void func_204(var uParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	...
	{
		unk_0x0FD8B5F4BB15CD71(func_299(uParam0), -1);
	}
	else
	{
		iParam5 = 1;
	...
	Var1 = { unk_0xF10F2A2453AF1DFB(func_278(uParam0), func_117(uParam0), func_229(iVar0)) };
	Var2 = { unk_0xD1A6A821F5AC81DB(func_299(uParam0), 1) };
	if (bParam3)
	{
		unk_0x19626F992DC71FB9(func_299(uParam0));
	}
	if (iParam5 || func_40(uParam0, 1048576))
	{
		...
		if (unk_0xB1EAADCB692D69CE(Var1 + Vector(1f, 0f, 0f), &fVar3, 0, 0))
		{
			if ((unk_0x1D5CD3EAAA7422B0((fVar3 - Var2.f_2)) < 0,35f || fVar3 < Var1.f_2) || bParam7)
			{
				Var1.f_2 = fVar3;
			}
		}
		...
		else
		{
			...
			if (bVar4)
			{
				unk_0x5C96CEA06531AB03(func_299(uParam0), func_117(uParam0));
				unk_0xB2BD5837A8D3CEDA(func_299(uParam0), Var1, 0, 1, 1, 1);
			}
		}
	}
	else
	{
		unk_0x974022927CB47E68(func_299(uParam0));
		unk_0xB5396F1FB088FE38(&(uParam0->f_21));
		if (func_244() || func_186(uParam0))
		{
			unk_0xA966E518B752B92A(0, Var1, 1f, -1, 0,25f, 512, iParam2);
			unk_0x10425721983AE158(0, "mini@golfai", "putt_approach_no_ball", 2f, -4f, -1, 0, 0, 0, 0, 0);
			unk_0x10425721983AE158(0, "mini@golfai", "putt_approach_no_ball", 4f, -4f, -1, 2, 0,999f, 0, 0, 0);
		}
		else
		{
			unk_0xA966E518B752B92A(0, Var1, 1f, -1, 0,25f, 512, iParam2);
		}
		unk_0x93C0674FC00824D0(uParam0->f_21);
		unk_0x4BD42B0527065BB6(func_299(uParam0), uParam0->f_21);
		unk_0xD0557B139A542F12(&(uParam0->f_21));
	}
	if (bParam7)
	{
...
void func_205(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	bVar2 = true;
	if (unk_0xFC8BFE4B41177C22(func_164(uParam0)))
	{
		if (iVar1 == unk_0x4B423FAA24E8ABF0(func_164(uParam0)))
		{
			bVar2 = false;
		}
	}
	...
	if (!bParam2 || bVar2)
	{
		...
		{
			unk_0x4D306DD94DD6FDBA(func_164(uParam0), iVar3, unk_0x72F7E39FB49FC0BA(iVar3, 28422), func_207(iVar3, iVar0), func_206(iVar3, iVar0), 0, 0, 0, 0, 2, 1, 0);
		}
	}
}
...
int func_209(var uParam0, var uParam1)
{
	...
	func_38(uParam0);
	uVar0 = unk_0x43AFC452F25F3A2F(func_211(uParam1, func_123(uParam0)), func_278(uParam0), 0, 1, 0, 0);
	return uVar0;
}
...
int func_210(int iParam0, int iParam1)
{
	...
	{
		return ((unk_0x13CCB1AD131C1082(iParam0, func_119(0), "wood_idle_a", 3) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "wood_idle_b", 3)) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "wood_idle_c", 3));
	}
	else if (iParam1 >= 6 && iParam1 <= 13)
	{
		return ((unk_0x13CCB1AD131C1082(iParam0, func_119(0), "iron_idle_a", 3) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "iron_idle_b", 3)) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "iron_idle_c", 3));
	}
	else if (iParam1 >= 14 && iParam1 <= 18)
	{
		return ((unk_0x13CCB1AD131C1082(iParam0, func_119(0), "wedge_idle_a", 3) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "wedge_idle_b", 3)) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "wedge_idle_c", 3));
	}
	else if (iParam1 == 19)
	{
		return ((unk_0x13CCB1AD131C1082(iParam0, func_119(0), "putt_idle_a", 3) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "putt_idle_b", 3)) || unk_0x13CCB1AD131C1082(iParam0, func_119(1), "putt_idle_c", 3));
	}
	return 0;
}
...
void func_212(var uParam0, var uParam1)
{
	...
	func_213(func_299(uParam0), &cVar3, &cVar4, bVar2, fVar0, 1f, 10, 0f, 0f, 0f, 0);
	if (!func_40(uParam0, 32768))
	{
		unk_0xD8ED11B32DF72E0B(func_299(uParam0), 1, 0);
		unk_0x854D2E21A9863405(func_299(uParam0));
...
void func_213(int iParam0, char[4] cParam1, char[4] cParam2, bool bParam3, float fParam4, float fParam5, int iParam6, float fParam7, float fParam8, float fParam9, bool bParam10)
{
	...
	Var1.f_20 = iParam6;
	unk_0x70BCE9B2354D8E3D(iParam0, &Var1, &Var0, &Var0, fParam8, fParam9);
}
...
int func_215(struct<3> Param0, float fParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, float fParam10)
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
	...
	if (!func_224(0))
	{
		if (func_223(unk_0x259BE71D8A81D4FA(), 1, 0) && !(func_222() || func_221()))
		{
			if (((bParam7 && func_220(unk_0x259BE71D8A81D4FA(), 1, 0)) && unk_0x3555462DB47B7AB1()) && Global_2657971[unk_0x259BE71D8A81D4FA() /*465*/].f_233 == 1)
			{
			}
			else if (func_219() == 28)
			{
	...
	if (((!Param0.f_0 == Global_2672855.f_1069 || !Param0.f_1 == Global_2672855.f_1069.f_1) || !Param0.f_2 == Global_2672855.f_1069.f_2) || !fParam1 == Global_2672855.f_1072)
	{
		...
		{
			if (unk_0x775142054EC39277(unk_0x7E3F74F641EE6B27(), Global_2672855.f_1073) < func_218(0))
			{
				return 0;
			}
			unk_0xEB205B72FDDFDFC6();
	...
	if (Global_2672855.f_1067)
	{
		...
		if (Global_2672855.f_1074 > -1)
		{
			...
			if (func_216(&(Global_2672855.f_1074), Param0, fParam1, iVar0))
			{
				func_225(bParam4, bParam7);
				return 1;
			}
...
int func_216(var uParam0, struct<3> Param1, float fParam2, int iParam3)
{
...
void func_225(bool bParam0, bool bParam1)
{
	...
	func_228();
	if (!BitTest(Global_1845281[unk_0x259BE71D8A81D4FA() /*883*/].f_268.f_33, 14) && !func_227())
	{
		func_226();
	}
}
...
int func_227()
{
	if (!unk_0x834C960822A4683F() && !func_224(0))
	{
		return 0;
	}
...
int func_242(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (unk_0xFC8BFE4B41177C22(func_250(uParam1)))
		{
			Var0 = { unk_0xD1A6A821F5AC81DB(func_250(uParam1), 1) };
		}
	}
...
int func_247(struct<3> Param0, float fParam1)
{
	...
	uVar0 = unk_0x4E55EAB577C13329(joaat("prop_golf_ball"), Param0, 1, 1, 0);
	unk_0x7D8D470E05A35981(uVar0, 1);
	unk_0x11C125313CB8ADA2(uVar0, 0);
	unk_0x5C96CEA06531AB03(uVar0, fParam1);
	if (bLocal_0)
	{
	}
	return iVar0;
...
float func_248(struct<2> Param0, Vector3 vParam1, struct<2> Param2, var uParam3)
{
...
void func_254(var uParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)
{
	...
	if (unk_0x1C2F771CDC87A3A5(func_274(uParam0, iParam1), 0))
	{
		func_277(uParam0, 2);
		return;
	}
	fVar1 = 144f;
	bVar6 = system::vdist2(unk_0xD1A6A821F5AC81DB(func_294(uParam0, func_272(uParam0, iParam1)), 1), uParam0->f_15[iParam1 /*34*/].f_10) < fVar1;
	if (!unk_0xCECDBB848D53DEB2(iVar2, func_274(uParam0, iParam1), 0) && !bVar6)
	{
		if (unk_0x9B5C1660CCDF7189(iVar2, joaat("script_task_enter_vehicle")) != 1)
		{
			unk_0xEBA229B2E0BB05E0(iVar2, func_274(uParam0, iParam1), -1, -1, 1f, 1, 0, 0);
		}
		return;
	}
	iVar7 = 786603;
	...
	if (((unk_0xFC8BFE4B41177C22(iVar2) && !unk_0x1C2F771CDC87A3A5(iVar2, 0)) && unk_0x9B5C1660CCDF7189(iVar2, joaat("script_task_vehicle_drive_to_coord")) != 1) && !func_40(&(uParam0->f_15[iParam1 /*34*/]), 33554432))
	{
		...
		func_3(Var4 + Var5, func_41(uParam2, func_313(uParam0)), &(uParam0->f_15[iParam1 /*34*/].f_10), &fVar0, 0f, 0f, 0f, 0f, 0f, 0f, 0);
		unk_0xCF6CC9EA0D2EFE23(func_284(uParam0, func_256(uParam0, iParam1)), func_274(uParam0, iParam1), uParam0->f_15[iParam1 /*34*/].f_10, 4f, 0, 0, iVar7, 4f, -1f);
	}
	if (bVar6)
	{
		unk_0x974022927CB47E68(func_284(uParam0, func_256(uParam0, iParam1)));
		func_57(&(uParam0->f_15[iParam1 /*34*/]), 33554432);
		if (!func_267(uParam0, -1))
		{
			unk_0xD5094C4B174E9016(func_274(uParam0, iParam1));
			iVar8 = 1;
			func_20(uParam0, uParam2, func_272(uParam0, iParam1), 0, 36581, 45421);
			iVar3 = 0;
			while (iVar3 < func_320(uParam0))
			{
				if (unk_0xFC8BFE4B41177C22(func_284(uParam0, iVar3)) && !unk_0x1C2F771CDC87A3A5(func_284(uParam0, iVar3), 0))
				{
					if (unk_0x7F420695E3F776FB(func_284(uParam0, iVar3), 0))
					{
						iVar8 = 0;
					}
				}
		...
		else if ((system::vdist2(func_265(uParam0, iParam1), func_41(uParam2, func_313(uParam0))) < 1600f && system::vdist2(unk_0xD1A6A821F5AC81DB(func_274(uParam0, iParam1), 1), func_41(uParam2, func_313(uParam0))) < 1600f) && !func_298(uParam0, iParam1, 67108864))
		{
			func_20(uParam0, uParam2, func_272(uParam0, iParam1), 1, 38314, 7443);
			if (bParam3)
			{
				func_277(uParam0, 2);
			}
		}
		else if (unk_0x7F420695E3F776FB(func_284(uParam0, iParam1), 0))
		{
			unk_0x2D864CC37DDFA963(func_284(uParam0, func_256(uParam0, iParam1)), func_274(uParam0, iParam1), unk_0xD1A6A821F5AC81DB(func_274(uParam0, iParam1), 1), 0f, 3, 360f, 0);
			if (bParam3)
			{
				unk_0x092B9247AF00F5CF(func_284(uParam0, iParam1), 0, 0);
				func_277(uParam0, 2);
...
float func_258(var uParam0)
{
	if (func_96(uParam0))
	{
		...
		{
			return (func_191(BitTest(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}
...
int func_262(var uParam0, int iParam1)
{
	...
	while (iVar0 < func_320(uParam0))
	{
		if (iVar0 >= iParam1)
		{
			if (!unk_0x1C2F771CDC87A3A5(func_284(uParam0, iVar0), 0) && !unk_0x1C2F771CDC87A3A5(func_274(uParam0, iVar0), 0))
			{
				if ((!unk_0xCECDBB848D53DEB2(func_284(uParam0, iVar0), func_274(uParam0, iVar0), 0) && !func_298(uParam0, iVar0, 16777216)) && !func_298(uParam0, iVar0, 67108864))
				{
					return 0;
				}
			}
...
int func_269(var uParam0, var uParam1, int iParam2)
{
	...
	Var1 = { unk_0xD1A6A821F5AC81DB(func_251(&(uParam1->f_15[iParam2 /*34*/])), 0) };
	if (system::vdist2(Var1, func_41(uParam0, func_313(uParam1))) > (55f * 55f))
	{
		return 0;
	}
...
float func_273(int iParam0, int iParam1, int iParam2)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_286(int iParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	bool bVar1;
	...
	if (!unk_0x1C2F771CDC87A3A5(iVar0, 0) && !unk_0x1C2F771CDC87A3A5(iParam0, 0))
	{
		...
		if (bParam4)
		{
			if (func_287(iParam0, uParam1, 1, bParam6, bVar1, 1))
			{
				*uParam3 = 32;
				return 1;
			}
		...
		{
			if (func_287(iParam0, uParam1, 0, bParam6, bVar1, bParam8))
			{
				*uParam3 = 16;
				return 1;
			}
...
int func_287(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if (bParam3)
	{
		if (!bLocal_243)
		{
			iLocal_244 = unk_0x8D91ADE44AC79BC9(iParam0);
			bLocal_243 = true;
		}
		iLocal_245 = unk_0x8D91ADE44AC79BC9(iParam0);
		iLocal_246 = (iLocal_244 - iLocal_245);
		uVar0 = unk_0xDC8D5832207C2EAD();
		if (!unk_0x1C2F771CDC87A3A5(uVar0, 0))
		{
			if (unk_0x9B3D4335E0EDB0BE(iParam0, iVar0, 1))
			{
				if (IntToFloat(iLocal_246) > 100f)
				{
					return 1;
				}
			}
	...
	if (func_288(unk_0x4A8C381C258A124D(), iParam0))
	{
		return 1;
	}
	if (bParam2)
	{
		if (unk_0x8BF5256C439DF778(iParam0) && func_295(iParam0, 1) < 1,5f)
		{
			return 1;
		}
...
int func_290(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	...
	if (unk_0x11552FA9DCB8E126(uParam0, 2))
	{
		...
		else
		{
			...
			if (unk_0x74CD4FE549433E92(iParam0) || func_291(iVar1))
			{
				if (unk_0x65FFA94B82A71741(iParam1, unk_0xD1A6A821F5AC81DB(iParam0, 1), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), IntToFloat(uParam2->f_6 * 3), 0, 1, 0))
				{
					if (unk_0x3644984C9D7B57EF(unk_0xBD545F8729E9F413(iParam1), iParam0, 120f) && unk_0xAD915B5E38F323E5(iParam1, iParam0, 17))
		...
		if (unk_0xD9F5E1FEFD1329E4(iParam0, 0))
		{
			if (unk_0xFD5C5BBD1FE92BB7(iParam0, -1, 0) != 0)
			{
				if (unk_0x23B29877D0BE9547(unk_0x4A8C381C258A124D(), &iVar0, 1))
				{
					...
					{
						if (func_273(unk_0x4A8C381C258A124D(), iParam0, 1) < 40f)
						{
...
{
	return func_273(unk_0x56E414973C2A8C0E(unk_0xB6B621402486C3E4()), iParam0, iParam1);
}
...
void func_296(var uParam0)
{
	...
	while (iVar0 < func_320(uParam0))
	{
		...
		if (unk_0xFC8BFE4B41177C22(uParam0->f_15[iVar0 /*34*/].f_2) && !unk_0x1C2F771CDC87A3A5(uParam0->f_15[iVar0 /*34*/].f_2, 0))
		{
			unk_0x974022927CB47E68(uParam0->f_15[iVar0 /*34*/].f_2);
		}
...
void func_297(var uParam0)
{
	...
	{
		unk_0xB3B56385ECA230B4(&(uParam0->f_5));
	}
}
...
void func_300(var uParam0, int iParam1, var uParam2, int iParam3, var uParam4)
{
	...
	if (!unk_0xFC8BFE4B41177C22(func_299(uParam0)))
	{
		return;
	}
	if (unk_0x1C2F771CDC87A3A5(func_299(uParam0), 0) || unk_0x4FAFF4BCB7633475(func_299(uParam0)))
	{
		return;
	}
	...
	if (unk_0x9B5C1660CCDF7189(func_299(uParam0), joaat("script_task_enter_vehicle")) == 1)
	{
		return;
	}
	...
	Var1 = { unk_0xD1A6A821F5AC81DB(iParam1, 1) };
	Var2 = { unk_0xD1A6A821F5AC81DB(func_299(uParam0), 1) };
	if (system::vdist2(Var2, Var1) > (150f * 150f) && system::vdist2(Var0, Var1) > (150f * 150f))
	{
		if (!func_40(uParam0, 1048576))
		{
			unk_0x7EF69980DE8B28B0(uParam0->f_2, 0);
			unk_0x9FF00EA9A61211D2(uParam0->f_2, 0);
		}
	...
	else
	{
		if (func_40(uParam0, 1048576))
		{
			unk_0x7EF69980DE8B28B0(uParam0->f_2, 1);
			unk_0x9FF00EA9A61211D2(uParam0->f_2, 1);
		}
		func_261(uParam0, 1048576);
	}
	if (system::vdist2(Var0, Var1) > (150f * 150f))
	{
		...
		if (Var0.f_2 > 100f)
		{
			if (unk_0xFC8BFE4B41177C22(uParam0->f_3))
			{
				...
				{
					unk_0xB2BD5837A8D3CEDA(uParam0->f_3, Var0.f_0, Var0.f_1, 50f, 1, 0, 0, 1);
				}
			}
		}
	}
	else
	{
		if (func_40(uParam0, 262144))
		{
			if (unk_0xFC8BFE4B41177C22(uParam0->f_3))
			{
				if (!unk_0x1C2F771CDC87A3A5(uParam0->f_3, 0))
				{
					Var4 = { uParam0->f_7 + Vector(50f, 0f, 0f) };
					if (unk_0xB1EAADCB692D69CE(Var4, &uVar3, 0, 0))
					{
						uParam0->f_7.f_2 = uVar3;
						unk_0xB2BD5837A8D3CEDA(uParam0->f_3, uParam0->f_7, 1, 0, 0, 1);
					}
				}
			}
		...
		{
			fVar5 = system::vdist(Var2, Var0);
			Var6 = { func_6(Var0 - Var2) };
			Var7 = { Var2 + Var6 * Vector(fVar5, fVar5, fVar5) * Vector(0,5f, 0,5f, 0,5f) };
			func_42(uParam2, iParam3, Var7, uParam4, 1, 1);
			if (unk_0x9B5C1660CCDF7189(func_299(uParam0), joaat("script_task_any")) == 1)
			{
				unk_0x974022927CB47E68(func_299(uParam0));
			}
		}
	}
	if (system::vdist2(Var2, Var1) > (150f * 150f))
	{
		func_57(uParam0, 524288);
		if (func_40(uParam0, 262144) && iParam3 == func_270(uParam2))
		{
			if (unk_0x9B5C1660CCDF7189(uParam0->f_2, joaat("script_task_any")) == 1)
			{
	...
	else if (func_40(uParam0, 524288))
	{
		...
		{
			func_267(uParam2, -1);
			if (unk_0xB1EAADCB692D69CE(Var2, &uVar3, 0, 0))
			{
				Var2.f_2 = uVar3;
				unk_0xB2BD5837A8D3CEDA(uParam0->f_2, Var2, 1, 0, 0, 1);
			}
		}
...
{
	if (unk_0xFC8BFE4B41177C22(func_284(uParam0, iParam1)) && !unk_0x1C2F771CDC87A3A5(func_284(uParam0, iParam1), 0))
	{
		if (!unk_0xAD915B5E38F323E5(func_284(uParam0, iParam1), unk_0x4A8C381C258A124D(), 17))
		{
			unk_0x734A9F4537A31459(&(uParam0->f_15[iParam1 /*34*/].f_2));
			return;
		}
		else if (!func_298(uParam0, iParam1, 16777216))
		{
			unk_0xD844F5E50DAB6FF7(func_284(uParam0, iParam1), unk_0x4A8C381C258A124D(), 150f, -1, 0, 0);
		}
		if (unk_0xFFAC548682B3D56E(func_284(uParam0, iParam1)))
		{
			unk_0x974022927CB47E68(func_284(uParam0, iParam1));
			unk_0xD844F5E50DAB6FF7(func_284(uParam0, iParam1), unk_0x4A8C381C258A124D(), 150f, -1, 0, 0);
		}
	}
...
void func_303(var uParam0, var uParam1)
{
	...
	func_54(uParam0, 2);
	func_44(uParam1, uParam0);
	if (!unk_0x4FAFF4BCB7633475(func_284(uParam0, 0)))
	{
		Var0 = { -1238,818f, 109,3903f, 55,91227f };
		uVar1 = func_309(uParam0, 0);
		func_308(uParam0, 0, Var0);
		if (unk_0xFC8BFE4B41177C22(uVar1))
		{
			unk_0x51C8BEA2005931AB(&iVar1);
		}
		...
		unk_0xB2BD5837A8D3CEDA(func_284(uParam0, 0), -1241,802f, 107,3439f, 55,7186f, 1, 0, 0, 1);
		unk_0x5C96CEA06531AB03(func_284(uParam0, 0), 342,8433f);
	}
	if (!unk_0x4FAFF4BCB7633475(func_284(uParam0, 1)))
	{
		Var0 = { -1236,201f, 112,7829f, 56,23418f };
		iVar1 = func_309(uParam0, 1);
		unk_0x19626F992DC71FB9(func_284(uParam0, 1));
		if (unk_0xFC8BFE4B41177C22(iVar1))
		{
			unk_0x51C8BEA2005931AB(&iVar1);
		}
		...
		unk_0xB2BD5837A8D3CEDA(func_284(uParam0, 1), -1243,465f, 104,3183f, 55,5857f, 1, 0, 0, 1);
		unk_0x5C96CEA06531AB03(func_284(uParam0, 1), 306,093f);
	}
	if (unk_0xFC8BFE4B41177C22(func_294(uParam0, 0)) && unk_0xD9F5E1FEFD1329E4(func_294(uParam0, 0), 0))
	{
		unk_0xB2BD5837A8D3CEDA(func_294(uParam0, 0), -1257,234f, 94,0251f, 54,784f, 0, 0, 0, 1);
		unk_0x5C96CEA06531AB03(func_294(uParam0, 0), 240,9284f);
	}
	func_277(uParam0, 2);
}
...
{
	Global_112997.f_1 = (Global_112997.f_1 || iParam0);
}
...
void func_312(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	{
		if (!unk_0xFC8BFE4B41177C22(func_294(uParam1, iVar2)))
		{
			if (iVar2 == 1)
			{
				Var3 = { Vector(10f, 10f, 10f) * unk_0x90D0E0397D3F7690(func_294(uParam1, 0)) };
			}
			if (func_43(func_327(uParam0, iParam2) + Var3, func_41(uParam0, func_313(uParam1)), &Var0, &uVar1))
			{
				func_285(uParam1, unk_0x5779387E956077A6(joaat("caddy"), Var0, uVar1, 1, 1, 0), iVar2);
				unk_0xD772F6AA66750D2B(func_294(uParam1, iVar2), 5, 1);
				unk_0x11C125313CB8ADA2(func_294(uParam1, iVar2), 1);
			}
		}
		iVar2++;
	}
...
void func_314(var uParam0, var uParam1, int iParam2)
{
	...
	if (!unk_0xFC8BFE4B41177C22(func_284(uParam1, iParam2)))
	{
		uVar1 = func_317(&iVar2, 1065437102);
		func_315(uParam1, iParam2, unk_0xB1DBFEB95C0EFB88(iVar2, uVar1, Var0, 0, 1, 1));
		unk_0x5C96CEA06531AB03(func_284(uParam1, iParam2), func_248(Var0, func_327(uParam0, func_313(uParam1))));
		if (unk_0x60C643DC13B0C72B("move_m@golfer@"))
		{
			unk_0xC806A20F4C5AC6AF(func_284(uParam1, iParam2), "move_m@golfer@");
		}
		unk_0x00941975834A0817(func_284(uParam1, iParam2), 1);
	}
}

void func_315(var uParam0, int iParam1, var uParam2)
{
	if (iParam1 < 0 || iParam1 >= uParam0->f_15)
	{
		return;
	}
	func_316(&(uParam0->f_15[iParam1 /*34*/]), uParam2);
}
...
{
	if (unk_0xD2AA6F822D3A55D2(0, 1065353216) < fParam1)
	{
		*iParam0 = 4;
...
void func_321(var uParam0, var uParam1, int iParam2, var uParam3)
{
	func_54(uParam1, iParam2);
	func_324(uParam1, uParam3);
...
{
	return (Global_112997.f_1 && iParam0) != 0;
}
...
{
	Global_112997.f_1 = (Global_112997.f_1 - (Global_112997.f_1 && iParam0));
}
...
void func_342(var uParam0, int iParam1)
{
	...
	func_344(iParam1);
	func_343();
	unk_0x268BE77F77533D03(func_337());
...
void func_344(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		while (iVar1 < func_320(uParam0[iVar0 /*170*/]))
		{
			...
			if (unk_0xFC8BFE4B41177C22((uParam0[iVar0 /*170*/])->f_15[iVar1 /*34*/].f_2))
			{
				unk_0xF09E30AF1B8FB379(&((uParam0[iVar0 /*170*/])->f_15[iVar1 /*34*/].f_2));
			}
			iVar1++;
		}
		if (unk_0xFC8BFE4B41177C22((uParam0[iVar0 /*170*/])->f_152[0]))
		{
			unk_0x68298CA6191CDFDB(&((uParam0[iVar0 /*170*/])->f_152[0]));
		}
		if (unk_0xFC8BFE4B41177C22((uParam0[iVar0 /*170*/])->f_152[1]))
		{
			unk_0x68298CA6191CDFDB(&((uParam0[iVar0 /*170*/])->f_152[1]));
		}
		iVar0++;
	}
}
...
void func_345(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		uVar1 = func_102(uParam0, iVar0);
		if (unk_0xFC8BFE4B41177C22(uVar1) && unk_0x110821AE6C63DD4F(iVar1))
		{
			unk_0xB3B56385ECA230B4(&iVar1);
			unk_0x51C8BEA2005931AB(&iVar1);
		}
		iVar0++;
	}
