...
void __EntryFunction__()
{
	...
	func_24(Var0);
	bLocal_4 = func_4();
	Local_5 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0) };
	func_1();
	while (true)
	{
		system::wait(0);
	...
	while (iVar0 < 20)
	{
		if (func_3(iVar0, &iVar1, &Var2, &Var3, &uVar5))
		{
			if (func_2(Var3, 0f, 0f, 0f, 0))
			{
				...
				unk_0x0B0C9A0F9AAEB7F0(&iVar4, 4);
				unk_0x0B0C9A0F9AAEB7F0(&iVar4, 3);
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						uLocal_3[iVar0] = unk_0x8D4CAF9A056EA9E4(iVar1, Var2, iVar4, uVar5, 1, 0);
					}
				}
				else if (system::vdist2(Var2, Local_5) > 400f)
				{
					...
					{
						uLocal_3[iVar0] = unk_0x8D4CAF9A056EA9E4(iVar1, Var2, iVar4, iVar5, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							uLocal_3[iVar0] = unk_0x8D4CAF9A056EA9E4(iVar1, Var2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						uLocal_3[iVar0] = unk_0x6FCBED6282FF5DA5(iVar1, Var2, Var3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (system::vdist2(Var2, Local_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						uLocal_3[iVar0] = unk_0x6FCBED6282FF5DA5(iVar1, Var2, Var3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
bool func_2(struct<3> Param0, struct<3> Param1, bool bParam2)
{
	if (bParam2)
	{
...
int func_4()
{
	if (Global_2697896 == -15)
	{
		Global_2697896 = func_23();
		func_15(&Global_2697896, 0, 0, 0, 1, 0, 0);
		return 1;
	}
	if (func_5(func_23(), Global_2697896))
	{
		Global_2697896 = func_23();
		func_15(&Global_2697896, 0, 0, 0, 1, 0, 0);
		return 1;
...
int func_23()
{
	...
	func_22(&uVar0, unk_0x4BA5A16068183C5E());
	func_21(&uVar0, unk_0x18E502A71E28968C());
	func_20(&uVar0, unk_0x5295501D0862870D());
	func_18(&uVar0, unk_0xB12880C92EA6EE15());
	func_19(&uVar0, unk_0x8825A6E0A30BDCB8());
	func_17(&uVar0, unk_0x7598FE4545010A75());
	return uVar0;
}
...
int func_25(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_27()
{
	...
	while (iVar0 < 20)
	{
		if (unk_0xB0E14182FAD64944(uLocal_3[iVar0]))
		{
			unk_0xDDFB0941A19702BE(uLocal_3[iVar0]);
		}
		iVar0++;
	}
}
