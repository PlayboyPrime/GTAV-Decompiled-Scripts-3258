...
void __EntryFunction__()
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113056[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_280(&(Global_113056[Var0.f_0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
	if (!func_264(&iVar2, &Var0, Var1, 1f))
	{
		func_263();
	...
	while (true)
	{
		...
		func_210(Var0.f_0);
		func_203(&iLocal_51, &uLocal_52, &(Var0.f_9), Var1, -1295,84f, 4641,98f, 105,33f, -1301,43f, 4641,21f, 105,62f);
		func_196(&Var0, Var1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_181(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_2(var* uParam0)
{
	...
	if (!func_180())
	{
		while (!func_171(*uParam0))
		{
			if (func_170(*uParam0))
			{
				func_158();
			}
			if (!func_211(uParam0, *uParam0 != 2))
			{
	...
	MemCopy(&sVar1, {func_119(*uParam0)}, 4);
...
int func_196(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_187(2))
	{
		if (!func_157())
		{
			if (((func_137(unk_0x4A8C381C258A124D()) && func_137(uParam0->f_28[0])) && (unk_0x1DD05E817C89C737() - uParam0->f_60) > iParam6) && func_202(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_201(&uVar0, iParam4, uParam0->f_28[0], sParam5, 0, 1);
				func_199(&uVar0, cParam2, sParam3, 7, 0, 0);
				uParam0->f_60 = unk_0x1DD05E817C89C737();
				return 1;
			}
		}
		else if (func_197(sParam3))
		{
			if (func_137(unk_0x4A8C381C258A124D()))
			{
				if (func_202(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
				{
					func_155();
				}
			}
...
void func_203(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(uParam2))
		{
			...
			{
				if (func_202(unk_0x4A8C381C258A124D(), Param3, 1) <= 100f)
				{
					func_206(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_202(unk_0x4A8C381C258A124D(), Param4, 1);
					fVar1 = func_202(unk_0x4A8C381C258A124D(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0,5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xDD291722ADDCBD60();
								unk_0x046FF102DCE74A94(uParam2, 5, 8);
								func_204(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xDD291722ADDCBD60();
							unk_0x046FF102DCE74A94(uParam2, 6, 8);
							func_204(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_202(unk_0x4A8C381C258A124D(), Param3, 1) > 120f)
				{
					func_207(iParam0);
				}
			}
...
int func_250(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (((!func_253(&iVar0) || !unk_0xE100DD4F82A51BDE("rcmlastone1")) || !unk_0x92A65766A892EFC6(joaat("weapon_pumpshotgun"))) || !unk_0x92A65766A892EFC6(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_28[0] = unk_0xB1DBFEB95C0EFB88(25, iLocal_50, -1299,02f, 4639,86f, 106,66f, 345,7769f, 1, 1);
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_251(&(uParam0->f_35[0]), iVar0[1], -1303,163f, 4648,085f, 104,9664f, 293,1504f);
				if (unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
				{
...
void func_251(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_252(uParam0);
...
int func_264(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_265((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_265((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_265(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_266(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_266(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
