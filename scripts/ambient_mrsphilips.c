...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		if (system::vdist2(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0), 1973,324f, 3815,594f, 31,42936f) < (fVar1 * fVar1))
		{
...
{
	return unk_0xD69CE161FE614531(2, uParam0, func_52(uParam1));
}
...
{
	return unk_0xF10F2A2453AF1DFB(func_86(), 0f, Param0);
}
...
int func_89(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	Var3 = { Var2 - Var0 };
	Var3 = { func_90(Var3, -Var0.f_3.f_2) };
	Var3 = { func_90(Var3, Var1.f_3.f_2) };
...
int func_98()
{
	return func_99(unk_0x259BE71D8A81D4FA());
}
...
var func_103()
{
	...
	func_113(&uVar0, unk_0x4BA5A16068183C5E());
	func_112(&uVar0, unk_0x18E502A71E28968C());
	func_111(&uVar0, unk_0x5295501D0862870D());
	func_106(&uVar0, unk_0xB12880C92EA6EE15());
	func_105(&uVar0, unk_0x8825A6E0A30BDCB8());
	func_104(&uVar0, unk_0x7598FE4545010A75());
	return uVar0;
}
...
void func_115(int iParam0)
{
	...
	if (unk_0x1226C55CA7D2269A() || func_117())
	{
		uVar0 = iParam0;
		unk_0x012C74D626CB4559(9, &uVar0, 1, 1);
	}
	else if (unk_0x0BA1A956D36B210F() || func_116())
	{
...
void func_118(char* sParam0, var uParam1, int iParam2)
{
	...
	unk_0x048963DA591ECAAF(sParam0, uParam1, iParam2, func_119(0));
}
...
void func_121(int iParam0, var uParam1)
{
	switch (iParam0)
	{
		...
		case 5:
			func_122(uParam1, "Barry3A", func_10(iParam0), 1, 1, 0, 1199,27f, -1255,63f, 34,23f, 381, "BARSTASH", 84, 0, "", 166, 0, 7, 4, 2, 0, 2359, func_123(iParam0), 0, 1);
			break;
		...
		case 8:
			func_122(uParam1, "Dreyfuss1", func_10(iParam0), 0, 2, 4, -1458,97f, 485,99f, 115,38f, 66, "LETTERS_HINT", 106, 0, "", 0, 0, -1, 4, 2, 0, 2359, func_123(iParam0), 0, 0);
			break;
		...
		case 38:
			func_122(uParam1, "Nigel1A", func_10(iParam0), 0, 12, 1, -558,65f, 284,49f, 90,86f, 149, "NIGITEMS", 100, 0, "", 0, 0, 42, 4, 4, 0, 2359, func_123(iParam0), 1, 1);
			break;
		...
		case 49:
			func_122(uParam1, "Paparazzo3A", func_10(iParam0), 0, 14, 2, 305,52f, 157,19f, 102,94f, 389, "PAPPHOTO", 102, 0, "", 0, 0, 51, 4, 2, 0, 2359, func_123(iParam0), 0, 1);
			break;
		...
		case 58:
			func_122(uParam1, "Tonya1", func_10(iParam0), 0, 17, 4, -14,39f, -1472,69f, 29,58f, 66, "AM_H_RCFS", -1, 0, "ambient_TonyaCall", 24, 1, 59, 4, 2, 0, 2359, func_123(iParam0), 0, 1);
			break;
...
int func_152()
{
	return func_147(unk_0x1AF90EB93E0012D6(), 0);
}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_166()) || Global_32951) || func_165()) || func_164(8, -1)) || func_162()) || func_102()) || func_163()) || func_161()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0xFB1E434B5C3D0CEE(unk_0x259BE71D8A81D4FA()) || unk_0x3F18810075C77D41(unk_0x4A8C381C258A124D())) || unk_0x9D6DF8F3584AAC2B(unk_0x4A8C381C258A124D())) || unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D())) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D())) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1)) || unk_0xB96BD3A32937D44E(unk_0x259BE71D8A81D4FA())) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0)) || func_166()) || Global_113016) || Global_32951) || func_165()) || func_164(8, -1)) || func_162()) || func_102()) || func_163()) || func_161()) || Global_113969.f_7691.f_919[iVar0] == 5) || Global_44589 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x8BF5256C439DF778(unk_0x4A8C381C258A124D()) || unk_0x9857C978BD3CBEDA(unk_0x4A8C381C258A124D())) || unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1)) || unk_0x1B32E388988DD296(unk_0x4A8C381C258A124D(), 0)) || func_166()) || Global_113016) || Global_32951) || func_165()) || func_164(8, -1)) || func_102()) || func_163()) || func_161()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_166() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0) || func_164(8, -1)) || func_161()) || func_160()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_167()
{
	...
	switch (iLocal_78)
	{
		...
		case 1:
			if (!func_172(25) && !unk_0x3555462DB47B7AB1())
			{
				func_169("MRSP_01_HELP", 1, 0, -1, 10000, 4, 0, 0, 0);
				func_168(25);
			}
			if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			{
