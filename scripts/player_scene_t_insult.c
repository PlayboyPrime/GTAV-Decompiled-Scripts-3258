#region Local Var
	...
	float fLocal_243 = 0f;
	struct<3> Local_244[2];
	struct<3> Local_245[2];
	float fLocal_246[2] = { 0f, 0f };
...
int func_2()
{
	...
	if (unk_0x5266F1D2AEF6F73A(Global_98843))
	{
		...
		if (!unk_0xD6F9DEE4765092A9(&Local_317))
		{
			if (!iLocal_321)
			{
				...
				else if (func_3(&uLocal_66, "PRSAUD", &Local_317, 3, 0, 0, 0))
				{
					iLocal_321 = 1;
				}
			}
	...
	if (system::vdist(Var2, Local_242) < 100f)
	{
		return 0;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_232)
	{
		...
		{
			Var3 = { unk_0xD1A6A821F5AC81DB(iLocal_232[iVar0], 1) };
			if (system::vdist(Var2, Var3) < 100f)
			{
				return 0;
			}
		}
...
void func_26(int iParam0, int iParam1)
{
	...
	{
		switch (iLocal_233[iParam1])
		{
			case 0:
				if (unk_0x13CCB1AD131C1082(iParam0, &cLocal_296, &(Local_306[iParam1 /*16*/]), 2))
				{
					fVar0 = -1f;
					fVar1 = -1f;
					if (unk_0xA2A6AE50772C4FDB(&cLocal_296, &(Local_306[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1) || func_35(&cLocal_296, &(Local_306[iParam1 /*16*/]), "WalkInterruptible", &fVar0, &fVar1))
					{
						fVar2 = unk_0xBD3B265153D3BA2D(Global_98843);
						if (fVar2 > fVar0)
						{
							unk_0x974022927CB47E68(iParam0);
							unk_0xC0086E5CBF13BBF7(iParam0, -8f, 1);
							unk_0x6EC1B5B2C6C31862(iParam0);
							fVar3 = 1f;
							...
							if (iLocal_65 == 263)
							{
								...
								func_33(iParam0, "GENERIC_FRIGHTENED_HIGH", "A_M_O_TRAMP_01_BLACK_FULL_01", 24, 0);
							}
							if (iLocal_65 == 244)
							{
								fVar3 = 2f;
							...
							unk_0xA966E518B752B92A(iParam0, Local_242 + Local_245[iParam1 /*3*/], fVar3, -1, (fLocal_247[iParam1] * 0,1f), 0, 1193033728);
							unk_0x717804C8C8DA67BF(iParam0, iVar4, 0, 0, 0);
							unk_0xD8ED11B32DF72E0B(iParam0, 0, 0);
							iLocal_233[iParam1] = 1;
							return;
						}
					}
				}
				...
				{
					unk_0x974022927CB47E68(iParam0);
					if (unk_0xD6F9DEE4765092A9(&(Local_307[iParam1 /*16*/])))
					{
						if (func_32(Local_245[iParam1 /*3*/], 0f, 0f, 0f, 0))
						{
							Var5 = { unk_0xD1A6A821F5AC81DB(iParam0, 1) };
							Local_245[iParam1 /*3*/] = { Var5 - Local_242 * Vector(4f, 4f, 4f) };
						}
						if (!unk_0xD6F9DEE4765092A9(&(Local_315[iParam1 /*16*/])))
						{
							unk_0x4669032A1DFBB449(iParam0, &(Local_315[iParam1 /*16*/]), 1048576000);
						}
						unk_0xA966E518B752B92A(iParam0, Local_242 + Local_245[iParam1 /*3*/], 1f, -1, 0,25f, 0, 1193033728);
						iLocal_233[iParam1] = 1;
					}
					else
					{
						if (!unk_0x5266F1D2AEF6F73A(iLocal_316))
						{
							iLocal_316 = unk_0x2EC137C692A52458(Local_242, 0f, 0f, fLocal_243, 2);
							unk_0xBF3497E24DEAD835(iLocal_316, 1);
						}
						iVar6 = 5;
						iVar7 = 144;
						iVar8 = 0;
						if (iLocal_239[0] == joaat("p_trev_rope_01_s") || iLocal_239[1] == joaat("p_trev_rope_01_s"))
						{
							if (!func_31(iVar6, 4))
							{
								func_30(&iVar6, 4);
							...
							unk_0xAAA71DD7E9059338(iLocal_232[iParam1], 1);
							unk_0x3F58BFCF656F0DF1(iLocal_232[iParam1], 0);
							unk_0x81E9E7612B0E4BCE(iLocal_232[iParam1], 0);
							unk_0xF0259D91B002AE9F(iLocal_232[iParam1], 1000);
							unk_0xD25E9BDC14A0B649(iLocal_232[iParam1], unk_0xF8A78594664D23A6(iLocal_232[iParam1]), 0, 0);
							unk_0xE915224DCA36212A(iLocal_232[iParam1], 0);
							unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 64, 1);
							unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 249, 1);
							unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 335, 1);
							iVar9 = 0;
							while (iVar9 < iLocal_238)
							{
								unk_0x999C62072AF920FD(iLocal_238[iVar9], 0);
								unk_0x918FE23DCE5B8322(iLocal_238[iVar9], 0, 0);
								iVar9++;
							}
						}
						if (!func_31(iVar7, 16))
						...
						unk_0x3DA436E63AB0F541(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_307[iParam1 /*16*/]), 1000f, -1000f, iVar6, iVar7, 1000f, iVar8);
						iVar9 = 0;
						while (iVar9 < iLocal_238)
						{
							if (iLocal_239[iVar9] != 0)
							{
								if (!unk_0xD6F9DEE4765092A9(&(Local_312[iVar9 /*16*/])))
								{
									unk_0x381D671BCFC294D9(iLocal_238[iVar9], iLocal_316, &(Local_312[iVar9 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
								}
							}
							iVar9++;
						}
						Local_245[iParam1 /*3*/] = { Local_244[iParam1 /*3*/] };
						iLocal_233[iParam1] = 10;
					}
				}
				break;
			
			case 1:
				if (!unk_0xD11A63E12F198FDB(iLocal_232[iParam1], uLocal_237))
				{
					if (!unk_0xDC469CE2BE7CE722(uLocal_237))
					{
						uLocal_237 = unk_0xAE734C5C560DD787(0);
					}
					if (iParam1 == 0)
					{
						unk_0xFF7B703047EDEC8F(iLocal_232[iParam1], uLocal_237);
					}
					else
					{
						unk_0x03AB73582A77DBD3(iLocal_232[iParam1], uLocal_237);
					}
				}
				if (unk_0x9B5C1660CCDF7189(iParam0, joaat("script_task_follow_nav_mesh_to_coord")) != 1)
				{
					if (fLocal_247[iParam1] == 0f)
					{
						fLocal_247[iParam1] = (system::vmag(Local_245[iParam1 /*3*/]) * 0,75f);
					}
					unk_0xE092C8C5A5EA5F57(iParam0, Local_242 + Local_245[iParam1 /*3*/], fLocal_247[iParam1], 1077936128, 1086324736);
					iLocal_233[iParam1] = 2;
					break;
				}
				if (func_29(iParam0))
				{
					iLocal_233[iParam1] = 3;
					break;
				}
				break;
			...
			case 3:
				iVar10 = 0;
				while (iVar10 < iLocal_233)
				{
					if (iParam1 != iVar10)
					{
						if (iLocal_233[iVar10] != 3 && iLocal_233[iVar10] != 4)
						{
							iLocal_233[iVar10] = 3;
						}
					}
				...
				iLocal_233[iParam1] = 4;
				break;
			
			case 4:
				if (unk_0x9B5C1660CCDF7189(iParam0, joaat("script_task_smart_flee_ped")) != 1)
				{
					iLocal_233[iParam1] = 1;
				}
				break;
			...
			case 10:
				...
				unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 249, 1);
				unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 335, 1);
				if (unk_0x13CCB1AD131C1082(iLocal_232[iParam1], &cLocal_296, &(Local_307[iParam1 /*16*/]), 2))
				{
					if (iLocal_65 == 288)
					{
						if (iLocal_322 <= 0)
						{
							iLocal_322 = (unk_0x1DD05E817C89C737() + unk_0xC5935DFB3F39785A(10000, 15000));
						}
						if (unk_0x75E315E7679F4F24(iParam0))
						{
							iLocal_322 = -1;
						}
						if (iLocal_322 > 0)
						{
							...
							{
								func_27(&uLocal_66, 3, iLocal_232[iParam1], "PIERWOMAN", 0, 1);
								if (func_3(&uLocal_66, "PRSAUD", "TRVS_STRUG", 3, 0, 0, 0))
								{
									iLocal_322 = -1;
								}
							}
				...
				else
				{
					...
					unk_0x3DA436E63AB0F541(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_307[iParam1 /*16*/]), 1000f, -1000f, iVar11, iVar12, 1000f, iVar13);
					iVar14 = 0;
					while (iVar14 < iLocal_238)
					{
						if (iLocal_239[iVar14] != 0)
						{
							if (!unk_0xD6F9DEE4765092A9(&(Local_312[iVar14 /*16*/])))
							{
								unk_0x381D671BCFC294D9(iLocal_238[iVar14], iLocal_316, &(Local_312[iVar14 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
							}
						}
						iVar14++;
					}
				...
				switch (iLocal_235[iParam1])
				{
					...
					case 0:
						iVar15 = unk_0xC5935DFB3F39785A(1500, 4000);
						unk_0xE67051907958B5EB(iLocal_232[iParam1], unk_0x4A8C381C258A124D(), iVar15, 0, 2);
						iLocal_236[iParam1] = ((unk_0x1DD05E817C89C737() + iVar15) + unk_0xC5935DFB3F39785A(500, 2000));
						iLocal_235[iParam1] = 1;
						break;
					
					case 1:
						if (unk_0x1DD05E817C89C737() > iLocal_236[iParam1])
						{
							iLocal_236[iParam1] = 0;
							iLocal_235[iParam1] = 0;
						}
						break;
				}
				if (unk_0x9B3D4335E0EDB0BE(iLocal_232[iParam1], unk_0x4A8C381C258A124D(), 1))
				{
				}
				bVar16 = false;
				if (unk_0x8D91ADE44AC79BC9(iLocal_232[iParam1]) < unk_0xF8A78594664D23A6(iLocal_232[iParam1]))
				{
					bVar16 = true;
				}
				if (unk_0x5B702A5D1F2635BE(iLocal_232[iParam1]))
				{
					bVar16 = true;
				}
				if (bVar16)
				{
					unk_0x7BB893EF8F683419(iLocal_316, 0f);
					unk_0xA7C372501A8A3B23(iLocal_316, 1);
					unk_0xBF3497E24DEAD835(iLocal_316, 0);
					iVar17 = 4;
					iVar18 = 4276;
					iVar19 = 0;
					unk_0x3DA436E63AB0F541(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_308[iParam1 /*16*/]), 8f, -1000f, iVar17, iVar18, 8f, iVar19);
					unk_0x999C62072AF920FD(iLocal_232[iParam1], 0);
					unk_0x72B18C9612CF3DA0(iLocal_232[iParam1], iVar18);
					unk_0x0428AFDCAA63B06E(iLocal_232[iParam1], 208, 1);
					iVar20 = 0;
					while (iVar20 < iLocal_238)
					{
						if (iLocal_239[iVar20] != 0)
						{
							if (!unk_0xD6F9DEE4765092A9(&(Local_313[iVar20 /*16*/])))
							{
								unk_0x381D671BCFC294D9(iLocal_238[iVar20], iLocal_316, &(Local_313[iVar20 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
								unk_0x999C62072AF920FD(iLocal_238[iVar20], 0);
							}
						}
						iVar20++;
					}
					iLocal_233[iParam1] = 11;
					break;
				}
				break;
			...
			case 11:
				...
				else if (unk_0xBD3B265153D3BA2D(iLocal_316) >= 0,99f)
				{
					bVar21 = false;
				}
				if (!bVar21)
				{
					...
					unk_0xA7C372501A8A3B23(iLocal_316, 0);
					unk_0xBF3497E24DEAD835(iLocal_316, 1);
					iVar22 = 0;
					iVar23 = 180;
					iVar24 = 0;
					unk_0x3DA436E63AB0F541(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_309[iParam1 /*16*/]), 1000f, -1000f, iVar22, iVar23, 1000f, iVar24);
					iVar25 = 0;
					while (iVar25 < iLocal_238)
					{
						if (iLocal_239[iVar25] != 0)
						{
							if (!unk_0xD6F9DEE4765092A9(&(Local_314[iVar25 /*16*/])))
							{
								unk_0x381D671BCFC294D9(iLocal_238[iVar25], iLocal_316, &(Local_314[iVar25 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
							}
						}
						iVar25++;
					}
					iLocal_233[iParam1] = 12;
					break;
				}
				break;
			...
			case 12:
				...
				unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 249, 1);
				unk_0x0FB8E752BCC547A9(iLocal_232[iParam1], 335, 1);
				if (!unk_0x13CCB1AD131C1082(iLocal_232[iParam1], &cLocal_296, &(Local_309[iParam1 /*16*/]), 2))
				{
					if (!unk_0x5266F1D2AEF6F73A(iLocal_316))
					{
						iLocal_316 = unk_0x2EC137C692A52458(Local_242, 0f, 0f, fLocal_243, 2);
					}
					unk_0x3DA436E63AB0F541(iLocal_232[iParam1], iLocal_316, &cLocal_296, &(Local_309[iParam1 /*16*/]), 1000f, -1000f, 0, 0, 1148846080, 0);
					iVar26 = 0;
					while (iVar26 < iLocal_238)
					{
						if (iLocal_239[iVar26] != 0)
						{
							if (!unk_0xD6F9DEE4765092A9(&(Local_314[iVar26 /*16*/])))
							{
								unk_0x381D671BCFC294D9(iLocal_238[iVar26], iLocal_316, &(Local_314[iVar26 /*16*/]), &cLocal_296, 8f, 8f, 0, 1148846080);
							}
						}
						iVar26++;
					}
	...
	else
	{
		...
		{
			iVar27 = 0;
			while (iVar27 < iLocal_238)
			{
				if (unk_0xFC8BFE4B41177C22(iLocal_238[iVar27]))
				{
					unk_0xC0086E5CBF13BBF7(iLocal_238[iVar27], -8f, 1);
					unk_0x5D7CD709B34C90F0(iLocal_238[iVar27], 0);
					unk_0xC7D381E526A969D3(iLocal_238[iVar27], 1);
					unk_0xB3B56385ECA230B4(&(iLocal_238[iVar27]));
				}
				iVar27++;
			}
		}
...
int func_28(int iParam0)
{
	...
	if (unk_0x1B32E388988DD296(iParam0, unk_0x4A8C381C258A124D()))
	{
		return 1;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_232)
	{
		...
		{
			if (iLocal_233[iVar0] < 0 && unk_0xFC8BFE4B41177C22(iLocal_232[iVar0]))
			{
				return 1;
			}
		}
...
int func_29(int iParam0)
{
	...
	if (iLocal_65 == 237)
	{
		fVar1 = system::vdist2(unk_0xD1A6A821F5AC81DB(iParam0, 0), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0));
		if (fVar1 < (10f * 10f))
		{
			return 1;
		}
...
void func_33(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4)
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_34(iParam3), iParam4);
}
...
{
	if (unk_0x1B79E937E91F40C3(sParam2, "WalkInterruptible"))
	{
		if (unk_0x1B79E937E91F40C3(cParam0, "SWITCH@TREVOR@SCARES_TRAMP"))
		{
			if (unk_0x1B79E937E91F40C3(uParam1, "trev_scares_tramp_exit_tramp"))
			{
				*fParam3 = 0,8f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x1B79E937E91F40C3(cParam0, "SWITCH@TREVOR@CHASE_STRIPPERS"))
		{
			if (unk_0x1B79E937E91F40C3(sParam1, "EXIT_STRIPPER_01") || unk_0x1B79E937E91F40C3(sParam1, "EXIT_STRIPPER_02"))
			{
				*fParam3 = 0,4f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x1B79E937E91F40C3(cParam0, "SWITCH@TREVOR@THROW_FOOD"))
		{
			if (unk_0x1B79E937E91F40C3(sParam1, "EXIT_Ped"))
			{
				*fParam3 = 0,7f;
				*fParam4 = 1f;
				return 1;
		...
		if (unk_0x5266F1D2AEF6F73A(Global_98843))
		{
			...
			while (iVar0 < iLocal_232)
			{
				if (!unk_0x4FAFF4BCB7633475(iLocal_232[iVar0]))
				{
					...
					fVar6 = -1f;
					fVar7 = -1f;
					if (unk_0xA2A6AE50772C4FDB(&cLocal_296, &(Local_306[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7) || func_35(&cLocal_296, &(Local_306[iVar0 /*16*/]), "WalkInterruptible", &fVar6, &fVar7))
					{
						fVar1 = -8f;
						iVar2 = 2;
						iVar3 = 0;
					...
					unk_0x3DA436E63AB0F541(iLocal_232[iVar0], Global_98843, &cLocal_296, &(Local_306[iVar0 /*16*/]), 1000f, fVar1, iVar2, iVar3, fVar4, iVar5);
					iLocal_233[iVar0] = 0;
				}
				iVar0++;
			}
			...
			{
				if (unk_0xFC8BFE4B41177C22(iLocal_238[iVar0]))
				{
					if (!unk_0xD6F9DEE4765092A9(&(Local_311[iVar0 /*16*/])))
					{
						unk_0x381D671BCFC294D9(iLocal_238[iVar0], Global_98843, &(Local_311[iVar0 /*16*/]), &cLocal_296, 8f, -1000f, 0, 1148846080);
					}
				}
				iVar0++;
			}
...
int func_38()
{
	...
	if (unk_0x5266F1D2AEF6F73A(Global_98842))
	{
		...
		while (iVar0 < iLocal_232)
		{
			if (!unk_0x4FAFF4BCB7633475(iLocal_232[iVar0]))
			{
				unk_0x3DA436E63AB0F541(iLocal_232[iVar0], Global_98842, &cLocal_296, &(Local_305[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
			}
			iVar0++;
		}
		iVar0 = 0;
		while (iVar0 < iLocal_238)
		{
			if (unk_0xFC8BFE4B41177C22(iLocal_238[iVar0]))
			{
				if (!unk_0xD6F9DEE4765092A9(&(Local_310[iVar0 /*16*/])))
				{
					unk_0x381D671BCFC294D9(iLocal_238[iVar0], Global_98842, &(Local_310[iVar0 /*16*/]), &cLocal_296, 8f, -1000f, 0, 1148846080);
				}
			}
			iVar0++;
		}
		if (!unk_0xD6F9DEE4765092A9(&Local_317))
		{
			func_27(&uLocal_66, 2, unk_0x4A8C381C258A124D(), "TREVOR", 0, 1);
			func_27(&uLocal_66, 7, iLocal_232[0], "STRIPPER1", 0, 1);
			func_27(&uLocal_66, 8, iLocal_232[1], "STRIPPER2", 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_47()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		{
			if (iLocal_234[iVar0] != 0)
			{
				unk_0xEC9DAA34BBB4658C(iLocal_234[iVar0]);
				if (!unk_0x6252BC0DD8A320DB(iLocal_234[iVar0]))
				{
					bVar2 = false;
					unk_0xEC9DAA34BBB4658C(iLocal_234[iVar0]);
				}
			}
			if (!unk_0xD6F9DEE4765092A9(&(Local_315[iVar0 /*16*/])))
			{
				unk_0x73DEEAB0747FB17C(&(Local_315[iVar0 /*16*/]));
				if (!unk_0x8175BC6D49412468(&(Local_315[iVar0 /*16*/])))
				{
					bVar2 = false;
				}
			}
		...
		unk_0x80813AC549A1E8AE(&cLocal_296);
		if (!unk_0xE100DD4F82A51BDE(&cLocal_296))
		{
			bVar2 = false;
			unk_0x80813AC549A1E8AE(&cLocal_296);
		}
	...
	while (iVar0 < iLocal_232)
	{
		if (iLocal_234[iVar0] != 0)
		{
			iLocal_232[iVar0] = unk_0xB1DBFEB95C0EFB88(26, iLocal_234[iVar0], Local_242 + Local_244[iVar0 /*3*/], 0, 1, 1);
			unk_0x5C96CEA06531AB03(iLocal_232[iVar0], (fLocal_243 + fLocal_246[iVar0]));
			unk_0xC6E8E1D693021E9E(iLocal_232[iVar0], 0);
			if (iLocal_234[iVar0] == joaat("a_f_y_beach_01"))
			{
				if (iLocal_65 == 288)
				{
					unk_0xD1C578C204015E1F(iLocal_232[iVar0], 8, 1, 0, 0);
				}
			}
			unk_0xBE8796DB2B90A437(iLocal_232[iVar0], 13, 0);
			unk_0xBE8796DB2B90A437(iLocal_232[iVar0], 17, 1);
			unk_0x10425721983AE158(iLocal_232[iVar0], &cLocal_296, &(Local_305[iVar0 /*16*/]), 8f, -8f, -1, 1, 0f, 0, 0, 0);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_238)
	{
		if (iLocal_239[iVar0] != 0)
		{
			iLocal_238[iVar0] = unk_0x4E55EAB577C13329(iLocal_239[iVar0], Local_242 + Local_244[iVar0 /*3*/] + Local_240[iVar0 /*3*/], 1, 1, 0);
			unk_0xCF39804E8C88080E(iLocal_238[iVar0], Vector((fLocal_243 + fLocal_246[iVar0]), 0f, 0f) + Local_241[iVar0 /*3*/], 2, 1);
			if (!unk_0xD6F9DEE4765092A9(&(Local_310[iVar0 /*16*/])))
			{
				unk_0x5ED9595F4AC7D134(iLocal_238[iVar0], &(Local_310[iVar0 /*16*/]), &cLocal_296, 8f, 1, 0, 0, 0, 0);
			}
		}
		iVar0++;
	}
...
void func_48()
{
	...
	func_51(iLocal_65, &Local_242, &fLocal_243, &cVar0);
	func_49(iLocal_65, &sLocal_248, &cLocal_264, &cLocal_280, &uVar1, &uVar2);
	StringCopy(&(Local_315[0 /*16*/]), "", 64);
	StringCopy(&(Local_315[1 /*16*/]), "", 64);
	iLocal_239[0] = 0;
	iLocal_239[1] = 0;
	switch (iLocal_65)
	{
		case 237:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@CHASE_STRIPPERS", 64);
			StringCopy(&(Local_305[0 /*16*/]), "LOOP_STRIPPER_01", 64);
			StringCopy(&(Local_306[0 /*16*/]), "EXIT_STRIPPER_01", 64);
			StringCopy(&(Local_307[0 /*16*/]), "", 64);
			StringCopy(&(Local_305[1 /*16*/]), "LOOP_STRIPPER_02", 64);
			StringCopy(&(Local_306[1 /*16*/]), "EXIT_STRIPPER_02", 64);
			StringCopy(&(Local_307[1 /*16*/]), "", 64);
			StringCopy(&Local_317, "TRVS_IG_35", 16);
			fLocal_320 = 0,15f;
			Local_244[0 /*3*/] = { unk_0xD2AA6F822D3A55D2(-10f, 10f), unk_0xD2AA6F822D3A55D2(-10f, 10f), 0f };
			Local_244[1 /*3*/] = { unk_0xD2AA6F822D3A55D2(-10f, 10f), unk_0xD2AA6F822D3A55D2(-10f, 10f), 0f };
			Local_245[0 /*3*/] = { 8,2284f, -35,8652f, -1,0334f };
			Local_245[1 /*3*/] = { 28,4066f, -23,8848f, -0,7887f };
			fLocal_246[0] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			fLocal_246[1] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			fLocal_247[0] = 50f;
			fLocal_247[1] = 50f;
			iLocal_234[0] = joaat("s_f_y_stripper_01");
			iLocal_234[1] = joaat("s_f_y_stripper_01");
			iLocal_235[0] = -1;
			iLocal_235[1] = -1;
			break;
		
		case 235:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@MOCKS_LAPDANCE", 64);
			StringCopy(&(Local_305[0 /*16*/]), "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			StringCopy(&(Local_306[0 /*16*/]), "001443_01_TRVS_28_EXIT_STRIPPER", 64);
			StringCopy(&(Local_307[0 /*16*/]), "001443_01_TRVS_28_IDLE_STRIPPER", 64);
			StringCopy(&(Local_305[1 /*16*/]), "001443_01_TRVS_28_IDLE_MAN", 64);
			StringCopy(&(Local_306[1 /*16*/]), "001443_01_TRVS_28_EXIT_MAN", 64);
			StringCopy(&(Local_307[1 /*16*/]), "001443_01_TRVS_28_IDLE_MAN", 64);
			Local_244[0 /*3*/] = { -1,5421f, 0,8274f, -1,0288f };
			Local_244[1 /*3*/] = { -0,9636f, 1,1757f, -1,0243f };
			Local_245[0 /*3*/] = { 0f, 0f, 0f };
			Local_245[1 /*3*/] = { 0f, 0f, 0f };
			fLocal_246[0] = -130f;
			fLocal_246[1] = -130f;
			fLocal_247[0] = 0f;
			fLocal_247[1] = 0f;
			...
			if (iVar3 < 8 || iVar3 > 20)
			{
				iLocal_234[0] = joaat("s_f_y_stripper_02");
			}
			else
			{
				iLocal_234[0] = joaat("s_f_y_stripper_01");
			}
			iLocal_234[1] = joaat("a_m_y_hipster_01");
			iLocal_235[0] = -1;
			iLocal_235[1] = 0;
			break;
		
		case 247:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@ANNOYS_SUNBATHERS", 64);
			StringCopy(&(Local_305[0 /*16*/]), "trev_annoys_sunbathers_loop_girl", 64);
			StringCopy(&(Local_306[0 /*16*/]), "trev_annoys_sunbathers_exit_girl", 64);
			StringCopy(&(Local_307[0 /*16*/]), "", 64);
			StringCopy(&(Local_315[0 /*16*/]), "move_f@scared", 64);
			StringCopy(&(Local_305[1 /*16*/]), "trev_annoys_sunbathers_loop_guy", 64);
			StringCopy(&(Local_306[1 /*16*/]), "trev_annoys_sunbathers_exit_guy", 64);
			StringCopy(&(Local_307[1 /*16*/]), "", 64);
			StringCopy(&(Local_315[1 /*16*/]), "move_m@hurry_Butch@A", 64);
			Local_244[0 /*3*/] = { -0,3866f, 0,1726f, 1f };
			Local_244[1 /*3*/] = { -0,0726f, -0,4742f, 1f };
			Local_245[0 /*3*/] = { Vector(1,5806f, -1719,606f, -1291,475f) - Local_242 };
			Local_245[1 /*3*/] = { Local_245[0 /*3*/] };
			fLocal_246[0] = 0f;
			fLocal_246[1] = 0f;
			fLocal_247[0] = 20f;
			fLocal_247[1] = fLocal_247[0];
			iLocal_234[0] = joaat("a_f_y_beach_01");
			iLocal_234[1] = joaat("a_m_y_beach_01");
			iLocal_235[0] = -1;
			iLocal_235[1] = -1;
			iLocal_239[0] = joaat("prop_cs_beachtowel_01");
			Local_240[0 /*3*/] = { 0f, 0f, -1f };
			Local_241[0 /*3*/] = { 0f, 0f, 2,16f };
			iLocal_239[1] = joaat("prop_cs_beachtowel_01");
			Local_240[1 /*3*/] = { 0f, 0f, -1f };
			Local_241[1 /*3*/] = { 0f, 0f, -4,32f };
			break;
		
		case 286:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@RUDE_AT_CAFE", 64);
			StringCopy(&(Local_305[0 /*16*/]), "001218_03_TRVS_23_RUDE_AT_CAFE_IDLE_FEMALE", 64);
			StringCopy(&(Local_306[0 /*16*/]), "001218_03_TRVS_23_RUDE_AT_CAFE_EXIT_FEMALE", 64);
			StringCopy(&(Local_307[0 /*16*/]), "", 64);
			Local_244[0 /*3*/] = { 4,261f, -2,388f, 0,5f };
			Local_245[0 /*3*/] = { 10,5918f, -34,5146f, 0f };
			fLocal_246[0] = 57,695f;
			fLocal_247[0] = 30f;
			iLocal_234[0] = joaat("a_f_y_hipster_03");
			iLocal_235[0] = -1;
			StringCopy(&(Local_305[1 /*16*/]), "", 64);
		...
		case 263:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@SCARES_TRAMP", 64);
			StringCopy(&(Local_305[0 /*16*/]), "trev_scares_tramp_idle_tramp", 64);
			StringCopy(&(Local_306[0 /*16*/]), "trev_scares_tramp_exit_tramp", 64);
			StringCopy(&(Local_307[0 /*16*/]), "", 64);
			Local_244[0 /*3*/] = { 2,0921f, -1,5872f, 0f };
			Local_245[0 /*3*/] = { Vector(10,9545f, -1419,537f, -605,8271f) - Local_242 };
			fLocal_246[0] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			fLocal_247[0] = 40f;
			iLocal_234[0] = joaat("a_m_o_tramp_01");
			iLocal_235[0] = -1;
			StringCopy(&(Local_305[1 /*16*/]), "", 64);
			StringCopy(&(Local_306[1 /*16*/]), "", 64);
			StringCopy(&(Local_307[1 /*16*/]), "", 64);
		...
		case 244:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@THROW_FOOD", 64);
			StringCopy(&(Local_305[0 /*16*/]), "LOOP_Ped", 64);
			StringCopy(&(Local_306[0 /*16*/]), "EXIT_Ped", 64);
			StringCopy(&(Local_307[0 /*16*/]), "", 64);
			Local_244[0 /*3*/] = { unk_0xD2AA6F822D3A55D2(-5f, 5f), unk_0xD2AA6F822D3A55D2(-5f, 5f), 0f };
			Local_245[0 /*3*/] = { Vector(28,2925f, -1451,728f, 507,6885f) - Local_242 };
			fLocal_246[0] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			fLocal_247[0] = 40f;
			iLocal_234[0] = joaat("a_m_y_stlat_01");
			iLocal_235[0] = -1;
			StringCopy(&(Local_305[1 /*16*/]), "", 64);
			StringCopy(&(Local_306[1 /*16*/]), "", 64);
			StringCopy(&(Local_307[1 /*16*/]), "", 64);
		...
		case 288:
			StringCopy(&cLocal_296, "SWITCH@TREVOR@UNDER_PIER", 64);
			StringCopy(&(Local_305[0 /*16*/]), "LOOP_Ped", 64);
			StringCopy(&(Local_306[0 /*16*/]), "EXIT_Ped", 64);
			StringCopy(&(Local_307[0 /*16*/]), "EXIT_LOOP_Ped", 64);
			StringCopy(&(Local_308[0 /*16*/]), "DEATH_Ped", 64);
			StringCopy(&(Local_309[0 /*16*/]), "DEATH_LOOP_Ped", 64);
			Local_244[0 /*3*/] = { unk_0xD2AA6F822D3A55D2(-10f, 10f), unk_0xD2AA6F822D3A55D2(-10f, 10f), 0f };
			Local_245[0 /*3*/] = { 0f, 0f, 0f };
			fLocal_246[0] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			fLocal_247[0] = 0f;
			iLocal_234[0] = joaat("a_m_m_business_01");
			iLocal_235[0] = -1;
			iLocal_239[0] = joaat("p_trev_rope_01_s");
			Local_240[0 /*3*/] = { 0f, 0f, 0f };
			StringCopy(&(Local_310[0 /*16*/]), "LOOP_Rope", 64);
			StringCopy(&(Local_311[0 /*16*/]), "EXIT_Rope", 64);
			StringCopy(&(Local_312[0 /*16*/]), "EXIT_LOOP_Rope", 64);
			StringCopy(&(Local_313[0 /*16*/]), "DEATH_Rope", 64);
			StringCopy(&(Local_314[0 /*16*/]), "DEATH_LOOP_Rope", 64);
			iLocal_239[1] = joaat("prop_rolled_sock_01");
			Local_240[1 /*3*/] = { 0f, 0f, 0f };
			StringCopy(&(Local_310[1 /*16*/]), "LOOP_Sock", 64);
			StringCopy(&(Local_311[1 /*16*/]), "EXIT_Sock", 64);
			StringCopy(&(Local_312[1 /*16*/]), "EXIT_LOOP_Sock", 64);
			StringCopy(&(Local_313[1 /*16*/]), "DEATH_Sock", 64);
			StringCopy(&(Local_314[1 /*16*/]), "DEATH_LOOP_Sock", 64);
			StringCopy(&(Local_305[1 /*16*/]), "", 64);
			StringCopy(&(Local_306[1 /*16*/]), "", 64);
			StringCopy(&(Local_307[1 /*16*/]), "", 64);
			Local_245[1 /*3*/] = { 0f, 0f, 0f };
		...
		default:
			...
			fLocal_246[0] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			fLocal_246[1] = unk_0xD2AA6F822D3A55D2(-180f, 180f);
			iLocal_234[0] = joaat("a_m_y_musclbeac_01");
			iLocal_234[1] = joaat("a_m_y_musclbeac_01");
			iLocal_235[0] = -1;
			iLocal_235[1] = -1;
			break;
	}
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[0];
			StringCopy(sParam2, func_57(Global_113969.f_2366.f_539.f_2314[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[1];
			StringCopy(sParam2, func_57(Global_113969.f_2366.f_539.f_2314[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_113969.f_2366.f_539.f_2310[2];
			StringCopy(sParam2, func_57(Global_113969.f_2366.f_539.f_2314[2]), 32);
			return 1;
			break;
...
void func_58()
{
	...
	while (iVar0 < iLocal_234)
	{
		if (iLocal_234[iVar0] != 0)
		{
			unk_0x55098D9E9AD58806(iLocal_234[iVar0]);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_239)
	{
		if (iLocal_239[iVar0] != 0)
		{
			unk_0x55098D9E9AD58806(iLocal_239[iVar0]);
		}
		iVar0++;
	}
	unk_0x268BE77F77533D03(&cLocal_296);
	if (unk_0xDC469CE2BE7CE722(uLocal_237))
	{
		unk_0x94CC4CA44256FDCB(uLocal_237);
	}
