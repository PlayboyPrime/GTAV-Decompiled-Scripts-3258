...
void __EntryFunction__()
{
	...
	if (!func_283(&iVar2, &Var0, Var1, 1f))
	{
		func_282();
	...
	while (true)
	{
		...
		func_218(Var0.f_0);
		func_211(&iLocal_52, &(Var0.f_9), Var1);
		if (iLocal_53 == 0)
		{
			if (Var0.f_0 == 22)
			{
				...
				{
					if (func_210(Var0.f_28[1]))
					{
						func_302("Trying to set Mary Ann boyfriend component variation");
						unk_0x2F19C4305F0B8DA7("MaryAnnes_Friend", Var0.f_28[1], 0);
						unk_0x60A0A4CD710160D5("MaryAnnes_Friend", 0, 0, 0, 0);
						iLocal_53 = 1;
					}
				}
			}
		...
		if (Var0.f_0 == 21)
		{
			func_207(&Var0, Var1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0.f_0 == 22)
		{
			func_202(&Var0, Var1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0.f_0 == 23)
		{
			if (iLocal_54 == 0)
			{
				if (func_207(&Var0, Var1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_54 = 1;
				}
			}
...
void func_140(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_210(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_210(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_210(uParam0->f_41[iVar0]))
		{
	...
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_210(iParam0->f_28[0]))
				{
					if (func_186(iParam0))
					{
						if (func_190(2))
		...
		case 5:
			if (*iParam0 == 6)
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
				{
					if (func_210(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)))
					{
...
void func_199(int iParam0)
{
	...
	if ((unk_0x1DD05E817C89C737() - iLocal_55) >= 900)
	{
		if (func_210(iParam0->f_28[0]))
		{
			if (!func_156())
			{
				func_200(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6, 0);
				iLocal_55 = unk_0x1DD05E817C89C737();
			}
		}
	}
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4)
{
	unk_0x4CAD907F190E6F10(uParam0, sParam1, sParam2, func_201(iParam3), iParam4);
}
...
int func_202(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_210(unk_0x4A8C381C258A124D()) && func_210(iParam0->f_28[0])) && !func_156()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_206(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_205(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_203(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_203(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
float func_206(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_207(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)
{
	var uVar0;
	...
	if (func_190(2))
	{
		if (!func_156())
		{
			if (((func_210(unk_0x4A8C381C258A124D()) && func_210(iParam0->f_28[0])) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_206(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_205(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
				func_203(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		else if (func_208(sParam3))
		{
			if (func_210(unk_0x4A8C381C258A124D()))
			{
				if (func_206(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
				{
					func_154();
				}
			}
...
void func_211(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(sParam1))
		{
			...
			{
				if (func_206(unk_0x4A8C381C258A124D(), Param2, 1) <= 100f)
				{
					func_214(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_206(unk_0x4A8C381C258A124D(), Param2, 1) > 120f)
				{
					func_216(iParam0);
				}
			}
...
int func_219(var uParam0, bool bParam1)
{
	...
	if (func_223(&(uParam0->f_48)) && bParam1)
	{
		func_220(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
...
void func_220(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_210(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_222(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_221(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_222(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_221(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_227(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_228(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_28[iVar0]))
			{
				if (!unk_0x4FAFF4BCB7633475(uParam0->f_28[iVar0]))
				{
					...
					if (func_248(*uParam0))
					{
						if (!func_169(*uParam0))
						{
							if (func_243(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_224(uParam0);
						...
						if (func_231(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_224(uParam0);
...
int func_231(int iParam0, float fParam1)
{
	...
	{
		if (func_242(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
{
	return func_233(iParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}

bool func_233(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_241(iParam0, iParam1);
	if (!func_210(iParam0) || !func_210(iParam1))
	{
		if (iVar2 != -1)
		{
			func_240(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	if (!func_237(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_234(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1DD05E817C89C737() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_234(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_237(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_239(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var1 = { func_239(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_238(Var1, Var0);
...
Vector3 func_239(struct<3> Param0)
{
	float fVar0;
	float fVar1;
...
int func_243(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_210(unk_0x4A8C381C258A124D()) && func_210(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_247(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_244(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
		else
		{
			...
			else
			{
				...
				if (func_247(iParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_244(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_244(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_245(var uParam0, float fParam1)
{
	...
	{
		if (func_246(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_246(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_239(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_247(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
int func_259(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			{
				if (func_260(&(uParam0->f_28[0]), 61, -915,6f, 6139,192f, 5,525f, 111,24f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_261(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
int func_266(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (!func_260(&(uParam0->f_28[0]), 61, 809,66f, 1279,76f, 360,49f, 122,53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_270(&(uParam0->f_28[1]), iVar0[1], 808,43f, 1279,16f, 360,47f, -79,11f, 26);
			...
			{
				func_268(&(uParam0->f_35[0]), iVar0[2], 808,35f, 1277,2f, 360,15f, 216,5f);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
			{
				func_268(&(uParam0->f_35[1]), iVar0[2], 807,89f, 1275,73f, 360,18f, 208,2f);
			}
			if (bVar2)
			{
				iLocal_49 = 3;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_210(uParam0->f_35[iVar1]))
				{
...
void func_268(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_269(uParam0);
...
void func_270(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)
{
	func_271(uParam0);
...
int func_272(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (func_260(&(uParam0->f_28[0]), 61, -1878,27f, -440,55f, 46,23f, 165,94f, "FANATIC LAUNCHER RC", 1))
				{
...
bool func_277(int iParam0, char* sParam1)
{
...
int func_283(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_284((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_284((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_284(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_285(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_285(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_291(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
