...
void func_105()
{
	iLocal_34 = joaat("u_m_y_hippie_01");
	StringCopy(&Local_202, "PBAM", 8);
	StringCopy(&Local_203, "ANDYMOON", 16);
	StringCopy(&Local_200, "Special_Ped@andy_moon", 64);
	StringCopy(&Local_201, "Base", 64);
	bLocal_263 = !Global_4;
	iLocal_216 = 15;
	sLocal_224 = "PBAM_INTERACT";
	StringCopy(&Local_229, "PBAM_CONV_GM", 16);
	StringCopy(&Local_230, "PBAM_CONV_GT", 16);
	StringCopy(&Local_231, "PBAM_CONV_GF", 16);
	StringCopy(&cLocal_232, "special_ped@andy_moon@base", 64);
	StringCopy(&cLocal_241, "special_ped@andy_moon@intro", 64);
	iLocal_215 = 0;
	iLocal_219[0] = 6;
	iLocal_219[1] = 7;
	iLocal_219[2] = 6;
