...
void __EntryFunction__()
{
	...
	func_52(14);
	func_50();
	func_49(&Local_40, 0, joaat("prop_power_cell"), "SSHIP_COLLECT");
	func_47(&Local_40, joaat("num_hidden_packages_1"), 755, 50);
	while (true)
	{
		system::wait(0);
		func_46(unk_0x4A8C381C258A124D());
		if (func_16(&Local_40, &Local_46) || func_15(107) == 1)
		{
			if (!bLocal_49)
			{
				bLocal_49 = func_11(367701416, 1, 2, 69, 5000, 10000, -1, 179, -1, 32, 1);
			}
			if (bLocal_49)
			{
				if (!func_4() == 1)
...
void func_5()
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_9(Global_113969.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_7(iVar0) && (!func_6(14) || Global_112917))
			{
				if (Global_113969.f_2366.f_539.f_4321 != iVar0 && func_7(Global_113969.f_2366.f_539.f_4321))
				{
...
int func_16(var uParam0, int iParam1)
{
	...
	if (!func_6(14) && !unk_0x15CCE8886267624F())
	{
		...
		if (!Global_79650)
		{
			func_17(&(uParam0->f_11), &(uParam0->f_12), &(uParam0->f_9), 0, &iLocal_48, &uLocal_50, "SSHIP_TITLE", "SSHIP_COLLECT");
		}
		if (!bLocal_49)
		{
...
int func_19(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (BitTest(Global_113969.f_10052.f_108, func_23(func_24(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_26(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((system::vdist2(Param2, unk_0x80C8AA1625977488((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_6(13)) || func_6(14))
		{
...
void func_50()
{
	...
	iLocal_48 = 0;
	Global_113969.f_10052.f_125.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
		Local_46[iVar0 /*11*/].f_3 = { func_51(iVar0, 0) };
		Local_46[iVar0 /*11*/].f_10 = 0;
		iVar0++;
	}
	Local_46[0 /*11*/].f_9 = 179,4746f;
	Local_46[1 /*11*/].f_9 = 198f;
	Local_46[2 /*11*/].f_9 = 104f;
	Local_46[3 /*11*/].f_9 = 321,5f;
	Local_46[4 /*11*/].f_9 = 256,25f;
	Local_46[5 /*11*/].f_9 = 286,5f;
	Local_46[6 /*11*/].f_9 = 0f;
	Local_46[6 /*11*/].f_6 = { 0f, 0f, 1f };
	Local_46[7 /*11*/].f_9 = -165,6051f;
	Local_46[8 /*11*/].f_9 = 91,5f;
	Local_46[9 /*11*/].f_9 = 116f;
	Local_46[10 /*11*/].f_9 = 15f;
	Local_46[11 /*11*/].f_9 = 305,5f;
	Local_46[12 /*11*/].f_9 = 0f;
	Local_46[13 /*11*/].f_9 = 95f;
	Local_46[14 /*11*/].f_9 = 40f;
	Local_46[15 /*11*/].f_9 = 40f;
	Local_46[16 /*11*/].f_9 = 40f;
	Local_46[17 /*11*/].f_9 = 40f;
	Local_46[18 /*11*/].f_9 = 40f;
	Local_46[19 /*11*/].f_9 = 40f;
	Local_46[20 /*11*/].f_9 = 40f;
	Local_46[21 /*11*/].f_6 = { 90f, 0f, 57f };
	Local_46[22 /*11*/].f_9 = 40f;
	Local_46[23 /*11*/].f_9 = 40f;
	Local_46[24 /*11*/].f_9 = 40f;
	Local_46[25 /*11*/].f_9 = 40f;
	Local_46[26 /*11*/].f_9 = 40f;
	Local_46[27 /*11*/].f_9 = 40f;
	Local_46[28 /*11*/].f_9 = 40f;
	Local_46[29 /*11*/].f_9 = 40f;
	Local_46[29 /*11*/].f_6 = { -24,35f, 15,74f, 14,31f };
	Local_46[30 /*11*/].f_9 = 40f;
	Local_46[31 /*11*/].f_9 = 40f;
	Local_46[32 /*11*/].f_9 = 40f;
	Local_46[33 /*11*/].f_9 = 40f;
	Local_46[34 /*11*/].f_6 = { 0f, 0f, -15f };
	Local_46[35 /*11*/].f_9 = 40f;
	Local_46[36 /*11*/].f_9 = 40f;
	Local_46[37 /*11*/].f_9 = 40f;
	Local_46[38 /*11*/].f_9 = 40f;
	Local_46[38 /*11*/].f_6 = { 20,18f, -0,87f, 20,46f };
	Local_46[39 /*11*/].f_6 = { 0f, 0f, -4,39f };
	Local_46[40 /*11*/].f_9 = 40f;
	Local_46[41 /*11*/].f_9 = 80f;
	Local_46[42 /*11*/].f_9 = 198f;
	Local_46[43 /*11*/].f_9 = 198f;
	Local_46[44 /*11*/].f_9 = 198f;
	Local_46[45 /*11*/].f_9 = 198f;
	Local_46[46 /*11*/].f_9 = 198f;
	Local_46[47 /*11*/].f_9 = 198f;
	Local_46[48 /*11*/].f_9 = 198f;
	Local_46[49 /*11*/].f_9 = 198f;
}
...
void func_53()
{
	...
	Global_113969.f_10052.f_125.f_2 = 0;
	iVar0 = 0;
	while (iVar0 < Local_46.f_0)
	{
		func_40(&(Local_46[iVar0 /*11*/].f_2));
		func_27(&(Local_46[iVar0 /*11*/].f_1));
		iVar0++;
	}
