...
void __EntryFunction__()
{
	...
	if (unk_0x486FF5D06E9659F1(joaat("ambient_tonyacall5")) > 1)
	{
...
int func_1()
{
	...
	if ((system::vdist2(Var0, Var1) > 10000f || unk_0x1C2F771CDC87A3A5(uLocal_36, 0)) || func_27())
	{
		return 1;
	}
	switch (iLocal_38)
	{
		case 0:
			if (unk_0xFC8BFE4B41177C22(uLocal_36) && !unk_0x1C2F771CDC87A3A5(uLocal_36, 0))
			{
				if (unk_0x65FFA94B82A71741(uLocal_36, Local_47, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0x4BD42B0527065BB6(uLocal_36, uVar3);
					unk_0xD0557B139A542F12(&uVar3);
					iLocal_38 = 1;
				}
			}
			...
			if (unk_0xFC8BFE4B41177C22(uLocal_36) && !unk_0x1C2F771CDC87A3A5(uLocal_36, 0))
			{
				if (unk_0x89EC60A4485FD199(uLocal_36) == 1)
				{
					if (!unk_0xFC8BFE4B41177C22(uLocal_37))
					{
						...
						{
							fVar4 = unk_0x82E64DE58A6B84A8(uLocal_36, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar4 >= 0,157f)
							{
				...
				{
					iVar2 = (unk_0xC5935DFB3F39785A(0, 65535) % 2);
					if (iVar2 == 0)
					{
						if (func_4(&uLocal_51, "TOWAUD", "TONYA_CALL5", 8, 0, 0, 0))
						{
							iLocal_38 = 2;
						}
					}
					else if (func_4(&uLocal_51, "TOWAUD", "TONYA_CALL6", 8, 0, 0, 0))
					{
						iLocal_38 = 2;
					}
				}
		...
		case 3:
			...
			if (system::vdist2(Var0, Var1) < 25f)
			{
				...
				{
					if (func_4(&uLocal_51, "TOWAUD", "TOW_MESS3", 8, 0, 0, 0))
					{
						system::settimera(0);
						iLocal_38 = 4;
					}
