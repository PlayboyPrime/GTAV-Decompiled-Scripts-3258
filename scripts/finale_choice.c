...
int func_13()
{
	if (Global_20930.f_1 > 3)
	{
		unk_0x8744D2E3FC95740E(&Global_8801, false);
		func_23(0);
		return 0;
	}
	unk_0x0B0C9A0F9AAEB7F0(&Global_8801, false);
	if (func_14(0, 0, 1, 1))
	{
		return 1;
	}
...
void func_20()
{
	...
	if (Global_79389 == 0)
	{
		...
		while (iVar2 < 161)
		{
			if (func_22(iVar2, Global_20930) == 1)
			{
				iVar1 = 1;
			}
			iVar2++;
		...
		func_16(4, "CELL_23", 2, "appChecklist", 39, 1, 1, 0, 0);
		if ((Global_44042 == 15 && func_2(0) == 0) && Global_8805 == 0)
		{
...
void func_31()
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_33(Global_113969.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_10(iVar0) && (!func_17(14) || Global_112917))
			{
...
void func_40(int iParam0)
{
	...
	Global_44594[iParam0] = unk_0x1DD05E817C89C737();
}

void func_41()
{
	Global_44593 = unk_0x1DD05E817C89C737();
}
...
void func_48(int iParam0)
{
	...
	while (iVar1 < Global_113969.f_7691.f_198)
	{
		...
		{
			func_49(Global_113969.f_7691.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_49(int iParam0)
{
	...
	{
		if (func_22(iParam0, Global_20930) == 1)
		{
			func_54(iParam0, Global_20930, 0);
			if (func_53(iParam0, Global_20930) == 0)
			{
				iVar0 = Global_20930;
