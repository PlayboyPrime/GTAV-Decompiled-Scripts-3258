...
void __EntryFunction__()
{
	...
	uLocal_50 = func_288(54);
	iLocal_51 = joaat("dune");
	iLocal_52 = unk_0xA0A2925EDC6DDA6D(joaat("weapon_sniperrifle"));
	iLocal_53 = unk_0xB39F6B1C186F538E(joaat("component_at_scope_large"));
	iLocal_54 = unk_0xB39F6B1C186F538E(joaat("component_at_ar_supp_02"));
	Local_55 = { -683,8261f, 5840,81f, 16,566f };
	iLocal_57 = -1;
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113056[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_113056[Var0.f_0 /*10*/].f_9));
			}
		}
		func_272(&Var0, 1);
	}
	if (!func_269(&iVar2, &Var0, Var1, 1f))
	{
		func_268();
	...
	unk_0x2094BC4B6731BA68(Var1, 3f, 1, 0, 0, 0);
	while (true)
	{
		system::wait(0);
		if (!func_209(&Var0, 1))
		...
		func_208(Var0.f_0);
		func_201(&iLocal_57, &(Var0.f_9), Var1);
		if (Var0.f_0 == 25)
		{
			func_196(&Var0, Var1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (Var0.f_0 == 25)
		{
			...
			{
				unk_0x4190C67D524CD0DC(unk_0x4A8C381C258A124D(), 3f);
			}
		}
		if (func_181(&Var0, 0) && unk_0x1D5CD3EAAA7422B0((Var1.f_2 - Var3.f_2)) < 2,5f)
		{
			if (!func_2(&Var0))
			{
				func_272(&Var0, 1);
...
int func_196(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_137(unk_0x4A8C381C258A124D()) && func_137(iParam0->f_28[0])) && !func_157()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_200(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_199(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_197(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_198(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
float func_200(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_201(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(sParam1))
		{
			...
			{
				if (func_200(unk_0x4A8C381C258A124D(), Param2, 1) <= 100f)
				{
					func_204(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_200(unk_0x4A8C381C258A124D(), Param2, 1) > 120f)
				{
					func_206(iParam0);
				}
			}
...
int func_209(int iParam0, bool bParam1)
{
	...
	func_120(*iParam0, &Var0);
	if ((func_246(*iParam0) || func_244(*iParam0)) || Global_79635 == 1)
	{
		return 1;
	}
	if (!unk_0x173751E886F8E9AB())
	...
	if (func_213(&(iParam0->f_48)) && bParam1)
	{
		func_210(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
...
void func_210(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_137(iParam0))
	{
		switch (uParam1->f_3)
		{
					...
					if (unk_0xE100DD4F82A51BDE(*uParam1))
					{
						...
						if (iParam2 != 21)
						{
							...
							else
							{
								...
								if (func_212(uParam1))
								{
									unk_0x9F5225AA1E102B7A(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								else
								{
									unk_0x9F5225AA1E102B7A(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 1000f, -8f, -1, 262152, 0f, 2, 0);
								}
								unk_0x9F5225AA1E102B7A(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
						...
						{
							unk_0x9F5225AA1E102B7A(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 3);
						}
						uParam1->f_3 = 2;
					}
					else
			...
			case 2:
				if (!func_212(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_211(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_212(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 3:
				...
				{
					unk_0x9F5225AA1E102B7A(0, *uParam1, uParam1->f_2, uParam1->f_5, uParam1->f_8, 4f, -4f, -1, 262152, 0f, 2, 0);
					unk_0x9F5225AA1E102B7A(0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
				}
			...
			case 5:
				if (!func_211(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
					...
					{
						unk_0x9F5225AA1E102B7A(iParam0, *uParam1, uParam1->f_1, uParam1->f_5, uParam1->f_8, 8f, -8f, -1, 262153, 0f, 2, 0);
					}
					uParam1->f_3 = 2;
				}
				break;
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_218(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
...
int func_221(int iParam0, float fParam1)
{
	...
	{
		if (func_232(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
{
	return func_223(iParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}

bool func_223(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	
	iVar2 = func_231(iParam0, iParam1);
	if (!func_137(iParam0) || !func_137(iParam1))
	{
		if (iVar2 != -1)
		{
			func_230(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	if (!func_227(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_224(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1DD05E817C89C737() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_224(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_225(int iParam0, int iParam1)
{
	int iVar0;
...
int func_227(int iParam0, int iParam1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_229(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var1 = { func_229(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_233(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_137(unk_0x4A8C381C258A124D()) && func_137(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_237(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_234(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
		else
		{
			...
			else
			{
				...
				if (func_237(iParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_234(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_235(var uParam0, float fParam1)
{
	...
	{
		if (func_236(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_236(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_229(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_237(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
int func_248(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_255(&iVar0) || !unk_0xE100DD4F82A51BDE("rcmhunting2"))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			{
				if (func_252(&(uParam0->f_28[0]), 54, -683,3276f, 5841,042f, 17,217f, 8,33f, "RC HUNTER 2", 1))
				{
			...
			{
				func_249(&(uParam0->f_35[0]), -685,2281f, 5833,982f, 16,331f, 313,2204f, 0);
			}
			if (!unk_0xFC8BFE4B41177C22(uLocal_56))
			{
				iLocal_56 = unk_0x8A3572575D91006C(joaat("weapon_sniperrifle"), 0, Local_55, 0, 1065353216, 0, 0, 1);
				unk_0x93A0B91D4456D7E9(iLocal_56, joaat("component_at_scope_large"));
				unk_0x93A0B91D4456D7E9(iLocal_56, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_49 = 3;
		...
		case 3:
			...
			if (unk_0xE10356B235A70E70(Local_55, 1f, iLocal_52, 0))
			{
				unk_0xCF39804E8C88080E(iLocal_56, 0f, -90f, -162,64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_249(var uParam0, struct<3> Param1, float fParam2, int iParam3)
{
	func_250(uParam0, iLocal_51, Param1, fParam2);
	if (unk_0xFC8BFE4B41177C22(*uParam0))
	{
...
void func_250(var uParam0, int iParam1, struct<3> Param2, var uParam3)
{
	func_251(uParam0);
...
int func_252(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_253(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
...
int func_253(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
int func_256(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if ((!func_255(&iVar0) || !func_257(&(uParam0->f_48))) || !unk_0xE100DD4F82A51BDE("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (func_252(&(uParam0->f_28[0]), 54, 1804,33f, 3931,33f, 33,83f, 91,63f, "RC HUNTER 1", 1))
				{
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_249(&(uParam0->f_35[0]), 1806,732f, 3934,353f, 33,3275f, 76,1155f, 0);
...
void func_258(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_269(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_270((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_270((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_270(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_271(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_271(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_273(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
