...
void __EntryFunction__()
{
	...
	iLocal_50 = func_305(56);
	iLocal_51 = func_305(57);
	iLocal_52 = func_305(59);
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113056[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_301(&(Global_113056[Var0.f_0 /*10*/].f_9));
			}
		}
		func_285(&Var0, 1);
	}
	if (!func_282(&iVar2, &Var0, Var1, 1f))
	{
		func_281();
	...
	if (Var0.f_0 == 32)
	{
		unk_0xA63572E348CC4CFB(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0, 1);
		unk_0xC4BCE90F7242F354(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x2094BC4B6731BA68(Var1, 40f, 1, 0, 0, 0);
	}
	else if (Var0.f_0 == 34)
	{
		uLocal_55 = func_257();
	...
	while (true)
	{
		...
		{
			func_221();
			if (func_220(Var0.f_35[1]))
			{
				if (!func_219(329,513f, 3402,691f, 36,258f, unk_0xD1A6A821F5AC81DB(Var0.f_35[1], 1), 1056964608))
				{
		...
		func_215(Var0.f_0);
		func_208(&iLocal_54, &(Var0.f_9), Var1);
		if (Var0.f_0 == 32)
		{
			func_204(&Var0, Var1, "MIN1AUD", "MIN1_AMB", 3, "JOE", 4, "JOSEF", &uLocal_57);
		}
		else if (Var0.f_0 == 34)
		{
			func_199(&Var0, Var1, "MIN3AUD", "MIN3_AMB", 3, "MANUEL", 5000, 1101004800);
		}
		if (func_185(&Var0, 0))
		{
			if (func_184(Var0.f_0))
			{
				func_181(Var0.f_0, &uLocal_56);
			}
			if (!func_2(&Var0))
			{
				func_285(&Var0, 1);
...
int func_199(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	var uVar0;
	
	if ((((func_137(unk_0x4A8C381C258A124D()) && func_137(iParam0->f_28[0])) && !func_157()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_203(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_202(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
		func_200(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_200(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_201(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_202(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
...
float func_203(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
int func_204(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_190(2))
		{
			if (!func_157())
			{
				if (((func_137(unk_0x4A8C381C258A124D()) && func_137(iParam0->f_28[0])) && func_137(iParam0->f_28[1])) && func_203(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
				{
					...
					{
						func_202(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
						func_202(&uVar0, iParam6, iParam0->f_28[1], sParam7, 0, 1);
						func_200(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
			...
			else if (((func_206(sParam3) && !*uParam8 == 1) && func_137(unk_0x4A8C381C258A124D())) && func_203(unk_0x4A8C381C258A124D(), Param1, 1) >= 20f)
			{
				func_302("pause conversation");
				func_205(1);
				*uParam8 = 1;
			}
			if (func_203(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_208(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(sParam1))
		{
			...
			{
				if (func_203(unk_0x4A8C381C258A124D(), Param2, 1) <= 100f)
				{
					func_211(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_203(unk_0x4A8C381C258A124D(), Param2, 1) > 120f)
				{
					func_213(iParam0);
				}
			}
...
int func_219(struct<2> Param0, float fParam1, struct<2> Param2, Vector3 vParam3, float fParam4)
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
void func_221()
{
	...
	{
		unk_0x60A0A4CD710160D5("Joe", 1, 0, 0, 0);
		unk_0x60A0A4CD710160D5("Josef", 0, 0, 0, 0);
		unk_0x60A0A4CD710160D5("Josef", 1, 0, 0, 0);
	}
}
...
int func_222(var uParam0, bool bParam1)
{
	...
	if ((func_256(*uParam0) || func_254(*uParam0)) || Global_79635 == 1)
	{
		return 1;
	}
	if (!unk_0x173751E886F8E9AB())
	...
	if (func_226(&(uParam0->f_48)) && bParam1)
	{
		func_223(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
...
void func_223(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_137(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_225(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_224(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_225(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_224(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_228(var uParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	var uVar2;
				...
				if (bParam2)
				{
					if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
					{
						...
						if (func_220(uVar2))
						{
							...
							{
								if (func_220(uParam0->f_35[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_229(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_28[iVar0]))
			{
				if (!unk_0x4FAFF4BCB7633475(uParam0->f_28[iVar0]))
				{
					...
					if (func_249(*uParam0))
					{
						if (!func_170(*uParam0))
						{
							if (func_244(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_216(uParam0);
						...
						if (func_232(uParam0->f_28[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_216(uParam0);
...
int func_232(int iParam0, float fParam1)
{
	...
	{
		if (func_243(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
{
	return func_234(iParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}
...
bool func_234(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_235(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1DD05E817C89C737() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_235(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_238(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_240(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var1 = { func_240(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_239(Var1, Var0);
...
float func_239(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_244(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_137(unk_0x4A8C381C258A124D()) && func_137(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_248(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_245(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
		else
		{
			...
			else
			{
				...
				if (func_248(iParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
...
int func_246(var uParam0, float fParam1)
{
	...
	{
		if (func_247(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_247(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_240(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_248(int iParam0, bool bParam1, float fParam2, float fParam3)
{
	if (bParam1)
	{
		if (unk_0x65F146FF416F109F(unk_0x4A8C381C258A124D()))
...
var func_257()
{
	return unk_0xA7B0B03284E7503C(-309,1f, 6205,4f, 30f, -279,33f, 6217,98f, 40f, 0, 1, 1, 1, 1);
}
...
int func_259(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_267(&iVar0) || !func_266(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			{
				func_265(&(uParam0->f_41[0]), iVar0[3], -303,74f, 6211,56f, 30,49f, -176,77f);
			...
			{
				if (func_262(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2,8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_260(&(uParam0->f_35[0]), iVar0[0], -281,93f, 6198,32f, 30,77f, -135,32f);
				unk_0x20DD46D27530FAC7(uParam0->f_35[0], 1);
				unk_0xCCA6D8A84EE8C88A(iVar0[0], 1);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
			{
				func_260(&(uParam0->f_35[1]), iVar0[1], -291,72f, 6208,33f, 30,87f, -134,5016f);
				unk_0x20DD46D27530FAC7(uParam0->f_35[1], 0);
				unk_0xCCA6D8A84EE8C88A(iVar0[1], 1);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			{
				func_265(&(uParam0->f_41[1]), iVar0[4], -303,74f, 6211,56f, 30,49f, -176,77f);
				unk_0x4D306DD94DD6FDBA(uParam0->f_41[1], uParam0->f_28[0], unk_0x72F7E39FB49FC0BA(uParam0->f_28[0], 18905), 0,12f, 0f, 0,03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1, 0);
			}
			if (bVar2)
			{
				iLocal_49 = 3;
...
void func_260(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_261(uParam0);
...
int func_262(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_263(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_263(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
void func_265(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_218(uParam0);
...
void func_268(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_269(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			func_260(&(uParam0->f_35[0]), iVar0[0], 20,8f, 4532,65f, 104,66f, 284,7f);
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				unk_0x0B74F181ADFC39BF(uParam0->f_35[0], 2);
				unk_0xBDE75E2FCBF91A6C(uParam0->f_35[0], 5, 0);
				unk_0x9452FE4900245259(uParam0->f_35[0], 14f);
				unk_0xCCA6D8A84EE8C88A(iVar0[0], 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
int func_270(var uParam0)
{
	...
	switch (iLocal_49)
	{
		case 0:
			...
			unk_0x80813AC549A1E8AE("rcmminute1");
			unk_0x2094BC4B6731BA68(321,69f, 3408,64f, 35,34f, 10f, 1, 0, 0, 0);
			iLocal_49 = 1;
			break;
		
		case 1:
			unk_0x2094BC4B6731BA68(321,69f, 3408,64f, 35,34f, 10f, 1, 0, 0, 0);
			if (!func_267(&iVar0) || !unk_0xE100DD4F82A51BDE("rcmminute1"))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (func_262(&(uParam0->f_28[0]), 56, 329,3f, 3404,2f, 35,8f, -174,9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_262(&(uParam0->f_28[1]), 57, 328,1f, 3403,8f, 35,8f, -149,6f, "RCM MINUTE - JOSEF", 1))
				{
					unk_0x7F08C4791E6D6969(uParam0->f_28[1], 0, 0, 0, 0, 1);
					unk_0x7F08C4791E6D6969(uParam0->f_28[1], 1, 0, 0, 0, 1);
				}
				else
				{
					bVar2 = false;
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_260(&(uParam0->f_35[0]), iVar0[0], 321,69f, 3408,64f, 35,34f, -105,8f);
				func_271(uParam0->f_35[0], iVar0[0]);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
			{
				func_260(&(uParam0->f_35[1]), iVar0[1], 329,49f, 3402,71f, 36,29f, 284,36f);
				func_271(uParam0->f_35[1], iVar0[1]);
				unk_0xF04751F8E604D487(uParam0->f_35[1], 0);
			}
			if (bVar2)
			{
				iLocal_49 = 3;
		...
		case 3:
			if (unk_0xE100DD4F82A51BDE("rcmminute1"))
			{
				if (func_137(uParam0->f_28[0]))
				{
					if (!unk_0x13CCB1AD131C1082(uParam0->f_28[0], "rcmminute1", "base_joe", 3))
					{
						unk_0x974022927CB47E68(uParam0->f_28[0]);
						unk_0x10425721983AE158(uParam0->f_28[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
				...
				if (func_137(uParam0->f_28[1]))
				{
					...
					unk_0x10425721983AE158(uParam0->f_28[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0x0428AFDCAA63B06E(uParam0->f_28[1], 185, 1);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
void func_271(int iParam0, var uParam1)
{
	if (unk_0xFC8BFE4B41177C22(uParam0))
	{
		unk_0xD45558BDBDE86734(iParam0, 0);
		unk_0x0B74F181ADFC39BF(iParam0, 2);
		unk_0xCCA6D8A84EE8C88A(uParam1, 1);
		unk_0xDD38B2935A3EAC56(iParam0, 0, 0);
		unk_0x3B1F6012B676860B(iParam0, 1);
	}
}
...
bool func_276(int iParam0, char* sParam1)
{
...
int func_282(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_283((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_283((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_283(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_284(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_284(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_285(int iParam0, bool bParam1)
{
	...
	if (*iParam0 == 32)
	{
		unk_0xA63572E348CC4CFB(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 1, 1);
	}
	else if (*iParam0 == 34)
	{
		unk_0xD7B6A43ACC36D868(uLocal_55, 0);
	}
	func_289(&(iParam0->f_48));
	if (iLocal_54 != -1)
	{
...
void func_290(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
