...
void __EntryFunction__()
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113056[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_281(&(Global_113056[Var0.f_0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	iVar2[0] = 31;
	if (!func_262(&iVar2, &Var0, Var1, 1f))
	{
		func_261();
		func_282("SCRIPT TERMINATED");
		unk_0xBBC29EBE6E1A48FA();
	}
	if (!func_253(Var0.f_0))
	{
		func_261();
		func_282("SCRIPT TERMINATED");
		unk_0xBBC29EBE6E1A48FA();
	...
	while (true)
	{
		...
		func_204(Var0.f_0);
		func_196(&iLocal_51, &(Var0.f_9), Var1);
		if (func_181(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_205(var uParam0, bool bParam1)
{
	...
	func_120(*uParam0, &Var0);
	if ((func_242(*uParam0) || func_240(*uParam0)) || Global_79635 == 1)
	{
		return 1;
	}
	if (!unk_0x173751E886F8E9AB())
...
void func_206(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_137(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_207(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_207(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_214(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
...
int func_217(int iParam0, float fParam1)
{
	...
	{
		if (func_228(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
{
	return func_219(iParam0, unk_0x4A8C381C258A124D(), fParam1, 1, 250, 7);
}
...
bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_220(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (unk_0x1DD05E817C89C737() - Local_35[iVar2 /*4*/].f_3) < iParam4);
}

int func_220(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_225(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var1 = { func_225(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_224(Var1, Var0);
...
float func_224(struct<3> Param0, struct<3> Param1)
{
	return (((Param0.f_0 * Param1.f_0) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_137(unk_0x4A8C381C258A124D()) && func_137(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_233(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_230(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_231(var uParam0, float fParam1)
{
	...
	{
		if (func_232(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_232(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_225(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_244(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_249(&iVar0) || !unk_0xE100DD4F82A51BDE("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			{
				func_248(&(uParam0->f_41[0]), iVar0[1], 2728,35f, 4145,59f, 43,3f, -91,28f);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			{
				func_248(&(uParam0->f_41[1]), iVar0[2], 2727,686f, 4145,715f, 44,08f, 71f);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (!func_245(&(uParam0->f_28[0]), 62, 2728,33f, 4145,6f, 43,89f, 89,19f, "RC MAUDE 1", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_136(uParam0->f_28[0]) && func_137(uParam0->f_41[0]))
			{
...
int func_245(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_246(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_246(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
void func_248(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_211(uParam0);
...
void func_250(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_50 = unk_0xA7B0B03284E7503C(Var0, Var1, 0, 1, 1, 1, 1);
...
bool func_256(int iParam0, char* sParam1)
{
...
int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_263((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_263((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_263(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_264(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_264(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_267(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
...
void func_279(var uParam0)
{
	if (unk_0x5266F1D2AEF6F73A(uParam0->f_59))
	{
		...
		{
			if (func_280(uParam0->f_28[0], joaat("script_task_synchronized_scene")))
			{
		...
		if (func_137(uParam0->f_41[0]))
		{
			unk_0xC0086E5CBF13BBF7(uParam0->f_41[0], -1000f, 1);
		}
	}
}
