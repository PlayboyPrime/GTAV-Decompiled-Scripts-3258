...
{
	return unk_0x5105BE70DEF1F5FB(uParam0, 355,6093f, 4832,486f, -59,99951f, 338,4763f, 4841,36f, -56,99947f, 15f, 0, 1, 0);
}
...
int func_70()
{
	if (Global_1845118 != func_60())
	{
		if (unk_0x99F8FC8A6D8E20C0("base_corridor_seats", Global_1845118, 1, 0))
		{
			return 0;
		}
...
void func_71()
{
	...
	iVar0[0] = 0;
	iVar0[1] = 1;
	func_72(5, &uLocal_100, &iVar0);
	iVar0[0] = 2;
	iVar0[1] = 3;
	func_72(6, &uLocal_100, &iVar0);
}
