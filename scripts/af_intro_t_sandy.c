...
void __EntryFunction__()
{
	...
	iLocal_35 = 0;
	func_33(&uLocal_36);
	func_32(&uLocal_36, 1701,78f, 3225,148f, 40,0202f);
	func_32(&uLocal_36, 1678,909f, 3287,602f, 39,9648f);
	func_32(&uLocal_36, 1710,438f, 3326,499f, 40,1797f);
	func_32(&uLocal_36, 1738,879f, 3335,25f, 40,1493f);
	func_32(&uLocal_36, 1768,387f, 3312,101f, 40,2875f);
	func_32(&uLocal_36, 1819,241f, 3225,449f, 42,9019f);
	func_31(&uLocal_36);
	while (true)
	{
		switch (iLocal_35)
...
void func_12(int iParam0)
{
	...
	while (iVar1 < Global_113969.f_7691.f_198)
	{
		...
		{
			func_13(Global_113969.f_7691.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
void func_26()
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_29(Global_113969.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_10(iVar0) && (!func_27(14) || Global_112917))
			{
