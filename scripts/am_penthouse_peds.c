#region Local Var
	...
	int iLocal_36 = 0;
	int iLocal_37 = 0;
	struct<3> Local_38 = { 0, 0, -1 } ;
	struct<49> Local_39[50];
	int iLocal_40 = 0;
	var uLocal_41 = 0;
#endregion
...
void __EntryFunction__()
{
	...
	{
		while (Local_38.f_0 == 0)
		{
			if (unk_0x93E08E0F531E2C35())
			{
				Local_38.f_1 = func_45(iScriptParam_40);
				Local_38.f_2 = func_44();
				Local_38.f_0 = 1;
			}
			else
			{
	...
	{
		func_37();
		if (((!unk_0x76CD105BCAC6EB9F() || func_29()) || Global_1579721 == 0) || func_28())
		{
			func_25();
		}
		func_3();
...
void func_1()
{
	...
	if (iLocal_37 == 1)
	{
		...
		if (iVar0 > -1)
		{
			if (unk_0xFC8BFE4B41177C22(Local_39[iVar0 /*49*/]) && !unk_0x1C2F771CDC87A3A5(Local_39[iVar0 /*49*/], 0))
			{
				unk_0xF60A7646F4B460F7(Local_39[iVar0 /*49*/]);
				iLocal_37++;
			}
		}
	}
	if (iLocal_37 == 2)
	{
		...
		{
			fVar1 = (system::to_float(Local_38.f_1) / 5f);
...
int func_2()
{
	...
	while (iVar3 < 50)
	{
		if (Local_39[iVar3 /*49*/].f_48 <= Local_38.f_1)
		{
			fVar1 = system::vdist(Local_39[iVar3 /*49*/].f_40, 945f, 15f, 117f);
			if (fVar1 < fVar0)
			{
				fVar0 = fVar1;
				iVar2 = iVar3;
...
void func_3()
{
	...
	while (iVar0 < 50)
	{
		if (func_22(&(Local_39[iVar0 /*49*/])))
		{
			if (!unk_0xFC8BFE4B41177C22(Local_39[iVar0 /*49*/]))
			{
				func_12(&(Local_39[iVar0 /*49*/]), iVar0);
			}
			else if (unk_0x1C2F771CDC87A3A5(Local_39[iVar0 /*49*/], 0))
			{
				func_11(&(Local_39[iVar0 /*49*/]));
			}
			func_4(&(Local_39[iVar0 /*49*/]));
		}
		iVar0++;
	}
	iLocal_35 = 0;
		...
		if (uParam0->f_46 && func_20(uParam0))
		{
			...
			*uParam0 = unk_0xB1DBFEB95C0EFB88(26, func_19(uParam0), uParam0->f_40, uParam0->f_43, 0, 0);
			if (unk_0xFC8BFE4B41177C22(*uParam0))
			{
				...
				if (iParam1 + 1 < 50)
				{
					if (func_19(&(Local_39[iParam1 + 1 /*49*/])) != func_19(uParam0))
					{
						unk_0x55098D9E9AD58806(func_19(uParam0));
					}
				}
				else
				{
...
bool func_28()
{
	return (!Global_1579717 && unk_0x834C960822A4683F());
}
...
void func_39()
{
	...
	while (iVar0 < 50)
	{
		func_40(&(Local_39[iVar0 /*49*/]), iVar0);
		iVar0++;
	}
}
...
{
	if (iParam0 >= Global_262145.f_26606)
	{
		return 5;
	}
	else if (iParam0 >= Global_262145.f_26605)
	{
		return 4;
	}
	else if (iParam0 >= Global_262145.f_26604)
	{
		return 3;
	}
	else if (iParam0 >= Global_262145.f_26603)
	{
		return 2;
	}
	return 1;
...
void func_46()
{
	while (!unk_0x0384E096E4BE6261(32, 0, Global_1579736))
	{
		system::wait(0);
	}
	Global_1579736++;
	func_47(0, -1, 0);
	unk_0x6F4A865F87C7A3AD(&Local_38, 3, 0);
}
