...
void __EntryFunction__()
{
	...
	if (!func_276(&iVar2, &Var0, Var1, 1f))
	{
		func_275();
	...
	while (true)
	{
		...
		func_214(Var0.f_0);
		func_207(&iLocal_51, &(Var0.f_9), Var1);
		if (Var0.f_0 == 44)
		{
			func_199(&Var0, Var1, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_52);
			func_198();
		}
		else if (Var0.f_0 == 45)
		{
			func_199(&Var0, Var1, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_53);
			func_196(&Var0);
		}
		if (func_181(&Var0, 0))
		{
...
void func_196(int iParam0)
{
	...
	if ((unk_0x1DD05E817C89C737() - iLocal_56) > 1250)
	{
		if (func_137(iParam0->f_28[0]) && !unk_0xCB5CAFF0A4A8B74B(iParam0->f_28[0]))
		{
			if (func_137(unk_0x4A8C381C258A124D()) && !func_197(unk_0x4A8C381C258A124D(), iParam0->f_28[0], 50f, 1))
			{
				Var0 = { unk_0xD1A6A821F5AC81DB(iParam0->f_28[0], 1) };
				Var1 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
				fVar3 = (Var1.f_0 - Var0.f_0);
				fVar4 = (Var1.f_1 - Var0.f_1);
				if (fVar4 != 0f)
				{
					fVar2 = unk_0x4964D7A2BFD2F9A3(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				unk_0x5C96CEA06531AB03(iParam0->f_28[0], fVar2);
			}
		}
...
void func_198()
{
	...
	unk_0x88F483FBD433696A(uLocal_54, "SET_COLOUR");
	...
	unk_0x88F483FBD433696A(uLocal_54, "SET_DISTANCE");
	unk_0x74BF156C860580D4(10f);
	unk_0xE6B753D52F4CA222();
	unk_0x61055542D9D877AE(uLocal_55);
	fVar0 = 0,1f;
	fVar1 = 0,24f;
	fVar2 = 0,21f;
	fVar3 = 0,51f;
	...
	unk_0x6D16B99FEB0AFFF1(uLocal_54, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x1DD05E817C89C737() - iLocal_56) > 1250)
	{
		unk_0xF37CDE164C892195(uLocal_57, "IDLE_BEEP", 2468,51f, 3437,39f, 49,9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_56 = unk_0x1DD05E817C89C737();
	}
}

int func_199(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_187(2))
		{
			if (!func_157())
			{
				if ((func_137(unk_0x4A8C381C258A124D()) && func_137(iParam0->f_28[0])) && func_206(unk_0x4A8C381C258A124D(), Param1, 1) < 20f)
				{
			...
			if (func_206(unk_0x4A8C381C258A124D(), Param1, 1) < 20f && *uParam6 == 1)
			{
...
void func_207(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
...
int func_215(int iParam0, bool bParam1)
{
	...
	func_120(*iParam0, &Var0);
	if ((func_252(*iParam0) || func_250(*iParam0)) || Global_79635 == 1)
	{
		return 1;
	}
	if (!unk_0x173751E886F8E9AB())
...
void func_216(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_137(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_218(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_217(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_218(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_217(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
			...
			if (unk_0xFC8BFE4B41177C22(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_224(unk_0x4A8C381C258A124D(), uParam0->f_35[iVar0]))
							{
...
int func_227(int iParam0, float fParam1)
{
	...
	{
		if (func_238(iParam0) || unk_0x41754DC6001F6313(unk_0x259BE71D8A81D4FA(), iParam0))
		{
...
bool func_229(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	uVar0 = func_230(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
...
int func_233(int iParam0, int iParam1, float fParam2, int iParam3)
{
	...
	Var0 = { func_235(unk_0xD1A6A821F5AC81DB(iParam1, 1) - unk_0xD1A6A821F5AC81DB(iParam0, 1)) };
	...
	{
		Var1 = { func_235(unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 5f, 0f) - unk_0x83FDC027F0BEA202(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_242(int iParam0, struct<3> Param1, float fParam2, int iParam3)
{
	...
	Var0 = { func_235(Param1 - unk_0xD1A6A821F5AC81DB(uParam0, 1)) };
	if (fParam2 < 0,1f || fParam2 > 360f)
	{
		return 1;
	}
...
void func_254()
{
	uLocal_54 = unk_0x8DE4F68A9728925E("digiscanner");
	while (!unk_0xA0C7B98BCF1EEF9E(uLocal_54))
	{
		system::wait(0);
	}
	...
	if (unk_0xC13AFEAFC3F7AD96("digiscanner"))
	{
		uLocal_55 = unk_0x08732C0099FA1813("digiscanner");
	}
	uLocal_57 = unk_0xCA369FBC0DE29517();
	iLocal_56 = unk_0x1DD05E817C89C737();
}
...
int func_256(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_263(&iVar0) || !func_262(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_49 = 2;
		...
		case 2:
			...
			{
				if (!func_259(&(uParam0->f_28[0]), 69, 2319,443f, 2583,588f, 46,7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_257(&(uParam0->f_35[0]), iVar0[1], 2331,08f, 2573,53f, 46,13f, 358,61f);
			}
			if (bVar2)
			{
				iLocal_49 = 3;
...
void func_257(var uParam0, var uParam1, struct<3> Param2, float fParam3)
{
	func_258(uParam0);
...
int func_260(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
void func_264(var uParam0, char* sParam1, char* sParam2, int iParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_265(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (!func_259(&(uParam0->f_28[0]), 69, 2468,51f, 3437,39f, 49,9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			if ((func_137(uParam0->f_28[0]) && unk_0xFC8BFE4B41177C22(uParam0->f_41[0])) && unk_0xFC8BFE4B41177C22(uParam0->f_41[1]))
			{
...
int func_276(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	...
	if (*iParam0 == 1)
	{
		if (func_277((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_277((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_277(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_278(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_278(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_279(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0xFC8BFE4B41177C22(iParam0->f_41[1]))
		{
			unk_0xB3B56385ECA230B4(&(iParam0->f_41[1]));
		}
