...
void __EntryFunction__()
{
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113056[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_271(&(Global_113056[Var0.f_0 /*10*/].f_9));
			}
		}
		func_258(&Var0, 1);
	}
	iVar2[0] = 35;
	if (!func_255(&iVar2, &Var0, Var1, 1f))
	{
		func_254();
	...
	func_243(&Var0);
	uLocal_50 = unk_0xA7B0B03284E7503C(Var1 - Vector(20f, 20f, 20f), Var1 + Vector(20f, 20f, 20f), 0, 1, 1, 1, 1);
	...
	while (true)
	{
		...
		func_204(Var0.f_0);
		func_196(&iLocal_49, &(Var0.f_9), Var1);
		if (func_181(&Var0, 0))
		{
			if (Var0.f_0 == 35)
			{
...
bool func_249(int iParam0, char* sParam1)
{
...
int func_255(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_256((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_256((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_256(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_257(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_257(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_259(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
