...
void __EntryFunction__()
{
	...
	iLocal_40 = 49;
	iLocal_41 = 64;
	Local_47 = { -336,6146f, -93,66808f, 46,0005f };
	fLocal_48 = 256,1257f;
	fLocal_52 = 0f;
	Local_57 = { -334,8087f, -85,713f, 47,4504f };
	sLocal_59 = "scr_lamgraff_paint_spray";
	sLocal_60 = "switch@franklin@lamar_tagging_wall";
	sLocal_61 = "lamar_tagging_wall_loop_lamar";
	sLocal_62 = "lamar_tagging_wall_exit_lamar";
	sLocal_63 = "lamar_tagging_exit_loop_lamar";
	Local_64 = { 0f, 0f, 0f };
	if (unk_0x96CFB880BAC634CE(11))
	{
		func_150();
	}
	func_85(ScriptParam_68.f_1[0 /*3*/]);
	while (true)
	{
		func_71();
		switch (iLocal_43)
...
void func_5(int iParam0, int iParam1)
{
	...
	if (iParam1 <= func_28(iParam0))
	{
		...
		{
			func_7(func_13(iParam0, iParam1), Local_42.f_0, Local_42.f_1);
		}
...
void func_40(int iParam0)
{
	...
	while (iVar1 < Global_113969.f_7691.f_198)
	{
		...
		{
			func_41(Global_113969.f_7691.f_137[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_41(int iParam0)
{
	...
	{
		if (func_47(iParam0, Global_20930) == 1)
		{
			func_46(iParam0, Global_20930, 0);
			if (func_45(iParam0, Global_20930) == 0)
			{
				iVar0 = Global_20930;
...
void func_51()
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				uLocal_56[iVar1] = unk_0x4E55EAB577C13329(joaat("prop_paints_can02"), -335,66f, -95,24f, 46,16f, 1, 1, 0);
				unk_0x62C438C53BB57AFD(uLocal_56[iVar1], -335,66f, -95,24f, 46,16f, 0, 0, 1);
				unk_0xCF39804E8C88080E(uLocal_56[iVar1], -2,32f, 0,66f, -0,8f, 2, 1);
				break;
			
			case 2:
				uLocal_56[iVar1] = unk_0x4E55EAB577C13329(joaat("prop_paint_brush05"), -336,04f, -94,9f, 46,02f, 1, 1, 0);
				unk_0x62C438C53BB57AFD(uLocal_56[iVar1], -336,04f, -94,9f, 46,02f, 0, 0, 1);
				unk_0xCF39804E8C88080E(uLocal_56[iVar1], 0,01f, 3,85f, 2,72f, 2, 1);
				break;
			
			case 3:
				uLocal_56[iVar1] = unk_0x4E55EAB577C13329(joaat("prop_paint_spray01b"), -336,34f, -95,66f, 46,02f, 1, 1, 0);
				unk_0x62C438C53BB57AFD(uLocal_56[iVar1], -336,34f, -95,66f, 46,02f, 0, 0, 1);
				unk_0xCF39804E8C88080E(uLocal_56[iVar1], -2,86f, 0,76f, 28,89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_55()
{
	...
	else if (iLocal_44 == 2)
	{
		...
		{
			if (unk_0x89568FA9A6BC0B4A(iLocal_46, 1))
			{
				func_150();
			}
		}
		...
		switch (iLocal_45)
		{
			...
			case 1:
				if (func_56())
				{
					if (func_50(iLocal_46))
					{
						if (unk_0x00926C3C4443B915(1106247680, 31086, 1061997773, 1060320051, 1048576000, 1090519040, 1051361018, 31086, 24818) == iLocal_46)
						{
							iLocal_67 = unk_0x1DD05E817C89C737() + 2000;
							iLocal_45++;
						}
					}
				}
			...
			case 2:
				if (iLocal_67 < unk_0x1DD05E817C89C737())
				{
					iLocal_50 = 1;
					iLocal_45++;
				}
...
int func_57()
{
	...
	else
	{
		...
		{
			iLocal_46 = unk_0xB1DBFEB95C0EFB88(26, joaat("u_m_m_streetart_01"), Local_47, fLocal_48, 1, 1);
			unk_0x55098D9E9AD58806(joaat("u_m_m_streetart_01"));
			uLocal_56[0] = unk_0x4E55EAB577C13329(joaat("prop_cs_spray_can"), Local_57, 1, 1, 0);
			unk_0x4D306DD94DD6FDBA(uLocal_56[0], iLocal_46, unk_0x72F7E39FB49FC0BA(iLocal_46, 28422), 0f, -0,01f, -0,02f, Local_64, 1, 1, 0, 0, 2, 1, 0);
			unk_0x44FB298D6382876D(iLocal_46, 1);
			unk_0x0428AFDCAA63B06E(iLocal_46, 42, 1);
			uLocal_51 = func_68(iLocal_46, 0, 145);
			func_58(1);
			unk_0x3CEA1FD137ACE2D9(iLocal_46, joaat("player"));
			unk_0x93956DF263A4A0DC(iLocal_46, 2,5f);
		}
	}
	return 0;
}
...
int func_62()
{
	switch (func_63(&Global_33008, 0, 5, 0, unk_0x8F76B2250AC806FA()))
	{
		case 1:
			return 1;
			break;
...
{
	func_72();
	if (!unk_0x173751E886F8E9AB() && iLocal_49 < 3)
	{
		func_150();
	}
}
...
void func_72()
{
	...
	if (func_50(iLocal_46))
	{
		bVar0 = func_50(iLocal_46);
		bVar1 = func_50(unk_0x4A8C381C258A124D());
		Var2 = { unk_0xD1A6A821F5AC81DB(iLocal_46, 0) };
		fVar4 = 7,5f;
		...
		{
			case 0:
				unk_0x80813AC549A1E8AE(sLocal_60);
				if (unk_0xE100DD4F82A51BDE(sLocal_60))
				{
					unk_0xAAA71DD7E9059338(iLocal_46, 1);
					unk_0x10425721983AE158(iLocal_46, sLocal_60, sLocal_61, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_49++;
				}
				break;
			...
			case 1:
				...
				if (func_82(unk_0x4A8C381C258A124D(), iLocal_46, 35f))
				{
					unk_0xB5396F1FB088FE38(&uLocal_66);
					unk_0x10425721983AE158(0, sLocal_60, sLocal_62, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0x10425721983AE158(0, sLocal_60, sLocal_63, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x93C0674FC00824D0(uLocal_66);
					unk_0x4BD42B0527065BB6(iLocal_46, uLocal_66);
					unk_0xD0557B139A542F12(&uLocal_66);
					unk_0x268BE77F77533D03(sLocal_60);
					iLocal_49++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_82(unk_0x4A8C381C258A124D(), iLocal_46, fVar8))
				{
					iLocal_49 = 3;
				}
				if (iLocal_50)
			...
			case 4:
				unk_0x1CA08719184AFC6F(iLocal_46, 8, 1);
				unk_0x1CA08719184AFC6F(iLocal_46, 32, 1);
				unk_0xB5396F1FB088FE38(&uLocal_66);
			...
			case 5:
				...
				if (!unk_0xCB5CAFF0A4A8B74B(iLocal_46) && system::vdist2(Var2, unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 0)) > 2500f)
				{
					uLocal_65 = unk_0x120E577522852984(Var3, Var2, 1, 0, 7);
					iLocal_49++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0x0E7DD1EBCA8D2DE3(uLocal_65, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0xFC8BFE4B41177C22(iLocal_46))
	{
		unk_0x5D7CD709B34C90F0(iLocal_46, 0);
	}
}
...
int func_73()
{
	...
	{
		case 0:
			if (unk_0x13CCB1AD131C1082(iLocal_46, sLocal_60, sLocal_63, 3))
			{
				fLocal_52 = 0,349f;
				iLocal_53 = 900;
				Local_55 = { Var0 };
			...
			else if (unk_0x13CCB1AD131C1082(iLocal_46, sLocal_60, sLocal_62, 3))
			{
				fLocal_52 = unk_0x82E64DE58A6B84A8(iLocal_46, sLocal_60, sLocal_62);
				fLocal_52 = func_77(fLocal_52, 0,2f, 0,349f);
				if (fLocal_52 != 0,2f)
				{
					fVar2 = ((1f / (0,349f - 0,161f)) * system::to_float(900));
					iLocal_53 = system::round(((fLocal_52 - 0,161f) * fVar2));
					Local_55 = { unk_0xD1A6A821F5AC81DB(iLocal_46, 0) - Vector(1f, 0f, 0f) };
					iLocal_54 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0x10425721983AE158(iLocal_46, sLocal_60, sLocal_62, 4f, -8f, -1, 0, fLocal_52, 1, 0, 0);
			iLocal_67 = unk_0x1DD05E817C89C737();
			func_76(&uLocal_51);
			func_75();
			if (unk_0xFC8BFE4B41177C22(uLocal_56[0]))
			{
				unk_0x837D67618BF89034(uLocal_56[0], 1, 1);
			}
			iLocal_54++;
			break;
		
		case 2:
			if (unk_0x13CCB1AD131C1082(iLocal_46, sLocal_60, sLocal_62, 3))
			{
				iVar3 = (unk_0x1DD05E817C89C737() - iLocal_67);
				fVar4 = (system::to_float(iVar3) / system::to_float(iLocal_53));
				fVar5 = (fLocal_52 - ((fLocal_52 - 0,161f) * fVar4));
				fVar5 = func_77(fVar5, 0,161f, fLocal_52);
				unk_0x6D75623C644D6F83(iLocal_46, sLocal_60, sLocal_62, fVar5);
				fVar6 = (fVar4 - 0,12f);
				fVar6 = func_77(fVar6, 0f, 0,8f);
				Var7 = { func_74(Local_55, Var1, fVar6) };
				unk_0xB2BD5837A8D3CEDA(iLocal_46, Var7, 0, 1, 0, 1);
				if (fVar5 == 0,161f)
				{
					unk_0x5D7CD709B34C90F0(iLocal_46, 0);
					return 1;
...
void func_75()
{
	if (iLocal_58 != 0)
	{
		unk_0x182120534CCF9023(iLocal_58, 0);
		iLocal_58 = 0;
	}
}
...
void func_78()
{
	...
	if (unk_0x13CCB1AD131C1082(iLocal_46, sLocal_60, sLocal_62, 3))
	{
		fVar0 = unk_0x82E64DE58A6B84A8(iLocal_46, sLocal_60, sLocal_62);
		if (fVar0 < 0,383793f)
		{
			func_75();
		}
	...
	else if (unk_0x13CCB1AD131C1082(iLocal_46, sLocal_60, sLocal_63, 3))
	{
		fVar0 = unk_0x82E64DE58A6B84A8(iLocal_46, sLocal_60, sLocal_63);
		if (fVar0 < 0,1124f)
		{
			func_75();
		}
...
void func_79()
{
	if (iLocal_58 == 0)
	{
		iLocal_58 = unk_0x62750FD2BDD8BD49(sLocal_59, uLocal_56[0], Local_64, Local_64, 1065353216, 0, 0, 0);
		unk_0x6154AB43546C6437(iLocal_58, 1f, 1f, 1f, 0);
		unk_0x1C53039135495CAE(iLocal_58, 0,2f);
	}
}
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	if (unk_0xFC8BFE4B41177C22(uParam0) && unk_0xFC8BFE4B41177C22(uParam1))
	{
		...
		return system::vdist2(unk_0xD1A6A821F5AC81DB(iParam0, 0), unk_0xD1A6A821F5AC81DB(iParam1, 0)) <= fVar0;
	}
	return 0;
}
...
{
	if (!func_84(iLocal_46, iParam0) && !func_84(iLocal_46, joaat("script_task_smart_flee_ped")))
	{
		func_76(&uLocal_51);
		unk_0xD844F5E50DAB6FF7(iLocal_46, unk_0x4A8C381C258A124D(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}
...
int func_95(struct<3> Param0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (!bVar0)
	{
		...
		if (!func_133(Global_113969.f_24998.f_43[iParam1]))
		{
			return 0;
		}
		...
		if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
		{
			if (!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0x6652E84A43F51B8B(unk_0x259BE71D8A81D4FA(), 1) || func_130()) || Global_32951) || func_129()) || func_128(8, -1)) || func_125()) || func_127()) || func_126()) || func_124()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_130() || unk_0xE7B45027762DEFE7(unk_0x259BE71D8A81D4FA()) > 0) || func_128(8, -1)) || func_124()) || func_123()) || Global_113969.f_7691.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_151(int iParam0)
{
	...
	if (func_162())
	{
		...
		func_154(30000);
		StringCopy(&cVar0, func_153(Global_113958, 1), 64);
