...
void __EntryFunction__()
{
	...
	unk_0xF2CB0224D3BE0B42("REPORT", 0);
	...
	while (true)
	{
		switch (iLocal_50)
		{
			...
			case 1:
				...
				uLocal_51 = unk_0x8DE4F68A9728925E("PSYCHOLOGY_REPORT");
				while (!unk_0xA0C7B98BCF1EEF9E(uLocal_51))
				{
					func_43();
					system::wait(0);
				}
				unk_0xF2CB0224D3BE0B42("REPORT", 3);
				while (!unk_0xDCB78A15E5F495DC(3))
				{
					func_43();
					system::wait(0);
				}
				unk_0x88F483FBD433696A(uLocal_51, "SET_PLAYER_NAME");
				unk_0x882AEFD55B8D51FB("STRING");
				unk_0xACF853FB3F6EA7D4("PATIENT");
				unk_0xCFAD3D478C87321A();
				unk_0x882AEFD55B8D51FB("GAMERTAG");
				...
				{
					unk_0xACF853FB3F6EA7D4("ACCNA_MIKE");
				}
				unk_0xCFAD3D478C87321A();
				unk_0xE6B753D52F4CA222();
				unk_0x88F483FBD433696A(uLocal_51, "SET_LETTER_TEXT");
				func_42("HEADER_1");
				func_42("HEADER_2");
				Var0 = { func_41(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_40(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_39(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_38(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_37(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_35(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_33(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_32(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_31(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_30(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_28(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_24(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_23(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_21(&uLocal_52) };
				func_42(&Var0);
				Var0 = { func_20(&uLocal_52) };
				func_42(&Var0);
				unk_0xE6B753D52F4CA222();
				...
				if (unk_0x15CCE8886267624F())
				{
					...
					while (!unk_0x9390801B06EE998F())
					{
						...
						unk_0xA91A4C18A2DB01BD(uLocal_51, 255, 255, 255, 255, 0);
						system::wait(0);
					}
				}
				func_43();
			...
			case 2:
				unk_0xA4F67CEB594AE064(1);
				unk_0xA91A4C18A2DB01BD(uLocal_51, 255, 255, 255, 255, 0);
				func_1(&uLocal_70, 1128792064, 1, 0, 1, 1065353216);
...
void func_1(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	if (!func_6(uParam0->f_1, 256) || (func_6(uParam0->f_1, 8192) && unk_0x7811C74D5B749F76(2)))
	{
		...
		if (unk_0x761778199FE1211C())
		{
			...
			unk_0x557F1E2300EF1A3E(func_6(uParam0->f_1, 4096));
			unk_0xE6B753D52F4CA222();
		}
		iVar5 = 0;
		iVar6 = 0;
...
int func_13(var uParam0, var uParam1, var uParam2)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			unk_0xCBF0312D1370143F(iVar0, "in", *uParam2);
			unk_0xA47FC2B828F55E4D(iVar0, "st", &(uParam2->f_1));
			unk_0xA47FC2B828F55E4D(iVar0, "mp", &(uParam2->f_2));
			unk_0xA47FC2B828F55E4D(iVar0, "ms", &(uParam2->f_3));
			unk_0xA47FC2B828F55E4D(iVar0, "sc", &(uParam2->f_5));
			unk_0xA47FC2B828F55E4D(iVar0, "pr", &(uParam2->f_6));
			unk_0xA47FC2B828F55E4D(iVar0, "fa", &(uParam2->f_7));
			unk_0xA47FC2B828F55E4D(iVar0, "sm", &(uParam2->f_8));
			unk_0xA47FC2B828F55E4D(iVar0, "kp", &(uParam2->f_9));
			unk_0xA47FC2B828F55E4D(iVar0, "sv", &(uParam2->f_10));
			unk_0xA47FC2B828F55E4D(iVar0, "yo", &(uParam2->f_11));
			unk_0xA47FC2B828F55E4D(iVar0, "fi", &(uParam2->f_12));
			unk_0xA47FC2B828F55E4D(iVar0, "rc", &(uParam2->f_13));
			unk_0xA47FC2B828F55E4D(iVar0, "co", &(uParam2->f_14));
			unk_0xCBF0312D1370143F(iVar0, "su", uParam2->f_15);
			unk_0xA8F33BC779C28BFB("gta5/psych/index.json", 0);
			*uParam0++;
			break;
...
{
	if (!unk_0x3CBCE367459737AD(uParam0))
	{
		if (*uParam0)
		{
			if (unk_0x6C99356A4D3C7B09(0) != 0 && iParam1)
			{
...
struct<4> func_20(var uParam0)
{
	...
	iVar1 = unk_0xC5935DFB3F39785A(1, 24);
	uParam0->f_15 = iVar1;
...
struct<4> func_21(var uParam0)
{
	...
	if (((func_22(110) || func_22(95)) || func_22(106)) || func_22(107))
	{
		...
		iVar1 = unk_0xC5935DFB3F39785A(1, 11);
	}
	else
	{
		StringCopy(&(uParam0->f_14), "N", 4);
		StringConCat(&Var0, "N", 16);
		iVar1 = unk_0xC5935DFB3F39785A(1, 12);
	}
...
struct<4> func_23(var uParam0)
{
	...
	unk_0xDF7F16323520B858(joaat("num_rndpeople_completed"), &iVar2, -1);
	unk_0xDF7F16323520B858(joaat("num_rndevents_completed"), &iVar3, -1);
	iVar4 = (iVar2 + iVar3);
	if (iVar4 > 10)
	{
	...
	iVar1 = unk_0xC5935DFB3F39785A(1, 13);
...
int func_25(int iParam0, int iParam1)
{
	...
	unk_0xDF7F16323520B858(iVar1, &uVar0, -1);
	return uVar0;
}
...
struct<4> func_30(var uParam0)
{
	...
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_cop_vehicle"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_cars"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_bikes"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_boats"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_helis"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_quadbikes"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_number_stolen_bicycles"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_cop_vehicle"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_cars"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_bikes"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_boats"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_helis"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_quadbikes"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_number_stolen_bicycles"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_cop_vehicle"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_cars"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_bikes"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_boats"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_helis"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_quadbikes"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_number_stolen_bicycles"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	if (iVar3 >= 100)
	{
...
struct<4> func_31(var uParam0)
{
	...
	unk_0xDF7F16323520B858(joaat("sp0_kills_innocents"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_kills_innocents"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_kills_innocents"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	if (iVar3 >= 100)
	{
...
struct<4> func_32(var uParam0)
{
	...
	unk_0xDF7F16323520B858(joaat("time_spent_on_stockmarket"), &iVar2, 0);
	if (iVar2 >= 120000)
	{
...
int func_34(int iParam0)
{
	if (iParam0 < 9)
	{
		return BitTest(Global_113969.f_18106.f_175[iParam0 /*19*/].f_18, 0);
	}
	return 0;
}
...
int func_36(int iParam0)
{
	...
	{
		case 0:
			return Global_113969.f_10052.f_90[0];
			break;
		
		case 1:
			return Global_113969.f_10052.f_90[1];
			break;
		
		case 2:
			return Global_113969.f_10052.f_90[2];
			break;
	}
	return 0;
}
...
struct<4> func_37(var uParam0)
{
	...
	unk_0xDF7F16323520B858(joaat("sp0_lap_danced_bought"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_lap_danced_bought"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_lap_danced_bought"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp0_money_spent_in_strip_clubs"), &iVar4, 0);
	iVar5 = (iVar5 + iVar4);
	unk_0xDF7F16323520B858(joaat("sp1_money_spent_in_strip_clubs"), &iVar4, 1);
	iVar5 = (iVar5 + iVar4);
	unk_0xDF7F16323520B858(joaat("sp2_money_spent_in_strip_clubs"), &iVar4, 2);
	iVar5 = (iVar5 + iVar4);
...
struct<4> func_38(var uParam0)
{
	...
	unk_0xDF7F16323520B858(joaat("sp0_money_total_spent"), &iVar2, 0);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp1_money_total_spent"), &iVar2, 1);
	iVar3 = (iVar3 + iVar2);
	unk_0xDF7F16323520B858(joaat("sp2_money_total_spent"), &iVar2, 2);
	iVar3 = (iVar3 + iVar2);
	if (iVar3 >= 1000000)
	{
		StringCopy(&(uParam0->f_3), "SP", 8);
		StringConCat(&Var0, "SP", 16);
		iVar1 = unk_0xC5935DFB3F39785A(1, 14);
	}
	else
	{
...
struct<4> func_39(var uParam0)
{
	...
	iVar2 = 0;
	iVar4 = 0;
	unk_0xDF7F16323520B858(joaat("sp0_total_playing_time"), &iVar4, 0);
	unk_0xDF7F16323520B858(joaat("sp1_total_playing_time"), &iVar3, 1);
	if (iVar3 > iVar4)
	{
		iVar4 = iVar3;
		iVar2 = 1;
	}
	unk_0xDF7F16323520B858(joaat("sp2_total_playing_time"), &iVar3, 2);
	if (iVar3 > iVar4)
	{
		iVar4 = iVar3;
		iVar2 = 2;
...
struct<4> func_41(var uParam0)
{
	...
	iVar1 = unk_0xC5935DFB3F39785A(1, 21);
	*uParam0 = iVar1;
	StringIntConCat(&Var0, iVar1, 16);
	return Var0;
}
...
void func_51(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else
	{
		...
		{
			if ((((((!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_57(unk_0x259BE71D8A81D4FA())) && !func_53(unk_0x259BE71D8A81D4FA(), 0)) && !func_52()) && !bParam4) && !bParam5) && !unk_0xAD15761928FCF79C())
			{
				unk_0x935364B4448CD584(unk_0x4A8C381C258A124D(), 0);
			}
		}
		else if (((!unk_0x4FAFF4BCB7633475(unk_0x4A8C381C258A124D()) && !func_57(unk_0x259BE71D8A81D4FA())) && !bParam4) && !bParam5)
		{
			unk_0x935364B4448CD584(unk_0x4A8C381C258A124D(), 0);
		}
		Global_79387 = 0;
...
int func_59(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
