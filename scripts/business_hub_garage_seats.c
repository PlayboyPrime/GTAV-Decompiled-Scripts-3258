...
int func_81()
{
	if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -1502,824f, -3006,31f, -80,557f, -1513,824f, -3006,31f, -84,557f, 9,5f, 0, 1, 0))
	{
		return 1;
	}
	return 0;
...
int func_82()
{
	if (Global_2657971[unk_0x259BE71D8A81D4FA() /*465*/].f_322.f_11 != func_19())
	{
		if (unk_0x99F8FC8A6D8E20C0("business_hub_garage_seats", Global_2657971[unk_0x259BE71D8A81D4FA() /*465*/].f_322.f_11, 1, 0))
		{
			return 0;
		}
...
void func_83()
{
	func_84(0, &uLocal_100, 0, 2);
	func_84(1, &uLocal_100, 1, 1);
	func_84(2, &uLocal_100, 2, 2);
	func_84(3, &uLocal_100, 3, 1);
	func_84(4, &uLocal_100, 4, 2);
	func_84(5, &uLocal_100, 5, 1);
	func_84(6, &uLocal_100, 6, 2);
	func_84(7, &uLocal_100, 7, 1);
	func_84(8, &uLocal_100, 8, 1);
}
...
void func_84(int iParam0, var uParam1, int iParam2, int iParam3)
{
	...
	func_88(iParam0, &Var0, &fVar1);
	(*uParam1)[iParam2 /*14*/] = iParam3;
	(uParam1[iParam2 /*14*/])->f_8 = { Var0 };
	(uParam1[iParam2 /*14*/])->f_8.f_3 = { 0f, 0f, fVar1 };
	(uParam1[iParam2 /*14*/])->f_1 = { func_86(func_87(), fVar1) + Var0 };
	(uParam1[iParam2 /*14*/])->f_1.f_3 = { func_86(func_85(), fVar1) + Var0 };
