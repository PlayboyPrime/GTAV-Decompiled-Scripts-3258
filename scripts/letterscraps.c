#region Local Var
	...
	var uLocal_53 = 0;
	int iLocal_54 = 0;
	char* sLocal_55[4] = { NULL, NULL, NULL, NULL };
	int iLocal_56 = 0;
	var uLocal_57 = 0;
	int iLocal_58 = 0;
#endregion
	...
	switch (iLocal_41)
	{
				...
				if (unk_0x9390801B06EE998F())
				{
					if (!func_20())
					{
						if (((!unk_0xE87F28FD4128D063() && !func_14()) && !func_13()) && !func_12())
						{
							...
							uLocal_53 = unk_0x8DE4F68A9728925E("LETTER_SCRAPS");
							while (!unk_0xA0C7B98BCF1EEF9E(uLocal_53))
							{
								system::wait(0);
							}
							unk_0x88F483FBD433696A(uLocal_53, "SET_LETTER_TEXT");
							func_11(sLocal_55[0]);
		...
		case 1:
			...
			if (iLocal_54 < 4)
			{
				...
				unk_0xA91A4C18A2DB01BD(uLocal_53, 255, 255, 255, 255, 0);
			}
			else
			{
				iLocal_41 = 2;
...
int func_15(int iParam0)
{
	...
	iVar0 = iParam0;
	if (!unk_0x1B79E937E91F40C3(&(Global_112618[iParam0 /*28*/]), "") && !unk_0xFF692AB7350A74D7(&(Global_112618[iParam0 /*28*/])))
	{
		if (BitTest(Global_112618[iParam0 /*28*/].f_27, 1))
		{
			if (BitTest(Global_112618[iParam0 /*28*/].f_27, 2))
			{
				return func_19(iVar0, &(Global_112618[iParam0 /*28*/]), &(Global_112618[iParam0 /*28*/].f_4), Global_112618[iParam0 /*28*/].f_20);
			}
			else
			{
				return func_18(iVar0, &(Global_112618[iParam0 /*28*/]), &(Global_112618[iParam0 /*28*/].f_4));
			}
		}
		else if (BitTest(Global_112618[iParam0 /*28*/].f_27, 2))
		{
			return func_17(iVar0, &(Global_112618[iParam0 /*28*/]), Global_112618[iParam0 /*28*/].f_20);
		}
		else
		{
			return func_16(iVar0, &(Global_112618[iParam0 /*28*/]));
		}
	}
	return 0;
}
	...
	while (iVar0 < 1)
	{
		...
		if (!(iParam1[uParam0->f_10 /*11*/])->f_10)
		{
			if (!bVar1)
			{
				...
				else if (uParam0->f_10 == iLocal_49)
				{
					func_55(iParam1[uParam0->f_10 /*11*/], uParam0->f_7, joaat("pickup_custom_script"), 0, 1, 2);
					if (unk_0xB0E14182FAD64944((iParam1[uParam0->f_10 /*11*/])->f_1))
					{
						unk_0x57303BAC3E5DA035((iParam1[uParam0->f_10 /*11*/])->f_1, sLocal_50);
					}
				}
				else
				{
...
int func_26(int iParam0)
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (BitTest(Global_113969.f_10052.f_108, func_30(func_31(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_38(var uParam0, var uParam1, struct<3> Param2)
{
	...
	{
		if ((system::vdist2(Param2, unk_0x80C8AA1625977488((uParam1[bVar0 /*11*/])->f_1)) > (60f * 60f) || func_58(13)) || func_58(14))
		{
...
void func_62()
{
	...
	Global_113969.f_10052.f_122.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
		Local_48[iVar0 /*11*/].f_3 = { func_63(iVar0, 0) };
		Local_48[iVar0 /*11*/].f_10 = 0;
		iVar0++;
	}
	iLocal_51 = 0;
	Local_48[0 /*11*/].f_9 = 179,4746f;
	Local_48[1 /*11*/].f_6 = { 0f, 0f, 198f };
	Local_48[2 /*11*/].f_9 = 104f;
	Local_48[3 /*11*/].f_9 = 321,5f;
	Local_48[4 /*11*/].f_6 = { 0f, 0f, 49f };
	Local_48[5 /*11*/].f_6 = { 0f, 0f, 286,5f };
	Local_48[6 /*11*/].f_9 = 278,0092f;
	Local_48[7 /*11*/].f_6 = { 5,3f, -1801,4f, 15,57f };
	...
	Local_48[13 /*11*/].f_6 = { -0,91f, -0,03f, -0,81f };
	Local_48[14 /*11*/].f_9 = 40f;
	Local_48[15 /*11*/].f_9 = 40f;
	Local_48[16 /*11*/].f_9 = 40f;
	Local_48[17 /*11*/].f_9 = 90f;
	Local_48[17 /*11*/].f_6 = { -0,55f, 0f, 0,78f };
	Local_48[18 /*11*/].f_6 = { 0f, 0f, 0f };
	Local_48[19 /*11*/].f_9 = 40f;
	Local_48[20 /*11*/].f_6 = { 0f, 2f, 15f };
	...
	Local_48[26 /*11*/].f_6 = { -6f, 10f, 0f };
	Local_48[27 /*11*/].f_9 = 40f;
	Local_48[27 /*11*/].f_6 = { -4,66f, 8,7f, 67,03f };
	Local_48[28 /*11*/].f_9 = 40f;
	Local_48[28 /*11*/].f_6 = { 1,54f, -8,31f, -19,94f };
	Local_48[29 /*11*/].f_9 = 40f;
	Local_48[30 /*11*/].f_9 = 40f;
	Local_48[30 /*11*/].f_6 = { 27,21f, -3,11f, -2,09f };
	Local_48[31 /*11*/].f_9 = 40f;
	Local_48[32 /*11*/].f_9 = 40f;
	Local_48[33 /*11*/].f_9 = 40f;
	Local_48[33 /*11*/].f_6 = { -9,89f, 0,3f, -0,01f };
	Local_48[34 /*11*/].f_9 = 40f;
	Local_48[35 /*11*/].f_9 = 40f;
	Local_48[36 /*11*/].f_9 = 40f;
	Local_48[36 /*11*/].f_6 = { 6,5f, -4,41f, -0,62f };
	Local_48[37 /*11*/].f_6 = { -9f, 5,3f, -2f };
	Local_48[38 /*11*/].f_9 = 40f;
	Local_48[38 /*11*/].f_6 = { -13,32f, -0,57f, -0,15f };
	Local_48[39 /*11*/].f_9 = 40f;
	Local_48[39 /*11*/].f_6 = { 4,71f, -21,26f, -0,06f };
	Local_48[40 /*11*/].f_9 = 40f;
	Local_48[41 /*11*/].f_9 = 80f;
	Local_48[42 /*11*/].f_6 = { -2f, 9f, 1f };
	Local_48[43 /*11*/].f_9 = 198f;
	Local_48[44 /*11*/].f_9 = 198f;
	Local_48[44 /*11*/].f_6 = { 0f, -20f, 0f };
...
void func_73()
{
	...
	unk_0xD314260005F064BF(&uLocal_53);
	unk_0x98E393364463951A(0);
	Global_113969.f_10052.f_122.f_2 = 0;
	iVar0 = 0;
