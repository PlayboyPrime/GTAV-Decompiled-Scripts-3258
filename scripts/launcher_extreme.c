...
void __EntryFunction__()
{
	...
	iLocal_50 = func_300(52);
	iLocal_51 = joaat("a_c_retriever");
	iLocal_52 = -1;
	uLocal_54 = unk_0xCA369FBC0DE29517();
	...
	if (unk_0x96CFB880BAC634CE(83))
	{
		...
		if (Var0.f_0 != -1)
		{
			if (Global_113056[Var0.f_0 /*10*/].f_9 != -1)
			{
				...
				func_296(&(Global_113056[Var0.f_0 /*10*/].f_9));
			}
		}
		func_284(&Var0, 1);
	}
	if (!func_281(&iVar2, &Var0, Var1, 1f))
	{
		func_280();
	...
	if (Var0.f_0 == 17)
	{
		uLocal_55 = unk_0xA7B0B03284E7503C(Var1 - Vector(40f, 40f, 40f), Var1 + Vector(40f, 40f, 40f), 0, 1, 1, 1, 1);
		unk_0x470041F66BF345BA("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0.f_0 == 18)
	{
		uLocal_55 = unk_0xA7B0B03284E7503C(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1, 1);
	}
	...
	while (true)
	{
		...
		func_216(Var0.f_0);
		func_209(&iLocal_52, &(Var0.f_9), Var1);
		if (Var0.f_0 == 18)
		{
			func_208(&Var0);
			func_203(&Var0, Var1, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0.f_0 == 19)
		{
			func_208(&Var0);
			if (unk_0x9F0C06CFBACDD6A1(uLocal_54))
			{
				func_203(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_202() && func_201(Var0.f_28[0])) && !unk_0x75E315E7679F4F24(Var0.f_28[0])) && unk_0x9F0C06CFBACDD6A1(uLocal_54)) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_A", 0, -1)) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_B", 0, -1)) && unk_0xD7E1DF759CD0FFF2("EXTREME_04_DOM_C", 0, -1))
			{
				unk_0xBD618A73193F9982(uLocal_54, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_53 == 0 && func_201(unk_0x4A8C381C258A124D())) && unk_0x65FFA94B82A71741(unk_0x4A8C381C258A124D(), Var1, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
				Var3 = { unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1) };
				if (Var3.f_2 < 100f)
				{
					iLocal_53 = 1;
					func_200("TOPMAZE_HELP", -1);
					func_297("Player below mission start location so displaying help text TOPMAZE_HELP");
				}
			}
		}
		if (func_185(&Var0, 0) || func_183(&Var0))
		{
			if (func_182(Var0.f_0))
			{
				func_179(Var0.f_0, &uLocal_56);
			}
			if (!func_2(&Var0))
			{
				func_284(&Var0, 1);
			...
			{
				unk_0x8E4825CCACA34B58(uLocal_54);
			}
			if (func_1(&Var0))
			{
				func_284(&Var0, 0);
...
void func_140(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < 6)
	{
		if (func_201(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_201(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_201(uParam0->f_41[iVar0]))
		{
...
void func_157()
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
		{
			if (func_158(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 10,5f, 1, 1056964608, 0, 1, 0))
			{
...
int func_158(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)
{
...
int func_169(int iParam0)
{
	...
	iVar0 = func_171(&(Global_113056[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
int func_176()
{
	return func_177(unk_0x1AF90EB93E0012D6(), 0);
}
...
void func_179(int iParam0, var uParam1)
{
	...
	{
		case 0:
			*uParam1 = func_180(-1604,668f, 5239,1f, 3,01f, 0);
			unk_0x4C905FB262965D5D(*uParam1, 66);
			unk_0x61183D6239A9D7B8(*uParam1, 42);
			break;
		
		case 1:
			*uParam1 = func_180(-1592,84f, 5214,04f, 3,01f, 0);
		...
		case 2:
		case 3:
			*uParam1 = func_180(190,26f, -956,35f, 29,63f, 0);
		...
		case 4:
			*uParam1 = func_180(414f, -761f, 29f, 0);
		...
		case 9:
			*uParam1 = func_180(-1622,89f, 4204,87f, 83,3f, 0);
			unk_0x4C905FB262965D5D(*uParam1, 66);
			unk_0x61183D6239A9D7B8(*uParam1, 42);
			break;
		...
		case 13:
			if (iParam0 == 11)
			{
				*uParam1 = func_180(1835,53f, 4705,86f, 38,1f, 0);
			}
			else if (iParam0 == 12)
			{
				*uParam1 = func_180(1826,13f, 4698,88f, 38,92f, 0);
			}
			else
			{
				*uParam1 = func_180(637,02f, 119,7093f, 89,5f, 0);
			}
		...
		case 19:
			if (iParam0 == 18)
			{
				*uParam1 = func_180(-954,19f, -2760,05f, 14,64f, 0);
			}
			else
			{
				*uParam1 = func_180(-63,8f, -809,5f, 321,8f, 0);
			}
		...
		case 23:
			if (iParam0 == 21)
			{
				*uParam1 = func_180(-1877,82f, -440,649f, 45,05f, 0);
			}
			else
			{
				*uParam1 = func_180(-915,6f, 6139,2f, 5,5f, 0);
			}
		...
		case 27:
			*uParam1 = func_180(-1104,93f, 291,25f, 64,3f, 0);
			unk_0x4C905FB262965D5D(*uParam1, 66);
			unk_0x61183D6239A9D7B8(*uParam1, 44);
			break;
		...
		case 34:
			*uParam1 = func_180(-303,82f, 6211,29f, 31,05f, 0);
			unk_0x4C905FB262965D5D(*uParam1, 386);
			unk_0x61183D6239A9D7B8(*uParam1, 44);
			break;
		
		case 43:
			*uParam1 = func_180(-44,75f, -1288,67f, 28,21f, 0);
			unk_0x4C905FB262965D5D(*uParam1, 149);
			unk_0x61183D6239A9D7B8(*uParam1, 44);
			break;
		
		case 46:
			*uParam1 = func_180(-149,75f, 285,81f, 93,67f, 0);
			unk_0x4C905FB262965D5D(*uParam1, 66);
			unk_0x61183D6239A9D7B8(*uParam1, 43);
			break;
		...
		case 48:
			if (iParam0 == 47)
			{
				*uParam1 = func_180(-70,71f, 301,43f, 106,79f, 0);
			}
			else
			{
				*uParam1 = func_180(-257,22f, 292,85f, 90,63f, 0);
			}
...
var func_180(struct<3> Param0, int iParam1)
{
	var uVar0;
	
	uVar0 = unk_0x34864AB7DA700AA6(Param0);
	unk_0x5D3946F818C6B331(uVar0, func_181(unk_0x76CD105BCAC6EB9F(), 1f, 1f));
...
int func_183(var uParam0)
{
	if (*uParam0 == 18)
	{
		if (unk_0x5105BE70DEF1F5FB(unk_0x4A8C381C258A124D(), -954,5357f, -2760,553f, 11,91636f, -947,6847f, -2749,719f, 15,63161f, 26f, 0, 1, 0))
		{
			if (!unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
			{
			...
			else if ((!func_184(unk_0x4A8C381C258A124D(), joaat("script_task_leave_any_vehicle")) && func_201(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0))) && func_158(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0), 3f, 1, 1056964608, 0, 1, 0))
			{
				unk_0x092B9247AF00F5CF(unk_0x4A8C381C258A124D(), 0, 0);
			}
		}
	...
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_201(uParam0->f_28[0]))
				{
					if (func_187(uParam0))
					{
						if (func_191(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
				{
					if (func_201(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)))
					{
...
int func_203(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	...
	if ((((func_201(unk_0x4A8C381C258A124D()) && func_201(iParam0->f_28[0])) && !func_202()) && (unk_0x1DD05E817C89C737() - iParam0->f_60) > iParam6) && func_207(unk_0x4A8C381C258A124D(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_206(&uVar0, iParam4, iParam0->f_28[0], sParam5, 0, 1);
...
float func_207(int iParam0, struct<3> Param1, int iParam2)
{
	struct<3> Var0;
...
void func_208(int iParam0)
{
	...
	{
		if (func_201(iParam0->f_28[0]))
		{
			unk_0x2F19C4305F0B8DA7("Dom", iParam0->f_28[0], 0);
		}
	}
}

void func_209(int iParam0, char* sParam1, struct<3> Param2)
{
	if (unk_0x75EAB09F5E974116(unk_0x259BE71D8A81D4FA()))
	{
		if (!unk_0xD6F9DEE4765092A9(sParam1))
		{
			...
			{
				if (func_207(unk_0x4A8C381C258A124D(), Param2, 1) <= 100f)
				{
					func_212(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_207(unk_0x4A8C381C258A124D(), Param2, 1) > 120f)
				{
					func_214(iParam0);
				}
			}
...
int func_217(var uParam0, bool bParam1)
{
	...
	if ((func_254(*uParam0) || func_252(*uParam0)) || Global_79635 == 1)
	{
		return 1;
	}
	if (!unk_0x173751E886F8E9AB())
	...
	if (func_221(&(uParam0->f_48)) && bParam1)
	{
		func_218(uParam0->f_28[0], &(uParam0->f_48), *uParam0);
	}
	return 1;
}
...
void func_218(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_201(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_220(uParam1) || !unk_0x13CCB1AD131C1082(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_219(iParam2) && !unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 25f))
					{
						unk_0x0E95B96CFEFE7B61(iParam0, unk_0x4A8C381C258A124D(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_220(uParam1) && uParam1->f_4 == 0) && unk_0xED977E2AE2CB16EE(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), unk_0xD1A6A821F5AC81DB(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_219(iParam2) || unk_0x3644984C9D7B57EF(iParam0, unk_0x4A8C381C258A124D(), 10f))
				{
					if (func_71(uParam1->f_5, 0f, 0f, 0f, 0))
					{
						unk_0x10425721983AE158(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
void func_222(var uParam0)
{
	...
	if (func_201(unk_0x4A8C381C258A124D()))
	{
		iVar0 = 0;
...
int func_229(int iParam0, float fParam1)
{
	...
	if (func_201(unk_0x4A8C381C258A124D()) && func_201(iParam0))
	{
...
bool func_231(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	...
	if (!func_201(iParam0) || !func_201(iParam1))
	{
		if (iVar2 != -1)
		{
			func_238(&(Local_35[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_232(&(Local_35[iVar2 /*4*/]), Var1, iParam1, &(Local_35[iVar2 /*4*/].f_3), iParam0, iParam5);
...
int func_241(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_201(unk_0x4A8C381C258A124D()) && func_201(uParam0))
	{
...
int func_256(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 1:
			if (!func_261(&iVar0) || !func_260(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_49 = 2;
...
void func_257(var uParam0, struct<3> Param1, float fParam2)
{
	func_258(uParam0, iLocal_51, Param1, fParam2, 26);
	unk_0x77EFA99E6A8FFC43(*uParam0);
	unk_0x81E9E7612B0E4BCE(*uParam0, 0);
	unk_0xEB418CA245FFE897(*uParam0, "EXTREME LAUNCHER RC");
}

void func_258(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4)
{
	func_259(uParam0);
...
void func_262(var uParam0, char* sParam1, char* sParam2, char* sParam3)
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_263(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			{
				if (func_264(&(uParam0->f_28[0]), 52, -63,8f, -809,5f, 321,8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					unk_0x0428AFDCAA63B06E(uParam0->f_28[0], 118, 0);
					unk_0x0428AFDCAA63B06E(uParam0->f_28[0], 208, 1);
					unk_0xB41DEC3AAC1AA107(uParam0->f_28[0], joaat("gadget_parachute"), 1, 0, 0);
...
int func_264(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)
{
	if (func_265(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (unk_0xFC8BFE4B41177C22(*uParam0))
		{
			if (!unk_0x1C2F771CDC87A3A5(*uParam0, 0))
...
int func_265(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)
{
	int iVar0;
...
int func_267(var uParam0)
{
	...
	switch (iLocal_49)
	{
		...
		case 2:
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_28[0]))
			{
				if (func_264(&(uParam0->f_28[0]), 52, -954,19f, -2760,05f, 14,64f, -31,79f, "EXTREME LAUNCHER RC", 1))
				{
					unk_0x62C438C53BB57AFD(uParam0->f_28[0], -954,2f, -2760,05f, 14,04f, 1, 0, 1);
					unk_0x0428AFDCAA63B06E(uParam0->f_28[0], 118, 0);
					unk_0x0428AFDCAA63B06E(uParam0->f_28[0], 208, 1);
					unk_0x5D7CD709B34C90F0(uParam0->f_28[0], 1);
					unk_0x44C48AC14D3C09ED(uParam0->f_28[0], 0, 0);
					unk_0xD1C578C204015E1F(uParam0->f_28[0], 8, 1, 0, 0);
					unk_0x10425721983AE158(uParam0->f_28[0], uParam0->f_48, uParam0->f_48.f_1, 8f, -8f, -1, 33281, 0, 0, 0, 0);
					if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
					{
						unk_0xE67051907958B5EB(uParam0->f_28[0], unk_0x4A8C381C258A124D(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[0]))
			{
				func_268(&(uParam0->f_35[0]), iVar0[0], -950,8f, -2751,98f, 13,21f, 199,05f);
				unk_0x0B74F181ADFC39BF(uParam0->f_35[0], 2);
				unk_0x20DD46D27530FAC7(uParam0->f_35[0], 0);
				unk_0x9452FE4900245259(uParam0->f_35[0], 0f);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[1]))
			{
				func_268(&(uParam0->f_35[1]), iVar0[0], -950,192f, -2755,96f, 13,3639f, -178,182f);
				unk_0x0B74F181ADFC39BF(uParam0->f_35[1], 2);
				unk_0x20DD46D27530FAC7(uParam0->f_35[1], 1);
				unk_0x9452FE4900245259(uParam0->f_35[1], 0f);
			}
			if (!unk_0xFC8BFE4B41177C22(uParam0->f_35[2]))
			{
				func_268(&(uParam0->f_35[2]), iVar0[1], -957,23f, -2764,89f, 14,04f, 147,61f);
				unk_0x0B74F181ADFC39BF(uParam0->f_35[2], 2);
				unk_0x20DD46D27530FAC7(uParam0->f_35[2], 2);
				unk_0x9452FE4900245259(uParam0->f_35[2], 0f);
				unk_0xF04751F8E604D487(uParam0->f_35[2], 0);
				unk_0xDD38B2935A3EAC56(uParam0->f_35[2], 0, 0);
			}
			if (bVar2)
			{
				iLocal_49 = 3;
...
bool func_275(int iParam0, char* sParam1)
{
...
int func_281(int iParam0, int iParam1, struct<3> Param2, float fParam3)
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_282((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_282((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_282(int iParam0, struct<3> Param1, float fParam2, var uParam3)
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_283(Var1.f_6, Param1, fParam2, 0))
	{
...
int func_283(struct<3> Param0, struct<3> Param1, float fParam2, bool bParam3)
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_284(int iParam0, bool bParam1)
{
	if (*iParam0 == 18)
	{
		if (func_201(iParam0->f_35[0]))
		{
			unk_0x0B74F181ADFC39BF(iParam0->f_35[0], 1);
		}
		if (func_201(iParam0->f_35[1]))
		{
			unk_0x0B74F181ADFC39BF(iParam0->f_35[1], 1);
		}
	}
	if (bParam1)
	{
	...
	if (*iParam0 == 17)
	{
		...
		unk_0x470041F66BF345BA("WORLD_VEHICLE_SALTON_DIRT_BIKE", 1);
	}
	else if (*iParam0 == 18)
	{
		unk_0xD7B6A43ACC36D868(uLocal_55, 0);
	...
	{
		unk_0x8E4825CCACA34B58(uLocal_54);
		unk_0x268BE77F77533D03("rcmextreme3");
