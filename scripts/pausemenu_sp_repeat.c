...
void __EntryFunction__()
{
	...
	if (Global_2883694)
	{
		if (unk_0x486FF5D06E9659F1(-43879923) == 0)
		{
			...
			system::start_new_script_with_name_hash_and_args(-43879923, &ScriptParam_28, 4, 1424);
		}
	...
	else if (Global_2883693)
	{
		if (unk_0x486FF5D06E9659F1(1179280373) == 0)
		{
			...
			system::start_new_script_with_name_hash_and_args(1179280373, &ScriptParam_28, 4, 1424);
		}
		unk_0xBBC29EBE6E1A48FA();
	}
	...
	switch (ScriptParam_28.f_0)
	{
		case 1:
			switch (ScriptParam_28.f_1)
			{
				case 75:
					if (ScriptParam_28.f_2 == 5)
					{
						func_83(1, 0, 1);
						func_82();
					}
					else if (ScriptParam_28.f_2 == 76)
					{
						func_82();
					}
					else
				...
				case 76:
					func_33(ScriptParam_28.f_3, 0);
					break;
				
				case 52:
					if (ScriptParam_28.f_2 == 52)
					{
						unk_0xD86E372FF627C3B2(ScriptParam_28.f_3);
					}
					break;
				
				case 154:
					if (ScriptParam_28.f_2 == 154)
					{
						unk_0xD86E372FF627C3B2(ScriptParam_28.f_3);
					}
					break;
				...
				default:
					func_32(1);
					if ((ScriptParam_28.f_1 == 26 || ScriptParam_28.f_1 == 25) || ScriptParam_28.f_1 == 153)
					{
						func_30(0, 1);
						func_29(2, 0);
						func_82();
					...
					else if (ScriptParam_28.f_1 == 5)
					{
						if (ScriptParam_28.f_2 == 75 || ScriptParam_28.f_2 == 133)
						{
						}
						else
						{
					...
					else
					{
						func_30(0, 1);
						func_29(2, 0);
						if (!ScriptParam_28.f_1 == 52 && !ScriptParam_28.f_1 == 154)
						{
							func_29(1, 0);
						}
						Global_79639 = 0;
		...
		case 2:
			switch (ScriptParam_28.f_1)
			{
				...
				case 76:
					if (Global_79656 != -1)
					{
						func_1(Global_79656, Global_79639);
						func_28(-1);
						...
						if (unk_0x7F420695E3F776FB(unk_0x4A8C381C258A124D(), 0))
						{
							...
							{
								Global_79641 = { unk_0xE5741C6B6539231F(unk_0x6EF03BE64E058E2F(unk_0x4A8C381C258A124D(), 0)) };
							}
						}
...
void func_1(int iParam0, int iParam1)
{
	...
	unk_0x0B0C9A0F9AAEB7F0(&Global_79638, 0);
}
...
int func_6()
{
	if (Global_113969.f_18577.f_380 > 0)
	{
		return 1;
	}
	return 0;
...
int func_7()
{
	...
	else if (Global_113969.f_10019.f_21 > 0)
	{
		return 1;
	}
	return 0;
	...
	if (func_8() == -1)
	{
		if (func_5(Global_79639))
		{
			...
			if (Global_79640 > 16)
			{
				...
				func_34(func_35(iParam0), Global_79640);
			}
		}
	}
}
...
void func_36()
{
	...
	{
		case 1:
			Global_79640 = func_37(&Local_27, 1, 0, 1);
			break;
		
		case 7:
			Global_79640 = func_37(&Local_27, 0, 1, 1);
			break;
...
void func_38(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_42(int iParam0, int iParam1)
{
	...
	{
		case 1:
			return Global_113969.f_9088.f_330[iParam0 /*6*/].f_3;
			break;
		
		case 7:
			return Global_113969.f_18577[iParam0 /*6*/].f_3;
			break;
...
int func_44()
{
	if (((Global_113969.f_9088.f_330[24 /*6*/] == 1 || Global_113969.f_9088.f_330[25 /*6*/] == 1) || Global_113969.f_9088.f_330[26 /*6*/] == 1) || Global_113969.f_9088.f_330[27 /*6*/] == 1)
	{
		return 1;
	}
	return 0;
...
void func_47(int iParam0)
{
	...
	Local_26 = { func_79(iParam0, Global_79639) };
	if (!func_4(2))
	{
		return;
	}
	...
	iVar4 = 0;
	iVar0 = 0;
	while (iVar0 < func_76(iParam0, Global_79639))
	{
		iVar5 = func_74(iParam0, Global_79639, iVar0);
		iVar6 = 1;
		switch (iVar5)
		{
			case 42:
		...
		if (!Global_64391[iVar5 /*13*/].f_7 && iVar6)
		{
...
float func_49(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	float fVar0;
	int iVar1;
	...
	else
	{
		unk_0xF3F7B05FC4684A7C("SET_DESCRIPTION");
		unk_0x330108B080A2132F(2);
		unk_0x330108B080A2132F(func_50(iVar1));
		unk_0x74BF156C860580D4(fVar0);
...
void func_53(int iParam0, int iParam1)
{
	...
	if (Global_79639 == 7)
	{
		...
		{
			case 52:
				*iParam1 = Global_113969.f_2355[0 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 53:
				*iParam1 = Global_113969.f_2355[1 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 54:
				*iParam1 = Global_113969.f_2355[2 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 55:
				*iParam1 = Global_113969.f_2355[3 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
			...
			case 56:
				*iParam1 = Global_113969.f_2355[4 /*2*/];
				if (*iParam1 == 0)
				{
					*iParam1 = 1;
				}
...
int func_54(int iParam0, int iParam1, int iParam2)
{
	...
	if (Global_64391[iParam0 /*13*/].f_7)
	{
		return 1;
	}
	Var0 = { Global_64391[iParam0 /*13*/] };
	...
	sVar3 = func_63(iParam0);
	if (iVar2 == -1)
	{
		func_62(iVar2, iParam1, 0, sVar3, iParam0, iParam2);
		iVar1 = 0;
	}
	else
	{
		...
		{
			case 1:
				func_61(iVar2, iParam1, iVar1, "MTTIME", iParam0, iParam2);
				break;
			
			case 2:
				func_61(iVar2, iParam1, iVar1, sVar3, iParam0, iParam2);
				break;
			
			case 3:
				func_60(iParam1, iVar1, sVar3, iParam0, iParam2);
				break;
			...
			case 5:
				func_59(iVar2, Var0.f_2, iParam1, iVar1, sVar3, iParam0, iParam2);
				break;
			...
			case 9:
				func_59(iVar2, 100, iParam1, iVar1, sVar3, iParam0, iParam2);
				break;
			...
			case 14:
			case 15:
				func_57(iVar2, iParam1, iVar1, sVar3, iParam0, iParam2);
				break;
			...
			case 12:
			case 13:
				func_55(iVar2, iParam1, iVar1, sVar3, iParam0, iParam2);
				break;
...
void func_55(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
	...
	if (iParam5 == 0)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_56(iParam4));
		unk_0xCFAD3D478C87321A();
	}
	else
	{
...
void func_57(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
		unk_0x88F483FBD433696A(iParam5, "SET_DATA_SLOT");
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	...
	if (iParam6 == 0)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_56(iParam5));
		unk_0xCFAD3D478C87321A();
	}
	else
	{
...
void func_59(int iParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
	float fVar0;
	...
	unk_0x330108B080A2132F(system::ceil(fVar0));
	if (iParam6 == 0)
	{
		unk_0x882AEFD55B8D51FB("PM_RP_STATD");
		unk_0xACF853FB3F6EA7D4(sParam4);
...
void func_60(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	if (iParam4 != 0)
	{
	...
	if (iParam4 == 0)
	{
		...
		unk_0xACF853FB3F6EA7D4(func_56(iParam3));
		unk_0xCFAD3D478C87321A();
	}
	else
	{
...
void func_62(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)
{
	if (iParam5 != 0)
	{
		unk_0x88F483FBD433696A(iParam5, "SET_DATA_SLOT");
...
{
	if (func_65(iParam0, func_72(Global_64391[iParam0 /*13*/].f_4)))
	{
		return 1;
	}
	return 0;
...
int func_65(int iParam0, int iParam1)
{
	...
	if (((iParam0 == 881 || iParam0 == 889) || iParam0 == 897) && Global_113969.f_24907[4 /*4*/] == func_66())
	{
...
void func_67()
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_70(Global_113969.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_68(iVar0) && (!func_26(14) || Global_112917))
			{
...
int func_73(int iParam0)
{
	...
	iVar0 = func_72(Global_64391[iParam0 /*13*/].f_4);
	if (iVar0 > -2)
	{
		return iVar0;
	}
...
struct<2> func_79(int iParam0, int iParam1)
{
	struct<2> Var0;
...
void func_83(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = 0;
	if (Global_79639 != iParam0 || iParam2 == 1)
	{
		iVar0 = 1;
	}
	Global_79639 = iParam0;
	func_4(2);
...
void func_84()
{
	...
	iVar3 = 0;
	iVar0 = 0;
	while (iVar0 < Global_79640)
	{
		iVar2 = 0;
		iVar3 = 0;
		iVar8 = -1;
		iVar1 = Local_27[iVar0 /*2*/];
		Local_26 = { func_79(iVar1, Global_79639) };
		iVar7 = 0;
		while (iVar7 < func_76(iVar1, Global_79639))
		{
			iVar4 = func_74(iVar1, Global_79639, iVar7);
			if (!Global_64391[iVar4 /*13*/].f_7)
			{
				if (func_64(iVar4) == 1)
				{
					iVar3++;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, char* sParam5, int iParam6)
{
