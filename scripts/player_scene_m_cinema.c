...
void __EntryFunction__()
{
	...
	func_21();
	func_17();
	while (iLocal_66 && func_7(1, iLocal_67[0]))
	{
		system::wait(0);
		switch (iLocal_64)
		{
...
int func_2()
{
	...
	if (system::vdist(unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1), Local_71) > 100f)
	{
		return 1;
	}
	return 0;
	...
	if (unk_0xFC8BFE4B41177C22(iParam0))
	{
		switch (iLocal_69[iParam1])
		{
			case 0:
				...
				if (unk_0x9B5C1660CCDF7189(iParam0, joaat("script_task_wander_standard")) != 1)
				{
					unk_0x761F56E633460973(iParam0, 1193033728, 0);
					unk_0x44FB298D6382876D(iLocal_67[iParam1], 1);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xD6F9DEE4765092A9(&(Local_70[iParam1 /*4*/])))
				{
					system::start_new_script_with_args(&(Local_70[iParam1 /*4*/]), &(iLocal_67[iParam1]), 1, 1424);
					iLocal_69[iParam1] = 4;
					return 0;
				}
				if (func_4(iParam0))
				...
				if (!unk_0x1FF4AE189014B73E(iParam0))
				{
					unk_0x21B9EFA4B4AA3A5B(iParam0, sVar0, 0, 1);
					unk_0x44FB298D6382876D(iLocal_67[iParam1], 1);
				}
				break;
			...
			case 2:
				...
				while (iVar1 < iLocal_69)
				{
					if (iParam1 != iVar1)
					{
						if (iLocal_69[iVar1] < 2 && iLocal_69[iParam1] >= 0)
						{
							iLocal_69[iVar1] = 2;
						}
					}
			...
			case 3:
				...
				if (unk_0x9B5C1660CCDF7189(iParam0, joaat("script_task_smart_flee_ped")) != 1)
				{
					...
					unk_0xD844F5E50DAB6FF7(iParam0, unk_0x4A8C381C258A124D(), 50f, 20000, 1, 0);
					return 1;
				}
				if (system::vdist2(unk_0xD1A6A821F5AC81DB(iParam0, 1), unk_0xD1A6A821F5AC81DB(unk_0x4A8C381C258A124D(), 1)) > (50f * 50f))
				{
					iLocal_69[iParam1] = 0;
					return 1;
				}
...
int func_7(int iParam0, int iParam1)
{
	...
	if (!unk_0x3555462DB47B7AB1())
	{
		...
		else if (iParam1 == func_8(Global_101254) && iParam1 != 0)
		{
			Global_101254 = 0;
		}
	}
...
void func_11()
{
	...
	if (unk_0xFC8BFE4B41177C22(unk_0x4A8C381C258A124D()))
	{
		if (func_14(Global_113969.f_2366.f_539.f_4321) != unk_0x4B423FAA24E8ABF0(unk_0x4A8C381C258A124D()))
		{
			...
			if (func_12(iVar0) && (!func_16(14) || Global_112917))
			{
...
void func_21()
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_68)
		{
			...
			if (!unk_0xD6F9DEE4765092A9(&(Local_70[iVar0 /*4*/])))
			{
				unk_0x97A5024CE91641F1(&(Local_70[iVar0 /*4*/]));
				if (!unk_0xA6E4F7A73ABC4A76(&(Local_70[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_67)
	{
		if (iLocal_68[iVar0] != 0)
		{
			iLocal_67[iVar0] = unk_0xB1DBFEB95C0EFB88(4, iLocal_68[iVar0], Local_71 + Local_73[iVar0 /*3*/], 0, 1, 1);
			unk_0x5C96CEA06531AB03(iLocal_67[iVar0], (fLocal_72 + fLocal_74[iVar0]));
			...
			unk_0x9FF00EA9A61211D2(iLocal_67[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_22()
{
	...
	func_26(iLocal_65, &Local_71, &fLocal_72, &cVar0);
	Var1.f_1 = -1;
	Var1.f_17 = 4;
	Var1.f_17.f_8 = 4;
	Var1.f_17.f_13 = 4;
	...
	{
		case 97:
			Local_73[0 /*3*/] = { Vector(45,5004f, -205,8167f, -1416,54f) - Local_71 };
			Local_73[1 /*3*/] = { Vector(45,5004f, -207,5375f, -1423,898f) - Local_71 };
			Local_73[2 /*3*/] = { Vector(45,5004f, -210,4254f, -1428,501f) - Local_71 };
			Local_73[3 /*3*/] = { Vector(45,5004f, unk_0xD2AA6F822D3A55D2(-205,8167f, -210,4254f), unk_0xD2AA6F822D3A55D2(-1416,54f, -1428,501f)) - Local_71 };
			fLocal_74[0] = (5,8017f - fLocal_72);
			fLocal_74[1] = (2,582f - fLocal_72);
			fLocal_74[2] = (-47,7025f - fLocal_72);
			fLocal_74[3] = (65,2818f - fLocal_72);
			iLocal_68[0] = joaat("a_f_m_tourist_01");
			StringCopy(&(Local_70[0 /*4*/]), "", 16);
			iLocal_68[1] = joaat("a_m_y_hipster_01");
			StringCopy(&(Local_70[1 /*4*/]), "", 16);
			iLocal_68[2] = joaat("a_m_m_bevhills_01");
			StringCopy(&(Local_70[2 /*4*/]), "", 16);
			iLocal_68[3] = joaat("a_m_m_genfat_01");
			StringCopy(&(Local_70[3 /*4*/]), "", 16);
			iLocal_69[0] = 0;
			iLocal_69[1] = 0;
			iLocal_69[2] = 0;
			iLocal_69[3] = 0;
		...
		case 158:
			Local_73[0 /*3*/] = { 1,2712f, 6,071f, -0,75f };
			Local_73[1 /*3*/] = { 3,8061f, 5,7599f, -0,5f };
			Local_73[2 /*3*/] = { 4,541f, 7,8487f, -0,4f };
			Local_73[3 /*3*/] = { 3,1051f, 13,7474f, -0,3463f };
			fLocal_74[0] = 123,059f;
			fLocal_74[1] = 134,0498f;
			fLocal_74[2] = 58,663f;
			fLocal_74[3] = 89,5592f;
			iLocal_68[0] = joaat("s_f_y_hooker_01");
			StringCopy(&(Local_70[0 /*4*/]), "pb_prostitute", 16);
			iLocal_68[1] = joaat("s_f_y_hooker_01");
			StringCopy(&(Local_70[1 /*4*/]), "pb_prostitute", 16);
			iLocal_68[2] = joaat("s_f_y_hooker_01");
			StringCopy(&(Local_70[2 /*4*/]), "pb_prostitute", 16);
			iLocal_68[3] = joaat("s_f_y_hooker_01");
			StringCopy(&(Local_70[3 /*4*/]), "pb_prostitute", 16);
			iLocal_69[0] = 1;
			iLocal_69[1] = 1;
			iLocal_69[2] = 1;
			iLocal_69[3] = 1;
